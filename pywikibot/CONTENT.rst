...
---------------------------
    ...
    +============================+======================================================+
    | __init__.py                | WaitingMixin: A mixin to implement wait cycles       |
    +----------------------------+------------------------------------------------------+
    ...
    +============================+======================================================+
    | __init__.py                | Page generators options and special page generators  |
    +----------------------------+------------------------------------------------------+
    ...
    +----------------------------+------------------------------------------------------+
    | _upload.py                 | Objects representing API upload to MediaWiki sites   |
    +----------------------------+------------------------------------------------------+
    ...
    +----------------------------+------------------------------------------------------+
    | buffer_interface.py        | Non-interactive interface that stores output         |
    +----------------------------+------------------------------------------------------+
