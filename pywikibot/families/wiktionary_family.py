...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'jv', 'az', 'eu', 'uk', 'br', 'ast', 'is', 'da', 'lo', 'sg', 'simple',
        'bn', 'la', 'hr', 'fj', 'sk', 'tg', 'mnw', 'ky', 'shn', 'bg', 'wa',
        'ur', 'ps', 'cy', 'vo', 'he', 'om', 'sl', 'af', 'zh-min-nan', 'lmo',
        'scn', 'tl', 'pa', 'sw', 'fy', 'ms', 'nn', 'ka', 'lv', 'min', 'sq',
        'nds', 'lb', 'co', 'mn', 'pnb', 'bs', 'nah', 'yue', 'sa', 'kk', 'km',
        'vec', 'diq', 'be', 'tk', 'mk', 'nia', 'sm', 'hsb', 'ks', 'shy', 'su',
        'gd', 'ga', 'bcl', 'an', 'gom', 'mr', 'wo', 'mni', 'ia', 'ang', 'mt',
        'sd', 'fo', 'tt', 'gn', 'so', 'ie', 'mi', 'csb', 'ug', 'bjn', 'si',
        'st', 'roa-rup', 'ha', 'tpi', 'hif', 'kl', 'guw', 'zu', 'ay', 'jbo',
        'yi', 'ln', 'gu', 'na', 'gv', 'kw', 'am', 'ne', 'rw', 'ts', 'qu', 'ig',
        'ss', 'iu', 'chr', 'dv', 'ti', 'tn',
    ]
