...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'hr', 'fj', 'tg', 'ky', 'sk', 'bg', 'wa', 'ur', 'ps', 'cy', 'shn',
        'vo', 'sl', 'he', 'af', 'zh-min-nan', 'scn', 'om', 'tl', 'pa', 'sw',
        'fy', 'nn', 'ka', 'lv', 'min', 'sq', 'nds', 'co', 'ms', 'mn', 'pnb',
        'lb', 'lmo', 'bs', 'nah', 'yue', 'mnw', 'sa', 'kk', 'km', 'diq', 'vec',
        'be', 'tk', 'mk', 'sm', 'hsb', 'nia', 'shy', 'ga', 'gd', 'an', 'wo',
        'mni', 'ks', 'gom', 'su', 'mr', 'ia', 'ang', 'mt', 'fo', 'tt', 'sd',
        'gn', 'ie', 'so', 'csb', 'ug', 'bcl', 'si', 'st', 'roa-rup', 'hif',
        'zu', 'kl', 'mi', 'ay', 'jbo', 'ln', 'yi', 'ha', 'gu', 'na', 'gv',
        'kw', 'tpi', 'ne', 'rw', 'ts', 'qu', 'ss', 'chr', 'iu', 'am', 'dv',
        'sg', 'ti', 'tn',
    ]
