...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'eu', 'uk', 'br', 'ast', 'da', 'lo', 'simple', 'is', 'hr', 'la', 'fj',
        'tg', 'ky', 'sk', 'bg', 'wa', 'ur', 'ps', 'skr', 'cy', 'vo', 'he',
        'af', 'shn', 'zh-min-nan', 'scn', 'sl', 'tl', 'bn', 'pa', 'sw', 'fy',
        'nn', 'ka', 'lv', 'om', 'sq', 'min', 'co', 'mn', 'pnb', 'nds', 'lb',
        'bs', 'ms', 'nah', 'yue', 'sa', 'kk', 'km', 'diq', 'vec', 'tk', 'be',
        'mk', 'sm', 'hsb', 'shy', 'gd', 'ga', 'an', 'wo', 'mni', 'gom', 'nia',
        'mr', 'ang', 'ia', 'fo', 'tt', 'mt', 'sd', 'gn', 'ie', 'so', 'csb',
        'ug', 'bcl', 'su', 'st', 'roa-rup', 'si', 'hif', 'zu', 'kl', 'mi',
        'ay', 'mnw', 'jbo', 'ln', 'yi', 'gu', 'na', 'gv', 'kw', 'tpi', 'ne',
        'ks', 'rw', 'ts', 'qu', 'ha', 'ss', 'chr', 'iu', 'am', 'dv', 'sg',
        'ti', 'tn',
    ]
