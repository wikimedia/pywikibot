...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'af', 'cy', 'sw', 'fy', 'tl', 'ast', 'nn', 'he', 'ur', 'ps', 'wa',
            'la', 'da', 'hy', 'sq', 'sm', 'sl', 'hi', 'az', 'tt', 'lv', 'ka',
            'lb', 'nah', 'pnb', 'bs', 'tk', 'hsb', 'kk', 'sk', 'km', 'mk', 'be',
            'ga', 'wo', 'ang', 'ms', 'co', 'gn', 'mr', 'ky', 'csb', 'st', 'nds',
            'ia', 'si', 'sh', 'sd', 'tg', 'ug', 'kl', 'jbo', 'mn', 'an', 'sa',
            'zu', 'gu', 'rw', 'fo', 'kw', 'gv', 'qu', 'ss', 'ie', 'mt', 'om',
            'chr', 'roa-rup', 'iu', 'pa', 'bn', 'am', 'so', 'su', 'za', 'gd',
            'jv', 'mi', 'tpi', 'ik', 'or', 'yi', 'ln', 'uz', 'ti', 'sg', 'na',
