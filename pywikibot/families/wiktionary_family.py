...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'pt', 'kn', 'vi', 'sr', 'th', 'hi', 'ro', 'no', 'et', 'id', 'ml', 'cs',
        'my', 'uz', 'li', 'or', 'te', 'eo', 'fa', 'ar', 'gl', 'jv', 'oc', 'az',
        'eu', 'uk', 'br', 'da', 'ast', 'lo', 'simple', 'is', 'hr', 'la', 'ky',
        'fj', 'tg', 'sk', 'bg', 'wa', 'ur', 'ps', 'cy', 'skr', 'vo', 'chr',
        'he', 'af', 'zh-min-nan', 'shn', 'scn', 'sl', 'tl', 'pa', 'sw', 'fy',
        'bn', 'nn', 'ka', 'lv', 'sq', 'co', 'min', 'mn', 'pnb', 'lb', 'nds',
        'bs', 'nah', 'ms', 'om', 'yue', 'sa', 'kk', 'km', 'diq', 'vec', 'tk',
        'be', 'mk', 'sm', 'hsb', 'shy', 'gd', 'ga', 'an', 'wo', 'mni', 'gom',
        'mr', 'ang', 'ia', 'tt', 'fo', 'mt', 'nia', 'sd', 'gn', 'ie', 'so',
        'csb', 'ug', 'bcl', 'st', 'roa-rup', 'si', 'hif', 'zu', 'kl', 'mi',
        'su', 'ay', 'jbo', 'ln', 'yi', 'gu', 'na', 'gv', 'kw', 'tpi', 'ne',
        'rw', 'ts', 'qu', 'ha', 'ss', 'iu', 'mnw', 'am', 'dv', 'ks', 'sg',
        'ti', 'tn',
    ]
