...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'fj', 'tg', 'skr', 'ky', 'sk', 'bg', 'wa', 'ur', 'ps', 'cy', 'vo',
        'shn', 'he', 'af', 'zh-min-nan', 'sl', 'scn', 'tl', 'om', 'pa', 'sw',
        'fy', 'nn', 'ka', 'lv', 'sq', 'nds', 'min', 'co', 'mn', 'pnb', 'ms',
        'lb', 'bs', 'nah', 'yue', 'sa', 'kk', 'km', 'diq', 'vec', 'tk', 'be',
        'mk', 'sm', 'hsb', 'shy', 'gd', 'ga', 'nia', 'mnw', 'an', 'wo', 'mni',
        'gom', 'mr', 'ang', 'ia', 'fo', 'tt', 'mt', 'sd', 'gn', 'ks', 'ie',
        'so', 'csb', 'ug', 'su', 'bcl', 'st', 'roa-rup', 'si', 'hif', 'zu',
