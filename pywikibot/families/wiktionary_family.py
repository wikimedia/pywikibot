...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'fj', 'tg', 'sk', 'bg', 'wa', 'ur', 'ps', 'cy', 'skr', 'vo', 'he',
        'af', 'zh-min-nan', 'shn', 'scn', 'sl', 'tl', 'pa', 'sw', 'fy', 'bn',
        'nn', 'ka', 'lv', 'sq', 'co', 'min', 'mn', 'pnb', 'lb', 'nds', 'bs',
        'om', 'ms', 'nah', 'yue', 'sa', 'kk', 'km', 'diq', 'vec', 'tk', 'be',
        'mk', 'sm', 'hsb', 'shy', 'gd', 'ga', 'an', 'wo', 'mni', 'gom', 'mr',
        'ang', 'ia', 'tt', 'fo', 'mt', 'nia', 'sd', 'gn', 'ie', 'so', 'csb',
        'ug', 'bcl', 'st', 'roa-rup', 'si', 'hif', 'zu', 'kl', 'mi', 'su',
        'ay', 'jbo', 'ln', 'yi', 'gu', 'na', 'gv', 'kw', 'tpi', 'ne', 'mnw',
        'rw', 'ts', 'qu', 'ha', 'chr', 'ss', 'ks', 'iu', 'am', 'dv', 'sg',
        'ti', 'tn',
    ]
