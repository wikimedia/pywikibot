...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'cs', 'lo', 'gl', 'eu', 'ca', 'te', 'uk', 'fj', 'bg', 'br', 'eo',
            'hr', 'oc', 'vo', 'is', 'th', 'simple', 'scn', 'sr', 'af', 'cy',
            'sw', 'fy', 'tl', 'ast', 'zh-min-nan', 'nn', 'he', 'ur', 'la', 'wa',
            'da', 'hy', 'sq', 'sm', 'sl', 'hi', 'tt', 'az', 'lv', 'ka', 'pnb',
            'lb', 'nah', 'tk', 'bs', 'hsb', 'kk', 'sk', 'km', 'mk', 'be', 'ga',
            'wo', 'ang', 'co', 'ms', 'gn', 'mr', 'ps', 'csb', 'st', 'nds', 'ia',
            'si', 'sh', 'sd', 'tg', 'ky', 'ug', 'kl', 'jbo', 'an', 'mn', 'zu',
