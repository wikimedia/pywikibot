...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        'en', 'fr', 'mg', 'zh', 'ru', 'de', 'sh', 'es', 'sv', 'el', 'nl', 'pl',
        ...
        'cy', 'vo', 'sl', 'om', 'he', 'af', 'zh-min-nan', 'scn', 'tl', 'pa',
        'sg', 'mnw', 'sw', 'fy', 'lmo', 'nn', 'ka', 'lv', 'ms', 'min', 'sq',
        'nds', 'co', 'mn', 'pnb', 'lb', 'bs', 'nah', 'yue', 'sa', 'kk', 'km',
        'diq', 'vec', 'be', 'tk', 'mk', 'sm', 'hsb', 'nia', 'shy', 'ks', 'gd',
        'ga', 'mr', 'gom', 'an', 'wo', 'mni', 'su', 'ia', 'ang', 'mt', 'fo',
        'sd', 'tt', 'bcl', 'gn', 'so', 'ie', 'csb', 'ug', 'si', 'st',
        'roa-rup', 'hif', 'tpi', 'zu', 'kl', 'mi', 'ay', 'ha', 'jbo', 'yi',
        'ln', 'gu', 'na', 'gv', 'kw', 'am', 'ne', 'rw', 'ts', 'qu', 'chr',
        'ss', 'iu', 'dv', 'ti', 'tn',
    ]
