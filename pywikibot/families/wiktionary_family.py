...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'vi', 'ca', 'pt', 'chr', 'sr', 'hi', 'ja', 'hy', 'ro', 'no', 'th',
            'ml', 'id', 'et', 'uz', 'li', 'my', 'or', 'te', 'fa', 'cs', 'ar',
            'jv', 'eu', 'az', 'gl', 'lo', 'uk', 'br', 'da', 'hr', 'eo', 'fj',
            'oc', 'bg', 'ps', 'simple', 'cy', 'vo', 'is', 'zh-min-nan', 'wa',
            'scn', 'ast', 'he', 'tg', 'af', 'sk', 'tl', 'sw', 'fy', 'la', 'nn',
            'ky', 'co', 'pnb', 'lv', 'mn', 'ka', 'sl', 'sq', 'nah', 'nds', 'lb',
            'bs', 'kk', 'sm', 'tk', 'sa', 'mk', 'hsb', 'km', 'bn', 'be', 'ms',
            'ga', 'ur', 'an', 'wo', 'ang', 'vec', 'pa', 'tt', 'gn', 'mr', 'sd',
