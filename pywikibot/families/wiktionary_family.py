...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'oc', 'jv', 'sg', 'az', 'uk', 'eu', 'is', 'ast', 'br', 'mnw', 'da',
        'bn', 'lo', 'simple', 'la', 'hr', 'sk', 'shn', 'fj', 'ky', 'wa', 'bg',
        'ur', 'ps', 'cy', 'tg', 'lmo', 'he', 'vo', 'om', 'sl', 'af',
        'zh-min-nan', 'kbd', 'scn', 'ms', 'tl', 'pa', 'fy', 'sw', 'ka', 'nn',
        'min', 'lv', 'nds', 'sq', 'gor', 'lb', 'co', 'mn', 'pnb', 'bs', 'kk',
        'nah', 'yue', 'sa', 'km', 'ckb', 'vec', 'be', 'diq', 'tk', 'nia', 'mk',
        'sm', 'hsb', 'ks', 'shy', 'su', 'gd', 'bcl', 'ga', 'an', 'gom', 'mr',
        'wo', 'mni', 'bjn', 'ia', 'ang', 'mt', 'sd', 'fo', 'tt', 'ha', 'gn',
        'so', 'ie', 'mi', 'csb', 'si', 'ug', 'guw', 'st', 'hif', 'roa-rup',
        'jbo', 'kl', 'zu', 'ay', 'yi', 'ln', 'gu', 'na', 'gv', 'kw', 'tpi',
