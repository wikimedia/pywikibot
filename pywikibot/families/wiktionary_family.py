...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'la', 'hr', 'fj', 'tg', 'sk', 'ky', 'wa', 'bg', 'ur', 'shn', 'ps',
        'cy', 'vo', 'sl', 'om', 'he', 'af', 'zh-min-nan', 'sg', 'scn', 'mnw',
        'tl', 'pa', 'sw', 'fy', 'lmo', 'nn', 'ka', 'lv', 'ms', 'min', 'sq',
        'nds', 'co', 'mn', 'pnb', 'lb', 'bs', 'nah', 'yue', 'sa', 'kk', 'km',
        'diq', 'vec', 'be', 'tk', 'mk', 'sm', 'hsb', 'nia', 'shy', 'ks', 'su',
        'gd', 'ga', 'mr', 'gom', 'an', 'wo', 'mni', 'bcl', 'ia', 'ang', 'mt',
        'fo', 'sd', 'tt', 'gn', 'so', 'ie', 'csb', 'ug', 'si', 'st', 'roa-rup',
        'tpi', 'kl', 'hif', 'zu', 'ha', 'mi', 'ay', 'jbo', 'yi', 'ln', 'gu',
        'na', 'gv', 'kw', 'am', 'ne', 'rw', 'ts', 'qu', 'iu', 'ss', 'chr',
        'dv', 'ti', 'tn',
    ]
