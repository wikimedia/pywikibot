...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'et', 'min', 'be', 'simple', 'el', 'hr', 'lt', 'gl', 'az', 'cy', 'sl',
        ...
        'cv', 'fy', 'tl', 'ckb', 'wuu', 'an', 'sco', 'diq', 'pa', 'io', 'ne',
        'vo', 'yo', 'gu', 'als', 'kn', 'bar', 'scn', 'ia', 'bpy', 'avk', 'qu',
        'mn', 'nv', 'crh', 'xmf', 'ha', 'si', 'bat-smg', 'os', 'frr', 'or',
        'gd', 'ps', 'ban', 'cdo', 'bug', 'yi', 'ilo', 'sd', 'am', 'nap', 'sah',
        'hsb', 'fo', 'li', 'map-bms', 'mai', 'mzn', 'gor', 'eml', 'ace', 'bcl',
        'shn', 'sa', 'wa', 'zh-classical', 'ie', 'lij', 'as', 'zu', 'mhr',
        'mrj', 'hif', 'hyw', 'ig', 'mni', 'hak', 'km', 'roa-tara', 'pam', 'sn',
        'nso', 'so', 'rue', 'bh', 'se', 'myv', 'vls', 'nds-nl', 'mi', 'sat',
        'sc', 'nah', 'vep', 'gan', 'kab', 'glk', 'tk', 'fiu-vro', 'co', 'bo',
        'tum', 'ab', 'ary', 'gv', 'frp', 'kw', 'kv', 'csb', 'pcd', 'ug', 'udm',
        'skr', 'zea', 'ay', 'gn', 'mt', 'nrm', 'bjn', 'smn', 'lez', 'lfn',
        'stq', 'lo', 'olo', 'mwl', 'fur', 'rm', 'ang', 'lad', 'gom', 'koi',
        'ext', 'tyv', 'rw', 'dsb', 'dty', 'ln', 'av', 'cbk-zam', 'dv', 'ksh',
        'gag', 'bxr', 'pap', 'pfl', 'pag', 'pi', 'haw', 'awa', 'tay', 'ks',
        'tw', 'inh', 'dag', 'krc', 'szy', 'xal', 'mdf', 'kaa', 'za', 'pdc',
        'atj', 'to', 'arc', 'tcy', 'kbp', 'jam', 'na', 'wo', 'kbd', 'nia',
        'nov', 'tet', 'ki', 'mnw', 'lg', 'bi', 'tpi', 'nqo', 'jbo', 'roa-rup',
        'fj', 'lbe', 'kg', 'xh', 'ty', 'cu', 'shi', 'srn', 'trv', 'om', 'guw',
        'sm', 'gcr', 'alt', 'chr', 'ltg', 'ny', 'blk', 'pih', 'got', 'mad',
        'st', 'ami', 'bm', 'tn', 've', 'rmy', 'ts', 'chy', 'rn', 'iu', 'ak',
        'ss', 'ff', 'ch', 'pnt', 'kcg', 'ady', 'ik', 'ee', 'sg', 'din', 'pcm',
        'pwn', 'kl', 'ti', 'dz', 'cr',
    ]
