...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'sh', 'hu', 'ko', 'cs', 'ro', 'ms', 'eu', 'tr', 'eo', 'hy', 'bg', 'da',
        'he', 'sk', 'zh-min-nan', 'kk', 'min', 'ce', 'hr', 'lt', 'et', 'be',
        'sl', 'el', 'gl', 'ur', 'az', 'simple', 'nn', 'uz', 'la', 'hi', 'th',
        'ka', 'vo', 'ta', 'azb', 'cy', 'ast', 'mk', 'tg', 'lv', 'mg', 'oc',
        'tt', 'ky', 'bs', 'tl', 'sq', 'new', 'zh-yue', 'af', 'te', 'br',
        ...
        'zh-classical', 'pam', 'frr', 'nso', 'szl', 'ace', 'se', 'km', 'mi',
        'nv', 'rue', 'nah', 'nds-nl', 'vls', 'bh', 'gan', 'crh', 'sc', 'vep',
        'bo', 'glk', 'co', 'so', 'tk', 'fiu-vro', 'myv', 'kv', 'lrc', 'csb',
        'as', 'gv', 'zea', 'udm', 'ay', 'ie', 'pcd', 'sn', 'ug', 'nrm', 'stq',
        'lez', 'lad', 'kw', 'mwl', 'gn', 'gom', 'rm', 'lij', 'koi', 'ab',
        'shn', 'haw', 'mt', 'ha', 'fur', 'frp', 'dsb', 'lfn', 'lo', 'ang',
        'ln', 'ext', 'cbk-zam', 'dv', 'dty', 'kab', 'ksh', 'olo', 'gag', 'pi',
        'pag', 'pfl', 'av', 'bxr', 'xal', 'bjn', 'krc', 'gor', 'pap', 'kaa',
        'za', 'pdc', 'rw', 'tyv', 'to', 'kl', 'nov', 'jam', 'arc', 'kbd',
        'tpi', 'kbp', 'tet', 'ig', 'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'ty',
        'mdf', 'kg', 'bi', 'wo', 'lg', 'srn', 'zu', 'atj', 'tcy', 'chr', 'ltg',
        'inh', 'sm', 'om', 'xh', 'pih', 'cu', 'rmy', 'tw', 'bm', 'tn', 'chy',
        'rn', 'got', 'ts', 'tum', 'ak', 'sat', 'st', 'ny', 'ch', 'pnt', 'ss',
