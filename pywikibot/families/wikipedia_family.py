...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'nv', 'avk', 'bat-smg', 'xmf', 'or', 'gd', 'cdo', 'ilo', 'yi', 'am',
        ...
        'bh', 'vls', 'nds-nl', 'sn', 'mi', 'sc', 'nah', 'so', 'sat', 'mni',
        ...
        'pag', 'av', 'ig', 'awa', 'haw', 'tay', 'rw', 'pap', 'xal', 'krc',
        'szy', 'za', 'pdc', 'kaa', 'inh', 'atj', 'arc', 'to', 'kbp', 'tpi',
        'jam', 'na', 'wo', 'kbd', 'tcy', 'tet', 'nov', 'lld', 'ki', 'mdf',
        'ak', 'lg', 'bi', 'jbo', 'roa-rup', 'lbe', 'kg', 'fj', 'xh', 'ty',
        'srn', 'om', 'nqo', 'trv', 'gcr', 'shi', 'sm', 'chr', 'ltg', 'alt',
        'nia', 'mnw', 'tw', 'ks', 'pih', 'ny', 'got', 'cu', 'st', 'mad', 'ami',
        'kl', 'dag', 'tn', 'bm', 'ts', 'rmy', 've', 'chy', 'rn', 'tum', 'iu',
