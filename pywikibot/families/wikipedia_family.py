...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'bg', 'da', 'kk', 'sk', 'hy', 'he', 'zh-min-nan', 'lt', 'hr', 'sl',
            'et', 'ce', 'gl', 'nn', 'uz', 'la', 'el', 'simple', 'vo', 'be',
            'th', 'az', 'ur', 'hi', 'ka', 'oc', 'ta', 'mk', 'mg', 'new', 'lv',
            'cy', 'bs', 'tt', 'tg', 'tl', 'te', 'pms', 'br', 'be-tarask', 'sq',
            'ky', 'ht', 'jv', 'ast', 'zh-yue', 'lb', 'ml', 'mr', 'bn', 'pnb',
            'af', 'is', 'sco', 'ga', 'ba', 'cv', 'fy', 'lmo', 'sw', 'my', 'an',
            'yo', 'ne', 'io', 'gu', 'nds', 'scn', 'bpy', 'pa', 'ku', 'als',
            'bar', 'kn', 'ia', 'qu', 'su', 'ckb', 'bat-smg', 'mn', 'arz', 'nap',
            'wa', 'bug', 'gd', 'yi', 'map-bms', 'am', 'si', 'mzn', 'fo', 'li',
            'nah', 'sah', 'or', 'vec', 'hsb', 'os', 'sa', 'mrj', 'hif', 'azb',
            'mhr', 'roa-tara', 'pam', 'ilo', 'eml', 'sd', 'ps', 'bh', 'xmf',
            'se', 'mi', 'bcl', 'diq', 'hak', 'gan', 'glk', 'vls', 'nds-nl',
            'rue', 'bo', 'fiu-vro', 'co', 'tk', 'sc', 'csb', 'wuu', 'lrc',
            'vep', 'szl', 'km', 'crh', 'gv', 'kv', 'frr', 'zh-classical', 'zea',
            'as', 'so', 'cdo', 'stq', 'kw', 'udm', 'ay', 'nso', 'nrm', 'ie',
            'koi', 'lad', 'ace', 'rm', 'myv', 'pcd', 'mt', 'fur', 'gn', 'lij',
            'dsb', 'dv', 'mai', 'cbk-zam', 'ext', 'kab', 'ksh', 'ang', 'mwl',
            'lez', 'gag', 'ln', 'ug', 'sn', 'pag', 'pi', 'frp', 'nv', 'gom',
            'av', 'pfl', 'haw', 'xal', 'krc', 'kaa', 'rw', 'bxr', 'pdc', 'to',
            'kl', 'nov', 'arc', 'lo', 'kbd', 'jam', 'pap', 'bjn', 'ha', 'tet',
            'ki', 'tyv', 'tpi', 'na', 'ig', 'lbe', 'jbo', 'roa-rup', 'ty', 'za',
            'kg', 'mdf', 'lg', 'wo', 'srn', 'ab', 'ltg', 'zu', 'sm', 'chr',
            'om', 'tn', 'chy', 'rmy', 'tw', 'cu', 'tum', 'xh', 'bi', 'rn',
            'pih', 'got', 'tcy', 'ss', 'pnt', 'bm', 'ch', 'ady', 'ts', 'iu',
            'st', 'ee', 'fj', 'ny', 'ks', 'ak', 'ik', 'sg', 've', 'ff', 'dz',
            'ti', 'cr',
        ]
