...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'mr', 'ky', 'ml', 'be-tarask', 'te', 'new', 'br', 'sw', 'vec', 'jv',
        'pms', 'pnb', 'ht', 'su', 'lb', 'ba', 'ga', 'szl', 'is', 'ku', 'lmo',
        'cv', 'fy', 'tl', 'wuu', 'an', 'sco', 'ckb', 'diq', 'pa', 'yo', 'ne',
        'bar', 'io', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'qu', 'mn', 'avk',
        'nv', 'xmf', 'si', 'crh', 'bat-smg', 'or', 'gd', 'cdo', 'frr', 'os',
        'ilo', 'yi', 'sd', 'am', 'bug', 'nap', 'ha', 'sah', 'hsb', 'map-bms',
        'fo', 'mai', 'ps', 'li', 'mzn', 'eml', 'gor', 'ace', 'ban', 'lld',
        'bcl', 'sa', 'wa', 'zh-classical', 'lij', 'shn', 'zu', 'mrj', 'mhr',
        'hif', 'as', 'mni', 'hyw', 'hak', 'roa-tara', 'pam', 'km', 'ie', 'nso',
        'rue', 'so', 'bh', 'se', 'sn', 'vls', 'nds-nl', 'myv', 'nah', 'sat',
        'mi', 'sc', 'vep', 'gan', 'glk', 'kab', 'tk', 'fiu-vro', 'co', 'bo',
        'ab', 'kv', 'frp', 'csb', 'pcd', 'kw', 'ug', 'gv', 'udm', 'ary', 'ay',
        'nrm', 'zea', 'gn', 'bjn', 'mt', 'skr', 'lez', 'lfn', 'smn', 'stq',
        'lo', 'mwl', 'olo', 'rm', 'fur', 'lad', 'gom', 'ang', 'koi', 'ext',
        'tyv', 'dsb', 'dty', 'ln', 'ig', 'cbk-zam', 'dv', 'rw', 'ksh', 'gag',
        'bxr', 'pfl', 'av', 'pi', 'pag', 'haw', 'awa', 'tay', 'pap', 'krc',
        'xal', 'szy', 'za', 'inh', 'kaa', 'pdc', 'atj', 'to', 'arc', 'kbp',
        'tpi', 'jam', 'na', 'wo', 'tw', 'kbd', 'mdf', 'tcy', 'dag', 'nov',
        'ki', 'nia', 'tet', 'lg', 'bi', 'jbo', 'roa-rup', 'fj', 'kg', 'xh',
        'lbe', 'ty', 'nqo', 'mnw', 'tum', 'cu', 'shi', 'ks', 'trv', 'srn',
