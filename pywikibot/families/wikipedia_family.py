...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'udm', 'ay', 'pcd', 'zea', 'kab', 'nrm', 'ug', 'sat', 'lij', 'kw',
        'lez', 'stq', 'haw', 'frp', 'lfn', 'gn', 'mwl', 'gom', 'rm', 'mt',
        'zu', 'lo', 'lad', 'ban', 'koi', 'fur', 'olo', 'dty', 'ang', 'dsb',
        'bjn', 'ext', 'ln', 'cbk-zam', 'dv', 'ksh', 'gag', 'pfl', 'tyv', 'pag',
        'pi', 'av', 'awa', 'bxr', 'xal', 'krc', 'pap', 'za', 'pdc', 'kaa',
        'rw', 'szy', 'arc', 'to', 'nov', 'jam', 'tpi', 'kbp', 'kbd', 'ig',
        'na', 'tet', 'inh', 'wo', 'tcy', 'ki', 'jbo', 'atj', 'roa-rup', 'ary',
        'bi', 'lbe', 'kg', 'ty', 'mdf', 'lg', 'srn', 'xh', 'gcr', 'ltg', 'fj',
        'chr', 'sm', 'ak', 'got', 'kl', 'om', 'pih', 'iu', 'cu', 'ny', 'tn',
        'tw', 'st', 'ts', 'nqo', 'rmy', 'bm', 'mnw', 'chy', 'rn', 'tum', 'ss',
        'ch', 'pnt', 'ady', 'ks', 've', 'ee', 'ik', 'ff', 'sg', 'ti', 'dz',
        'cr', 'din',
    ]
