...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'af', 'pms', 'bn', 'ml', 'jv', 'lb', 'ht', 'sco', 'mr', 'ga', 'pnb',
        'sw', 'is', 'ba', 'cv', 'fy', 'my', 'su', 'lmo', 'nds', 'an', 'yo',
        'ne', 'pa', 'gu', 'io', 'bar', 'scn', 'als', 'bpy', 'kn', 'ku', 'ckb',
        'ia', 'qu', 'arz', 'mn', 'bat-smg', 'si', 'wa', 'gd', 'nap', 'yi',
        'am', 'or', 'bug', 'cdo', 'wuu', 'map-bms', 'hsb', 'mai', 'fo', 'mzn',
        'xmf', 'li', 'sah', 'ilo', 'sa', 'vec', 'eml', 'os', 'sd', 'mrj',
        'mhr', 'hif', 'roa-tara', 'ps', 'diq', 'hak', 'pam', 'bcl',
        'zh-classical', 'nso', 'frr', 'szl', 'ace', 'se', 'mi', 'nah',
        'nds-nl', 'km', 'rue', 'bh', 'vls', 'nv', 'gan', 'crh', 'so', 'sc',
        'bo', 'vep', 'glk', 'co', 'tk', 'fiu-vro', 'myv', 'lrc', 'kv', 'csb',
        'as', 'gv', 'udm', 'zea', 'ay', 'ie', 'ug', 'sn', 'nrm', 'stq', 'lez',
        'pcd', 'kw', 'lad', 'mwl', 'gn', 'rm', 'gom', 'koi', 'lij', 'ab', 'mt',
        'fur', 'dsb', 'frp', 'haw', 'ang', 'ln', 'lo', 'dv', 'ext', 'cbk-zam',
        'dty', 'lfn', 'kab', 'ksh', 'gag', 'olo', 'pag', 'pi', 'pfl', 'av',
        'bxr', 'xal', 'krc', 'ha', 'pap', 'kaa', 'za', 'pdc', 'bjn', 'rw',
        'gor', 'tyv', 'to', 'kl', 'nov', 'jam', 'arc', 'kbd', 'tpi', 'kbp',
        'tet', 'ig', 'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'mdf', 'kg',
        'bi', 'wo', 'lg', 'srn', 'zu', 'tcy', 'chr', 'ltg', 'sm', 'inh', 'om',
        'xh', 'pih', 'cu', 'rmy', 'bm', 'tw', 'tn', 'atj', 'rn', 'chy', 'got',
        'tum', 'ts', 'ak', 'st', 'ch', 'ny', 'pnt', 'ss', 'fj', 'ady', 'iu',
