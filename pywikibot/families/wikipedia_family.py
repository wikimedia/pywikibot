...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'crh', 'bpy', 'qu', 'nv', 'mn', 'xmf', 'ban', 'si', 'ps', 'frr', 'tum',
        'os', 'bat-smg', 'or', 'sah', 'mzn', 'ig', 'cdo', 'gd', 'bug', 'yi',
        'sd', 'ilo', 'am', 'nap', 'li', 'bcl', 'fo', 'gor', 'hsb', 'map-bms',
        'mai', 'shn', 'eml', 'ace', 'zh-classical', 'sa', 'as', 'wa', 'ie',
        'lij', 'mhr', 'zu', 'hyw', 'sn', 'hif', 'mrj', 'bjn', 'mni', 'km',
        ...
        'fur', 'rm', 'mdf', 'lad', 'gom', 'ext', 'kaa', 'tyv', 'koi', 'dsb',
        'pap', 'av', 'ln', 'dty', 'tw', 'cbk-zam', 'dv', 'ksh', 'za', 'gag',
        ...
        'ty', 'guw', 'cu', 'trv', 'ami', 'srn', 'sm', 'alt', 'mad', 'gcr',
        'ltg', 'chr', 'tn', 'ny', 'st', 'pih', 'got', 'rmy', 'ee', 'bm', 'pcm',
