...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'simple', 'la', 'el', 'th', 'sh', 'oc', 'new', 'mk', 'roa-rup',
            'ka', 'tl', 'pms', 'ht', 'be', 'te', 'uz', 'ta', 'be-x-old', 'lv',
            'br', 'ceb', 'sq', 'jv', 'mg', 'cy', 'mr', 'lb', 'is', 'bs', 'hy',
            'my', 'yo', 'an', 'lmo', 'ml', 'pnb', 'fy', 'bpy', 'af', 'bn', 'sw',
            'io', 'ne', 'gu', 'zh-yue', 'ba', 'nds', 'scn', 'ur', 'ku', 'ast',
            'qu', 'su', 'diq', 'tt', 'ga', 'ky', 'cv', 'ia', 'nap', 'bat-smg',
            'map-bms', 'als', 'wa', 'kn', 'am', 'ckb', 'gd', 'sco', 'bug', 'tg',
            'mzn', 'zh-min-nan', 'yi', 'vec', 'arz', 'hif', 'roa-tara', 'nah',
            'os', 'sah', 'mn', 'sa', 'pam', 'hsb', 'li', 'mi', 'si', 'se', 'co',
            'gan', 'glk', 'bar', 'fo', 'ilo', 'bo', 'bcl', 'mrj', 'fiu-vro',
            'nds-nl', 'ps', 'tk', 'vls', 'gv', 'rue', 'pa', 'dv', 'xmf', 'pag',
            'nrm', 'kv', 'zea', 'koi', 'km', 'rm', 'csb', 'lad', 'udm', 'or',
            'mhr', 'mt', 'fur', 'lij', 'wuu', 'ug', 'pi', 'sc', 'frr',
            'zh-classical', 'bh', 'nov', 'ksh', 'ang', 'so', 'stq', 'kw', 'nv',
            'hak', 'ay', 'vep', 'frp', 'ext', 'pcd', 'szl', 'gag', 'gn', 'ie',
            'ln', 'haw', 'xal', 'eml', 'pfl', 'rw', 'pdc', 'krc', 'crh', 'ace',
            'to', 'ce', 'as', 'kl', 'arc', 'dsb', 'myv', 'bjn', 'pap', 'sn',
            'tpi', 'lbe', 'mdf', 'wo', 'kab', 'jbo', 'lez', 'av', 'srn',
            'cbk-zam', 'ty', 'bxr', 'lo', 'kbd', 'ab', 'tet', 'mwl', 'ltg',
            'na', 'ig', 'kg', 'nso', 'za', 'kaa', 'zu', 'rmy', 'chy', 'cu',
            'tn', 'chr', 'got', 'cdo', 'sm', 'bi', 'bm', 'iu', 'pih', 'sd',
            'ss', 'pnt', 'ee', 'om', 'ha', 'ki', 'ti', 'ts', 'ks', 'sg', 've',
            'rn', 'cr', 'ak', 'lg', 'tum', 'dz', 'ny', 'ik', 'ff', 'ch', 'fj',
            'st', 'tw', 'xh',
        ]
