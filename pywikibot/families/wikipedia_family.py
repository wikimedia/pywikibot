...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'os', 'sah', 'frr', 'avk', 'eml', 'ace', 'ps', 'sa', 'gor', 'bcl',
        ...
        'glk', 'ab', 'kab', 'so', 'bo', 'sat', 'co', 'tk', 'fiu-vro', 'ie',
        'kv', 'csb', 'pcd', 'gv', 'udm', 'ug', 'ay', 'zea', 'frp', 'nrm', 'kw',
        'lez', 'gn', 'lfn', 'stq', 'mwl', 'mt', 'rm', 'lo', 'lad', 'olo',
        'ary', 'gom', 'koi', 'skr', 'fur', 'bjn', 'ang', 'dty', 'dsb', 'ext',
        'ln', 'tyv', 'cbk-zam', 'dv', 'ksh', 'gag', 'smn', 'pfl', 'pi', 'pag',
        ...
        'om', 'gcr', 'trv', 'ltg', 'sm', 'chr', 'nqo', 'nia', 'mnw', 'got',
        'pih', 'st', 'kl', 'cu', 'ny', 'tw', 'mad', 'tn', 'ts', 'bm', 'rmy',
        'chy', 'rn', 'tum', 'ss', 'ch', 'iu', 'ks', 'pnt', 'ady', 'alt', 've',
        'ee', 'ik', 'ff', 'sg', 'din', 'dz', 'ti', 'cr', 'tay',
    ]
