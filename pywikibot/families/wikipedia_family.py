...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'bg', 'da', 'kk', 'sk', 'hy', 'he', 'lt', 'hr', 'sl', 'et',
            'zh-min-nan', 'ce', 'gl', 'uz', 'nn', 'la', 'vo', 'simple', 'el',
            'be', 'az', 'ur', 'ka', 'hi', 'th', 'oc', 'ta', 'mk', 'mg', 'new',
            'cy', 'bs', 'tt', 'lv', 'te', 'tl', 'pms', 'be-tarask', 'br', 'sq',
            'ky', 'ht', 'jv', 'tg', 'ast', 'zh-yue', 'lb', 'mr', 'ml', 'bn',
            'pnb', 'is', 'af', 'sco', 'ga', 'ba', 'cv', 'lmo', 'fy', 'sw', 'my',
            'an', 'yo', 'ne', 'io', 'gu', 'scn', 'nds', 'bpy', 'pa', 'ku',
            'als', 'kn', 'qu', 'ia', 'su', 'bar', 'ckb', 'bat-smg', 'mn', 'arz',
            'nap', 'bug', 'wa', 'gd', 'yi', 'am', 'map-bms', 'mzn', 'fo', 'si',
            'nah', 'li', 'sah', 'vec', 'hsb', 'or', 'os', 'mrj', 'sa', 'mhr',
            'roa-tara', 'azb', 'pam', 'ilo', 'hif', 'ps', 'se', 'mi', 'eml',
            'bcl', 'bh', 'diq', 'xmf', 'hak', 'gan', 'glk', 'vls', 'nds-nl',
            'rue', 'sd', 'bo', 'fiu-vro', 'co', 'sc', 'lrc', 'tk', 'csb', 'vep',
            'km', 'wuu', 'szl', 'gv', 'crh', 'kv', 'frr', 'zh-classical', 'zea',
            'as', 'so', 'ay', 'stq', 'kw', 'udm', 'cdo', 'nrm', 'koi', 'ie',
            'nso', 'rm', 'fur', 'mt', 'lad', 'pcd', 'ace', 'gn', 'myv', 'lij',
            'dsb', 'dv', 'cbk-zam', 'ext', 'kab', 'ksh', 'ang', 'lez', 'gag',
            'mwl', 'mai', 'ug', 'pi', 'pag', 'sn', 'nv', 'frp', 'gom', 'ln',
            'av', 'pfl', 'haw', 'xal', 'krc', 'kaa', 'rw', 'pdc', 'bxr', 'to',
            'kl', 'nov', 'arc', 'kbd', 'lo', 'bjn', 'ha', 'pap', 'tet', 'ki',
            'tpi', 'tyv', 'na', 'lbe', 'jbo', 'roa-rup', 'ig', 'ty', 'za',
            'mdf', 'kg', 'wo', 'srn', 'lg', 'ab', 'ltg', 'zu', 'sm', 'chr',
