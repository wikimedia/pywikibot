...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'sl', 'el', 'gl', 'az', 'ur', 'simple', 'nn', 'azb', 'uz', 'th', 'la',
        'hi', 'ka', 'vo', 'ta', 'cy', 'ast', 'mk', 'tg', 'lv', 'mg', 'oc',
        'tt', 'bs', 'ky', 'af', 'tl', 'sq', 'new', 'zh-yue', 'te', 'br',
        'be-tarask', 'bn', 'pms', 'ml', 'lb', 'jv', 'ht', 'sco', 'mr', 'ga',
        'sw', 'pnb', 'ba', 'is', 'nds', 'my', 'cv', 'fy', 'su', 'lmo', 'an',
        'ne', 'yo', 'pa', 'gu', 'io', 'bar', 'scn', 'als', 'ku', 'bpy', 'kn',
        'ckb', 'ia', 'qu', 'arz', 'mn', 'wuu', 'bat-smg', 'si', 'wa', 'gd',
        'or', 'yi', 'nap', 'am', 'cdo', 'bug', 'hsb', 'map-bms', 'mai', 'fo',
        'xmf', 'mzn', 'li', 'sah', 'eml', 'ilo', 'os', 'vec', 'sa', 'sd',
        'mrj', 'mhr', 'hif', 'ps', 'roa-tara', 'diq', 'bcl', 'hak',
        'zh-classical', 'frr', 'pam', 'ace', 'szl', 'nso', 'se', 'km', 'nv',
        'mi', 'rue', 'nah', 'nds-nl', 'vls', 'bh', 'gan', 'crh', 'sc', 'vep',
        'bo', 'glk', 'co', 'tk', 'fiu-vro', 'so', 'myv', 'lrc', 'as', 'kv',
        'csb', 'gv', 'shn', 'zea', 'udm', 'ay', 'pcd', 'ie', 'sn', 'ug', 'nrm',
        'stq', 'lez', 'lad', 'kw', 'mwl', 'gn', 'gom', 'rm', 'haw', 'lij',
        'ab', 'koi', 'ha', 'mt', 'fur', 'frp', 'lfn', 'dsb', 'lo', 'ln', 'ang',
        'ext', 'cbk-zam', 'dty', 'dv', 'olo', 'kab', 'ksh', 'gag', 'pi', 'pag',
        'pfl', 'av', 'bjn', 'bxr', 'xal', 'krc', 'gor', 'pap', 'kaa', 'za',
        'pdc', 'rw', 'tyv', 'to', 'kl', 'nov', 'jam', 'arc', 'kbd', 'tpi',
        'kbp', 'tet', 'ig', 'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'kg',
        'mdf', 'wo', 'bi', 'lg', 'zu', 'srn', 'tcy', 'atj', 'inh', 'chr',
        'ltg', 'sm', 'om', 'xh', 'pih', 'cu', 'rmy', 'bm', 'tw', 'tn', 'sat',
