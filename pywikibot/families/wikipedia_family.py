...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'tt', 'bs', 'ky', 'af', 'sq', 'tl', 'zh-yue', 'new', 'te', 'bn',
        'be-tarask', 'br', 'pms', 'ml', 'lb', 'jv', 'ht', 'sco', 'mr', 'ga',
        'sw', 'ba', 'nds', 'pnb', 'is', 'my', 'fy', 'cv', 'su', 'lmo', 'an',
        'ne', 'yo', 'pa', 'gu', 'io', 'bar', 'scn', 'ku', 'als', 'bpy', 'kn',
        'ckb', 'ia', 'qu', 'arz', 'wuu', 'mn', 'bat-smg', 'si', 'wa', 'or',
        'gd', 'yi', 'am', 'nap', 'cdo', 'bug', 'hsb', 'mai', 'map-bms', 'xmf',
        'fo', 'mzn', 'li', 'ilo', 'sah', 'eml', 'vec', 'os', 'sa', 'sd', 'mrj',
        'diq', 'mhr', 'ps', 'hif', 'roa-tara', 'zh-classical', 'bcl', 'ace',
        'hak', 'frr', 'pam', 'szl', 'nso', 'se', 'km', 'nv', 'hyw', 'mi',
        'rue', 'nah', 'nds-nl', 'vls', 'bh', 'crh', 'gan', 'sc', 'vep', 'bo',
        'glk', 'co', 'myv', 'tk', 'fiu-vro', 'as', 'so', 'kv', 'lrc', 'csb',
        'gv', 'shn', 'udm', 'zea', 'ie', 'pcd', 'ay', 'sn', 'ug', 'nrm', 'stq',
        'lez', 'kw', 'lad', 'mwl', 'gom', 'gn', 'haw', 'rm', 'lij', 'ha', 'ab',
        'koi', 'kab', 'lo', 'mt', 'lfn', 'fur', 'frp', 'dsb', 'ln', 'ang',
        'ext', 'olo', 'cbk-zam', 'dty', 'dv', 'ksh', 'gag', 'pi', 'pag', 'pfl',
        'bjn', 'av', 'bxr', 'xal', 'gor', 'krc', 'pap', 'za', 'kaa', 'pdc',
        'rw', 'tyv', 'to', 'kl', 'nov', 'jam', 'arc', 'kbp', 'kbd', 'tpi',
        'tet', 'ig', 'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'bi', 'kg',
        'mdf', 'wo', 'lg', 'zu', 'srn', 'tcy', 'inh', 'atj', 'chr', 'ltg',
        'sm', 'xh', 'om', 'sat', 'pih', 'cu', 'rmy', 'tw', 'bm', 'tn', 'chy',
