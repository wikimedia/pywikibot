...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'vi', 'ja', 'zh', 'pt', 'ar', 'uk', 'fa', 'sr', 'ca', 'no', 'id', 'fi',
        'ko', 'hu', 'sh', 'cs', 'ro', 'eu', 'tr', 'ms', 'eo', 'hy', 'bg', 'da',
        'he', 'sk', 'zh-min-nan', 'kk', 'min', 'ce', 'hr', 'et', 'lt', 'be',
        'el', 'sl', 'gl', 'azb', 'nn', 'az', 'simple', 'ur', 'th', 'hi', 'ka',
        'uz', 'la', 'ta', 'vo', 'cy', 'mk', 'ast', 'tg', 'lv', 'mg', 'tt',
        'oc', 'af', 'bs', 'ky', 'sq', 'tl', 'zh-yue', 'bn', 'new', 'te',
        'be-tarask', 'br', 'ml', 'pms', 'su', 'lb', 'ht', 'jv', 'sco', 'mr',
        'nds', 'sw', 'ga', 'ba', 'is', 'pnb', 'my', 'fy', 'cv', 'lmo', 'an',
        'ne', 'yo', 'pa', 'bar', 'io', 'gu', 'ku', 'als', 'scn', 'bpy', 'kn',
        'ckb', 'ia', 'qu', 'wuu', 'arz', 'mn', 'bat-smg', 'wa', 'si', 'or',
        'am', 'gd', 'yi', 'cdo', 'nap', 'bug', 'hsb', 'mai', 'map-bms', 'fo',
        'ilo', 'xmf', 'mzn', 'li', 'vec', 'eml', 'sd', 'sah', 'os', 'sa',
        'diq', 'ps', 'mrj', 'mhr', 'zh-classical', 'hif', 'nv', 'roa-tara',
        'ace', 'bcl', 'frr', 'hak', 'pam', 'szl', 'nso', 'se', 'km', 'hyw',
        'rue', 'mi', 'nah', 'vls', 'bh', 'nds-nl', 'crh', 'gan', 'vep', 'sc',
        'ab', 'bo', 'as', 'myv', 'glk', 'co', 'tk', 'fiu-vro', 'so', 'lrc',
        'csb', 'kv', 'shn', 'gv', 'sn', 'udm', 'zea', 'ay', 'ie', 'pcd', 'nrm',
        'ug', 'kab', 'stq', 'lez', 'kw', 'lad', 'ha', 'mwl', 'gom', 'gn',
        'haw', 'rm', 'lij', 'lfn', 'lo', 'koi', 'mt', 'frp', 'fur', 'dsb',
        'ext', 'ang', 'ln', 'dty', 'olo', 'cbk-zam', 'dv', 'ksh', 'bjn', 'gag',
        'pi', 'pfl', 'pag', 'av', 'bxr', 'gor', 'xal', 'krc', 'za', 'pap',
        'kaa', 'pdc', 'tyv', 'rw', 'to', 'kl', 'nov', 'arc', 'jam', 'kbp',
        'kbd', 'tpi', 'tet', 'ig', 'ki', 'zu', 'na', 'wo', 'jbo', 'roa-rup',
        'lbe', 'bi', 'ty', 'kg', 'mdf', 'lg', 'sat', 'tcy', 'srn', 'inh', 'xh',
        'atj', 'ltg', 'chr', 'sm', 'pih', 'om', 'tn', 'ak', 'cu', 'tw', 'ts',
        'rmy', 'bm', 'st', 'chy', 'rn', 'got', 'tum', 'ny', 'ch', 'ss', 'pnt',
        'fj', 'iu', 'ady', 've', 'ee', 'ks', 'ik', 'sg', 'ff', 'dz', 'ti',
        'din', 'cr',
    ]
