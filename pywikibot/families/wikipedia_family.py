...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'simple', 'th', 'la', 'el', 'new', 'roa-rup', 'oc', 'ka', 'sh',
            'tl', 'mk', 'ht', 'pms', 'te', 'ta', 'ceb', 'be-x-old', 'br', 'sq',
            'lv', 'be', 'jv', 'mg', 'lb', 'cy', 'mr', 'is', 'bs', 'yo', 'an',
            'bpy', 'hy', 'lmo', 'fy', 'sw', 'io', 'ml', 'bn', 'gu', 'af', 'pnb',
            'ne', 'nds', 'ku', 'scn', 'ur', 'zh-yue', 'su', 'qu', 'diq', 'ba',
            'ast', 'tt', 'ga', 'ia', 'nap', 'cv', 'bat-smg', 'map-bms', 'wa',
            'am', 'kn', 'als', 'bug', 'my', 'zh-min-nan', 'gd', 'tg', 'yi',
            'vec', 'roa-tara', 'hif', 'sco', 'os', 'arz', 'nah', 'sah', 'uz',
            'pam', 'sa', 'mn', 'hsb', 'mi', 'li', 'si', 'co', 'gan', 'glk',
            'ky', 'ckb', 'bcl', 'fo', 'bar', 'bo', 'mrj', 'ilo', 'fiu-vro',
            'nds-nl', 'tk', 'vls', 'se', 'gv', 'dv', 'nrm', 'rue', 'pag', 'pa',
            'mzn', 'ps', 'rm', 'km', 'udm', 'koi', 'csb', 'fur', 'mt', 'kv',
            ...
            'eml', 'gn', 'ce', 'kl', 'myv', 'arc', 'gag', 'dsb', 'pap', 'as',
            'bjn', 'lbe', 'tpi', 'wo', 'jbo', 'kab', 'mdf', 'av', 'sn', 'ty',
            'srn', 'lo', 'ab', 'ltg', 'mwl', 'ig', 'lez', 'na', 'kg', 'tet',
            'kbd', 'kaa', 'nso', 'rmy', 'cu', 'tn', 'chr', 'zu', 'sm', 'bi',
