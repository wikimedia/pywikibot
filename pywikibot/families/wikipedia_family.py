...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'vi', 'ja', 'zh', 'pt', 'uk', 'fa', 'ar', 'sr', 'ca', 'no', 'sh', 'fi',
        'id', 'hu', 'ko', 'cs', 'ro', 'ms', 'tr', 'eu', 'eo', 'hy', 'bg', 'da',
        'he', 'zh-min-nan', 'sk', 'kk', 'min', 'ce', 'hr', 'lt', 'et', 'sl',
        'be', 'el', 'gl', 'ur', 'nn', 'simple', 'az', 'uz', 'la', 'th', 'hi',
        'ka', 'vo', 'ta', 'azb', 'cy', 'mk', 'tg', 'ast', 'lv', 'mg', 'oc',
        'tt', 'tl', 'ky', 'bs', 'sq', 'new', 'te', 'zh-yue', 'br', 'be-tarask',
        'pms', 'af', 'bn', 'ml', 'jv', 'lb', 'ht', 'sco', 'mr', 'ga', 'pnb',
        'sw', 'is', 'ba', 'cv', 'fy', 'my', 'su', 'lmo', 'nds', 'an', 'yo',
        'ne', 'pa', 'gu', 'io', 'bar', 'scn', 'als', 'bpy', 'kn', 'ku', 'ckb',
        'ia', 'qu', 'arz', 'mn', 'bat-smg', 'si', 'gd', 'wa', 'nap', 'yi',
        'am', 'or', 'bug', 'cdo', 'wuu', 'map-bms', 'hsb', 'mai', 'fo', 'mzn',
        'xmf', 'li', 'sah', 'ilo', 'sa', 'vec', 'eml', 'os', 'sd', 'mrj',
        'mhr', 'hif', 'roa-tara', 'ps', 'diq', 'hak', 'pam', 'zh-classical',
        'bcl', 'nso', 'frr', 'szl', 'ace', 'se', 'mi', 'nah', 'nds-nl', 'km',
        'rue', 'bh', 'vls', 'gan', 'nv', 'so', 'crh', 'sc', 'bo', 'vep', 'glk',
        'co', 'tk', 'fiu-vro', 'lrc', 'myv', 'kv', 'csb', 'as', 'gv', 'udm',
        'zea', 'ay', 'ug', 'ie', 'nrm', 'sn', 'stq', 'lez', 'pcd', 'kw', 'lad',
        'mwl', 'gn', 'rm', 'gom', 'koi', 'lij', 'ab', 'mt', 'fur', 'dsb',
        'frp', 'haw', 'ang', 'ln', 'dv', 'ext', 'cbk-zam', 'lo', 'dty', 'lfn',
        'kab', 'ksh', 'gag', 'olo', 'pag', 'pi', 'pfl', 'av', 'bxr', 'xal',
        'krc', 'pap', 'ha', 'kaa', 'za', 'bjn', 'pdc', 'rw', 'gor', 'tyv',
        'to', 'kl', 'nov', 'jam', 'arc', 'kbd', 'tpi', 'kbp', 'tet', 'ig',
        'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'mdf', 'kg', 'bi', 'wo',
        'lg', 'srn', 'zu', 'tcy', 'chr', 'ltg', 'sm', 'inh', 'om', 'xh', 'pih',
        'cu', 'rmy', 'tw', 'bm', 'tn', 'rn', 'chy', 'atj', 'got', 'tum', 'ts',
        'ak', 'st', 'ch', 'ny', 'pnt', 'ss', 'fj', 'ady', 'iu', 'sat', 'ee',
