...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'vo', 'yo', 'ne', 'ia', 'gu', 'kn', 'als', 'avk', 'bar', 'ha', 'scn',
        'crh', 'bpy', 'qu', 'nv', 'mn', 'xmf', 'ban', 'si', 'ps', 'frr',
        'bat-smg', 'os', 'or', 'sah', 'cdo', 'gd', 'bug', 'mzn', 'yi', 'sd',
        'ilo', 'ig', 'am', 'nap', 'li', 'tum', 'fo', 'gor', 'hsb', 'map-bms',
        'mai', 'bcl', 'shn', 'eml', 'ace', 'zh-classical', 'sa', 'as', 'wa',
        'ie', 'lij', 'zu', 'mhr', 'hyw', 'hif', 'sn', 'mrj', 'bjn', 'mni',
        'km', 'hak', 'so', 'roa-tara', 'pam', 'rue', 'nso', 'bh', 'sat', 'se',
        'mi', 'myv', 'vls', 'nds-nl', 'sc', 'kw', 'dag', 'vep', 'glk', 'ary',
        'tk', 'kab', 'gan', 'co', 'bo', 'fiu-vro', 'rw', 'ab', 'gv', 'nah',
        'ug', 'zea', 'skr', 'frp', 'udm', 'pcd', 'kv', 'csb', 'mt', 'gn',
        'smn', 'ay', 'nrm', 'ks', 'lez', 'lfn', 'mwl', 'olo', 'stq', 'lo',
        'ang', 'fur', 'rm', 'lad', 'gom', 'ext', 'tyv', 'koi', 'mdf', 'dsb',
        'av', 'ln', 'dty', 'kaa', 'pap', 'tw', 'cbk-zam', 'dv', 'ksh', 'gag',
        'bxr', 'pfl', 'lg', 'za', 'pi', 'szy', 'pag', 'haw', 'tay', 'awa',
        'blk', 'inh', 'krc', 'xal', 'pdc', 'to', 'atj', 'arc', 'tcy', 'mnw',
        'jam', 'kbp', 'wo', 'anp', 'kbd', 'nia', 'shi', 'nov', 'ki', 'nqo',
        'bi', 'tpi', 'tet', 'roa-rup', 'xh', 'jbo', 'om', 'fj', 'kg', 'lbe',
        'ty', 'guw', 'cu', 'trv', 'srn', 'sm', 'alt', 'gcr', 'tn', 'chr',
        'ltg', 'ff', 'mad', 'ny', 'st', 'pih', 'got', 'rmy', 'ee', 'ami', 'bm',
        've', 'ts', 'pcm', 'chy', 'ss', 'kcg', 'rn', 'ch', 'gur', 'ik', 'pnt',
