...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'nn', 'ka', 'hi', 'uz', 'th', 'ta', 'la', 'cy', 'ast', 'mk', 'zh-yue',
        'bn', 'vo', 'lv', 'tg', 'af', 'my', 'mg', 'bs', 'oc', 'sq', 'mr',
        'nds', 'ky', 'ml', 'be-tarask', 'te', 'sw', 'new', 'br', 'jv', 'vec',
        'ht', 'pms', 'pnb', 'su', 'lb', 'ba', 'lld', 'ga', 'szl', 'is', 'ku',
        'lmo', 'cv', 'fy', 'tl', 'wuu', 'an', 'ckb', 'sco', 'diq', 'pa', 'yo',
        'io', 'ne', 'bar', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'avk', 'qu',
        'mn', 'nv', 'xmf', 'crh', 'si', 'bat-smg', 'ha', 'os', 'frr', 'gd',
        'or', 'cdo', 'yi', 'bug', 'ilo', 'sd', 'am', 'ps', 'nap', 'ban', 'sah',
        'hsb', 'fo', 'map-bms', 'mai', 'li', 'mzn', 'gor', 'eml', 'ace', 'bcl',
        'sa', 'wa', 'zh-classical', 'shn', 'lij', 'zu', 'as', 'mrj', 'mhr',
        'hif', 'hyw', 'ie', 'mni', 'hak', 'km', 'roa-tara', 'pam', 'nso',
        'rue', 'so', 'ig', 'sn', 'bh', 'se', 'myv', 'vls', 'nds-nl', 'mi',
        'sat', 'sc', 'nah', 'vep', 'gan', 'kab', 'glk', 'tk', 'fiu-vro', 'co',
        'bo', 'ab', 'ary', 'frp', 'kv', 'kw', 'csb', 'gv', 'pcd', 'ug', 'udm',
        'skr', 'ay', 'zea', 'nrm', 'gn', 'mt', 'bjn', 'smn', 'lez', 'lfn',
        'stq', 'lo', 'mwl', 'olo', 'fur', 'rm', 'lad', 'ang', 'gom', 'koi',
        'ext', 'tyv', 'dsb', 'rw', 'dty', 'tum', 'ln', 'cbk-zam', 'dv', 'ksh',
        'av', 'gag', 'bxr', 'pfl', 'pag', 'pap', 'pi', 'haw', 'awa', 'tay',
        'inh', 'krc', 'xal', 'tw', 'szy', 'za', 'pdc', 'kaa', 'atj', 'to',
        'dag', 'arc', 'mdf', 'kbp', 'jam', 'na', 'wo', 'kbd', 'tcy', 'nov',
        'nia', 'ki', 'tet', 'lg', 'bi', 'tpi', 'jbo', 'roa-rup', 'fj', 'lbe',
        'kg', 'nqo', 'xh', 'ty', 'mnw', 'ks', 'cu', 'shi', 'srn', 'trv', 'om',
        'sm', 'gcr', 'alt', 'chr', 'ltg', 'ny', 'pih', 'got', 'mad', 'guw',
        'st', 'ami', 'tn', 'rmy', 'bm', 'ts', 'chy', 've', 'rn', 'iu', 'ak',
