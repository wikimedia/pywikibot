...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'nn', 'ka', 'hi', 'th', 'uz', 'ta', 'la', 'cy', 'vo', 'ast', 'mk',
        'zh-yue', 'lv', 'bn', 'tg', 'my', 'af', 'mg', 'oc', 'bs', 'sq', 'nds',
        'ky', 'be-tarask', 'ml', 'new', 'mr', 'te', 'br', 'vec', 'pms', 'jv',
        'ht', 'pnb', 'sw', 'su', 'lb', 'tl', 'ba', 'ga', 'szl', 'is', 'lmo',
        'cv', 'fy', 'wuu', 'sco', 'diq', 'an', 'ku', 'pa', 'yo', 'ne', 'bar',
        'io', 'ckb', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'qu', 'mn', 'si',
        'bat-smg', 'nv', 'xmf', 'or', 'cdo', 'ilo', 'gd', 'yi', 'am', 'nap',
        'bug', 'sd', 'hsb', 'mai', 'wa', 'fo', 'map-bms', 'mzn', 'li', 'os',
        'sah', 'avk', 'frr', 'eml', 'ace', 'ps', 'sa', 'gor', 'bcl',
        'zh-classical', 'mrj', 'mhr', 'lij', 'hif', 'hak', 'roa-tara', 'crh',
        'pam', 'hyw', 'ha', 'nso', 'as', 'km', 'shn', 'rue', 'zu', 'se', 'bh',
        'vls', 'nds-nl', 'mi', 'nah', 'sc', 'sn', 'ban', 'vep', 'gan', 'myv',
        'glk', 'kab', 'sat', 'ab', 'so', 'bo', 'co', 'tk', 'fiu-vro', 'ie',
        'kv', 'csb', 'pcd', 'gv', 'udm', 'ug', 'ay', 'frp', 'zea', 'nrm', 'kw',
        'lez', 'gn', 'lfn', 'stq', 'mwl', 'mt', 'rm', 'lo', 'ary', 'lad',
        'olo', 'gom', 'skr', 'koi', 'bjn', 'fur', 'ang', 'dty', 'dsb', 'ext',
        'ln', 'tyv', 'cbk-zam', 'dv', 'ksh', 'gag', 'smn', 'pfl', 'pag', 'pi',
        'av', 'mni', 'awa', 'tay', 'haw', 'bxr', 'xal', 'pap', 'ig', 'krc',
        'rw', 'za', 'pdc', 'kaa', 'szy', 'arc', 'to', 'inh', 'nov', 'kbp',
        'jam', 'tpi', 'wo', 'kbd', 'na', 'atj', 'ki', 'tet', 'tcy', 'ak',
        'lld', 'lg', 'jbo', 'roa-rup', 'bi', 'lbe', 'kg', 'ty', 'mdf', 'xh',
        'fj', 'srn', 'om', 'gcr', 'trv', 'ltg', 'sm', 'chr', 'nqo', 'nia',
        'pih', 'mnw', 'got', 'st', 'kl', 'cu', 'ny', 'mad', 'tw', 'tn', 'ts',
        'bm', 'rmy', 'chy', 'rn', 'tum', 'ss', 'ch', 'iu', 'ks', 'pnt', 'ady',
        'alt', 've', 'ee', 'ik', 'ff', 'sg', 'din', 'dz', 'ti', 'cr',
    ]
