...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'sco', 'ha', 'yo', 'ne', 'kn', 'ia', 'gu', 'als', 'avk', 'crh', 'bar',
        ...
        'kaa', 'stq', 'ang', 'lo', 'fur', 'rm', 'ext', 'tw', 'lad', 'gom',
        'pap', 'tyv', 'koi', 'ln', 'av', 'dsb', 'dty', 'cbk-zam', 'dv', 'ksh',
        'za', 'lg', 'gag', 'bxr', 'pfl', 'szy', 'blk', 'tay', 'pag', 'pi',
        'haw', 'awa', 'inh', 'krc', 'pdc', 'to', 'atj', 'tcy', 'arc', 'mnw',
        'shi', 'xal', 'ff', 'jam', 'kbp', 'xh', 'wo', 'nia', 'om', 'anp',
        'kbd', 'nov', 'ki', 'nqo', 'bi', 'tpi', 'tet', 'roa-rup', 'jbo', 'zgh',
        'tn', 'fj', 'kg', 'lbe', 'guw', 'ty', 'cu', 'rmy', 'trv', 'mad', 'ami',
        'srn', 'alt', 'sm', 'ltg', 'gcr', 'chr', 'ny', 'pcm', 'dga', 'st',
        'gpe', 'pih', 'kcg', 'got', 'ss', 'gur', 'ee', 'bm', 'ts', 've', 'bbc',
        'chy', 'rn', 'ik', 'fon', 'ady', 'ch', 'guc', 'fat', 'pnt', 'iu',
