...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'he', 'ce', 'zh-min-nan', 'sk', 'kk', 'min', 'hr', 'et', 'lt', 'be',
        'el', 'azb', 'sl', 'gl', 'az', 'simple', 'nn', 'ur', 'hi', 'th', 'ka',
        'uz', 'la', 'ta', 'vo', 'cy', 'mk', 'tg', 'ast', 'lv', 'mg', 'tt',
        'af', 'oc', 'bs', 'ky', 'bn', 'sq', 'zh-yue', 'tl', 'new', 'te',
        'be-tarask', 'br', 'ml', 'pms', 'arz', 'su', 'nds', 'lb', 'ht', 'jv',
        'sco', 'mr', 'sw', 'pnb', 'ga', 'szl', 'ba', 'is', 'my', 'fy', 'cv',
        'lmo', 'an', 'ne', 'pa', 'yo', 'bar', 'io', 'gu', 'als', 'ku', 'scn',
        'kn', 'ckb', 'bpy', 'wuu', 'ia', 'qu', 'mn', 'bat-smg', 'si', 'wa',
        'or', 'cdo', 'gd', 'yi', 'am', 'nap', 'bug', 'ilo', 'mai', 'xmf',
        'hsb', 'map-bms', 'fo', 'mzn', 'diq', 'sd', 'li', 'vec', 'eml', 'sah',
        'os', 'sa', 'nv', 'ps', 'ace', 'mrj', 'mhr', 'zh-classical', 'frr',
        'hif', 'bcl', 'roa-tara', 'hak', 'pam', 'nso', 'km', 'hyw', 'se',
        'rue', 'mi', 'vls', 'bh', 'nah', 'nds-nl', 'crh', 'gan', 'shn', 'vep',
        'sc', 'as', 'ab', 'glk', 'bo', 'myv', 'co', 'so', 'tk', 'fiu-vro',
        'lrc', 'kv', 'csb', 'gv', 'sn', 'udm', 'zea', 'ie', 'ay', 'pcd', 'ha',
        'kab', 'nrm', 'ug', 'lez', 'stq', 'kw', 'mwl', 'haw', 'gn', 'gom',
        'lfn', 'lij', 'rm', 'lad', 'lo', 'frp', 'koi', 'mt', 'fur', 'dsb',
        'dty', 'olo', 'ang', 'ext', 'ln', 'cbk-zam', 'dv', 'bjn', 'ksh', 'gag',
        'pfl', 'pi', 'pag', 'gor', 'av', 'sat', 'bxr', 'xal', 'krc', 'tyv',
        'za', 'pap', 'kaa', 'pdc', 'rw', 'to', 'nov', 'kl', 'jam', 'arc',
        'tpi', 'kbp', 'kbd', 'szy', 'tet', 'ig', 'zu', 'wo', 'ki', 'na', 'tcy',
        'jbo', 'roa-rup', 'lbe', 'bi', 'ty', 'mdf', 'kg', 'inh', 'lg', 'atj',
        'srn', 'ban', 'xh', 'ltg', 'chr', 'got', 'sm', 'pih', 'om', 'ak', 'tn',
        'tw', 'cu', 'fj', 'ts', 'rmy', 'bm', 'st', 'chy', 'rn', 'tum', 'ny',
        'nqo', 'ch', 'ss', 'pnt', 'gcr', 'mnw', 'ady', 'iu', 've', 'ee', 'ks',
        'ik', 'sg', 'ff', 'dz', 'ti', 'din', 'cr',
    ]
