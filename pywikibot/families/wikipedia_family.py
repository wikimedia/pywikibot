...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'tg', 'mg', 'af', 'tt', 'bn', 'oc', 'zh-yue', 'bs', 'sq', 'ky', 'new',
        'tl', 'be-tarask', 'te', 'ml', 'br', 'nds', 'pms', 'su', 'sw', 'ht',
        'lb', 'jv', 'mr', 'sco', 'pnb', 'ga', 'szl', 'ba', 'is', 'my', 'fy',
        'vec', 'cv', 'lmo', 'an', 'pa', 'ne', 'wuu', 'yo', 'bar', 'io', 'gu',
        'ku', 'als', 'ckb', 'kn', 'scn', 'bpy', 'ia', 'qu', 'mn', 'bat-smg',
        'diq', 'or', 'si', 'cdo', 'ilo', 'gd', 'yi', 'am', 'nv', 'nap', 'bug',
        'xmf', 'wa', 'hsb', 'mai', 'sd', 'map-bms', 'fo', 'mzn', 'li', 'eml',
        'sah', 'os', 'sa', 'ps', 'frr', 'bcl', 'ace', 'zh-classical', 'mrj',
        'mhr', 'hif', 'hak', 'roa-tara', 'pam', 'nso', 'km', 'hyw', 'se',
        'rue', 'crh', 'mi', 'vls', 'bh', 'shn', 'nah', 'nds-nl', 'as', 'sc',
        'vep', 'gan', 'myv', 'ab', 'glk', 'bo', 'so', 'co', 'gor', 'tk',
        'fiu-vro', 'sn', 'lrc', 'kv', 'csb', 'ha', 'gv', 'udm', 'ie', 'ay',
        'pcd', 'zea', 'kab', 'nrm', 'ug', 'lez', 'stq', 'kw', 'haw', 'lfn',
        'frp', 'lij', 'mwl', 'gn', 'gom', 'rm', 'lo', 'lad', 'mt', 'koi',
        'fur', 'olo', 'dsb', 'dty', 'ang', 'sat', 'ext', 'ln', 'bjn',
        'cbk-zam', 'dv', 'ksh', 'ban', 'gag', 'pfl', 'pag', 'pi', 'tyv', 'av',
        'zu', 'bxr', 'xal', 'krc', 'pap', 'za', 'pdc', 'kaa', 'rw', 'szy',
        'to', 'arc', 'nov', 'jam', 'tpi', 'kbp', 'kbd', 'ig', 'na', 'tet',
        'wo', 'ki', 'tcy', 'inh', 'jbo', 'roa-rup', 'bi', 'lbe', 'kg', 'ty',
        'mdf', 'lg', 'atj', 'srn', 'xh', 'cu', 'gcr', 'chr', 'om', 'fj', 'ltg',
        'sm', 'got', 'kl', 'ak', 'pih', 'tn', 'tw', 'st', 'ts', 'rmy', 'bm',
        'chy', 'rn', 'nqo', 'tum', 'ny', 'mnw', 'ss', 'ch', 'pnt', 'iu', 'ady',
        'ks', 've', 'ee', 'ik', 'sg', 'ff', 'ti', 'dz', 'din', 'cr', 'awa',
    ]
