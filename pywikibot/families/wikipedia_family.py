...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'bpy', 'hy', 'lmo', 'fy', 'sw', 'bn', 'io', 'ml', 'gu', 'af', 'pnb',
            'ne', 'nds', 'scn', 'ku', 'ur', 'zh-yue', 'su', 'qu', 'diq', 'ba',
            'ast', 'tt', 'ga', 'nap', 'ia', 'cv', 'bat-smg', 'map-bms', 'wa',
            'am', 'kn', 'als', 'bug', 'my', 'zh-min-nan', 'tg', 'gd', 'vec',
            'yi', 'roa-tara', 'hif', 'os', 'sco', 'arz', 'nah', 'sah', 'uz',
            'pam', 'sa', 'mn', 'hsb', 'mi', 'li', 'si', 'co', 'gan', 'glk',
            'bcl', 'fo', 'ky', 'ckb', 'bar', 'bo', 'mrj', 'ilo', 'fiu-vro',
            ...
            'haw', 'ay', 'rw', 'ln', 'pdc', 'pfl', 'krc', 'ace', 'to', 'crh',
            'eml', 'ce', 'gn', 'kl', 'myv', 'arc', 'gag', 'pap', 'bjn', 'lbe',
            'tpi', 'as', 'dsb', 'wo', 'jbo', 'mdf', 'av', 'kab', 'sn', 'ty',
            'srn', 'lo', 'ab', 'ltg', 'ig', 'na', 'mwl', 'kg', 'tet', 'kaa',
            'nso', 'rmy', 'cu', 'tn', 'kbd', 'sm', 'bi', 'sd', 'bm', 'ik', 'iu',
            'ss', 'pih', 'za', 'chr', 'pnt', 'got', 'cdo', 'zu', 'ee', 'ha',
            'ti', 'ks', 'om', 'bxr', 've', 'ts', 'sg', 'rn', 'dz', 'cr', 'lg',
