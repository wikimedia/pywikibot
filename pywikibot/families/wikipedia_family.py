...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'oc', 'te', 'ml', 'be-tarask', 'nds', 'br', 'ky', 'sw', 'lmo', 'jv',
        'new', 'pnb', 'vec', 'ht', 'pms', 'ba', 'lb', 'ku', 'su', 'ga', 'szl',
        'is', 'fy', 'ckb', 'cv', 'pa', 'tl', 'an', 'wuu', 'diq', 'io', 'sco',
        'vo', 'yo', 'ne', 'ha', 'kn', 'ia', 'gu', 'als', 'avk', 'crh', 'bar',
        'scn', 'bpy', 'qu', 'mn', 'nv', 'ban', 'xmf', 'ig', 'si', 'frr', 'tum',
        ...
        'nov', 'xh', 'ki', 'nqo', 'bi', 'tpi', 'tet', 'roa-rup', 'jbo', 'fj',
        'kg', 'lbe', 'tn', 'guw', 'ty', 'cu', 'rmy', 'trv', 'ami', 'srn',
        'mad', 'sm', 'alt', 'ltg', 'gcr', 'chr', 'ny', 'pcm', 'st', 'pih',
        'gpe', 'got', 'ss', 'gur', 'ee', 'bm', 'kcg', 'ts', 've', 'chy', 'rn',
        'ady', 'ch', 'ik', 'fon', 'guc', 'fat', 'pnt', 'iu', 'pwn', 'sg',
        'din', 'ti', 'kl', 'dz', 'cr',
    ]
