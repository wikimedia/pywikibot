...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'vi', 'ja', 'zh', 'pt', 'uk', 'fa', 'ar', 'sr', 'ca', 'no', 'id', 'fi',
        ...
        'tt', 'bs', 'ky', 'tl', 'sq', 'new', 'zh-yue', 'te', 'af', 'br',
        ...
        'glk', 'co', 'so', 'tk', 'fiu-vro', 'myv', 'kv', 'lrc', 'csb', 'as',
        'gv', 'zea', 'udm', 'ay', 'ie', 'pcd', 'sn', 'ug', 'nrm', 'stq', 'lez',
        'lad', 'kw', 'mwl', 'gn', 'gom', 'rm', 'lij', 'ab', 'koi', 'mt', 'haw',
        'fur', 'shn', 'frp', 'dsb', 'ha', 'lo', 'lfn', 'ang', 'ln', 'dv',
        'ext', 'cbk-zam', 'dty', 'kab', 'ksh', 'olo', 'gag', 'pi', 'pag',
        'pfl', 'av', 'bxr', 'xal', 'krc', 'bjn', 'pap', 'gor', 'kaa', 'za',
        'pdc', 'rw', 'tyv', 'to', 'nov', 'kl', 'jam', 'arc', 'kbd', 'tpi',
        'kbp', 'tet', 'ig', 'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'mdf',
        'kg', 'bi', 'wo', 'lg', 'srn', 'zu', 'tcy', 'chr', 'ltg', 'inh', 'sm',
        'om', 'xh', 'pih', 'atj', 'cu', 'rmy', 'tw', 'bm', 'tn', 'rn', 'chy',
        'got', 'ts', 'tum', 'ak', 'sat', 'st', 'ny', 'ch', 'pnt', 'ss', 'fj',
        'ady', 'iu', 'ee', 'ks', 've', 'ik', 'sg', 'ff', 'dz', 'ti', 'cr',
        'din',
    ]
