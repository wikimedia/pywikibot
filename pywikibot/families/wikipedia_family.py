...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'mg', 'oc', 'lv', 'ky', 'bs', 'tt', 'sq', 'new', 'te', 'azb',
            'zh-yue', 'pms', 'br', 'be-tarask', 'ast', 'bn', 'ml', 'jv', 'ht',
            'lb', 'mr', 'sco', 'af', 'ga', 'pnb', 'is', 'ba', 'cv', 'fy', 'su',
            'sw', 'my', 'lmo', 'an', 'yo', 'ne', 'nds', 'pa', 'gu', 'io',
            'scn', 'bar', 'bpy', 'als', 'ku', 'kn', 'ckb', 'ia', 'qu', 'arz',
            'mn', 'bat-smg', 'gd', 'wa', 'nap', 'si', 'yi', 'am', 'bug', 'cdo',
            'or', 'map-bms', 'fo', 'mzn', 'hsb', 'xmf', 'mai', 'li', 'sah',
            'sa', 'vec', 'ilo', 'os', 'mrj', 'myv', 'hif', 'mhr', 'eml', 'bh',
            'roa-tara', 'ps', 'diq', 'pam', 'sd', 'hak', 'nso', 'zh-classical',
            'se', 'bcl', 'ace', 'wuu', 'mi', 'nah', 'szl', 'nds-nl', 'frr',
            'rue', 'gan', 'vls', 'km', 'bo', 'vep', 'crh', 'sc', 'glk',
            'fiu-vro', 'co', 'lrc', 'tk', 'kv', 'csb', 'gv', 'as', 'lad', 'so',
            'zea', 'nv', 'udm', 'ay', 'lez', 'stq', 'ie', 'kw', 'nrm', 'pcd',
            'mwl', 'ug', 'rm', 'koi', 'ab', 'gn', 'gom', 'lij', 'mt',
            'cbk-zam', 'fur', 'dsb', 'sn', 'dv', 'ang', 'ln', 'ext', 'kab',
            'ksh', 'frp', 'lo', 'gag', 'dty', 'pag', 'olo', 'pi', 'av', 'bxr',
            'pfl', 'xal', 'haw', 'krc', 'pap', 'kaa', 'rw', 'pdc', 'bjn', 'to',
            'ha', 'nov', 'kl', 'arc', 'jam', 'kbd', 'tyv', 'tpi', 'tet', 'ki',
            'kbp', 'ig', 'na', 'roa-rup', 'lbe', 'jbo', 'ty', 'mdf', 'za',
            'kg', 'lg', 'wo', 'bi', 'srn', 'tcy', 'zu', 'chr', 'ltg', 'sm',
            'om', 'xh', 'rmy', 'tn', 'cu', 'pih', 'rn', 'chy', 'tw', 'ts',
            'tum', 'got', 'st', 'pnt', 'ss', 'bm', 'ch', 'fj', 'atj', 'ady',
            'iu', 'ny', 'ee', 'ak', 'ks', 'ik', 've', 'sg', 'ff', 'dz', 'ti',
            'cr', 'din',
        ]
