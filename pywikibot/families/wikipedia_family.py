...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ms', 'ce', 'eo', 'he', 'hy', 'bg', 'da', 'tt', 'azb', 'sk', 'kk',
        'hr', 'min', 'et', 'be', 'lt', 'el', 'simple', 'az', 'sl', 'gl', 'ur',
        ...
        'bat-smg', 'si', 'nv', 'or', 'cdo', 'ilo', 'xmf', 'gd', 'yi', 'am',
        'nap', 'bug', 'sd', 'hsb', 'wa', 'mai', 'fo', 'map-bms', 'mzn', 'li',
        'sah', 'os', 'eml', 'frr', 'avk', 'ace', 'ps', 'sa', 'gor', 'bcl',
        'zh-classical', 'mrj', 'mhr', 'hif', 'hak', 'roa-tara', 'pam', 'crh',
        'hyw', 'nso', 'km', 'shn', 'rue', 'as', 'se', 'bh', 'vls', 'zu',
        'nds-nl', 'mi', 'nah', 'sc', 'ha', 'lij', 'vep', 'sn', 'gan', 'myv',
        'ab', 'ban', 'glk', 'kab', 'bo', 'so', 'co', 'tk', 'sat', 'fiu-vro',
        'ie', 'kv', 'csb', 'pcd', 'gv', 'udm', 'ug', 'ay', 'zea', 'nrm', 'frp',
        'kw', 'lez', 'gn', 'lfn', 'stq', 'mwl', 'rm', 'mt', 'lo', 'lad', 'gom',
        'olo', 'koi', 'fur', 'bjn', 'ary', 'skr', 'ang', 'dty', 'dsb', 'ext',
        'ln', 'tyv', 'cbk-zam', 'dv', 'ksh', 'gag', 'pfl', 'pi', 'pag', 'av',
        'awa', 'smn', 'haw', 'bxr', 'xal', 'ig', 'krc', 'pap', 'rw', 'za',
        'pdc', 'kaa', 'szy', 'arc', 'to', 'nov', 'kbp', 'inh', 'jam', 'tpi',
        'wo', 'kbd', 'na', 'tet', 'ki', 'atj', 'tcy', 'ak', 'lld', 'jbo',
        'roa-rup', 'bi', 'lbe', 'lg', 'kg', 'ty', 'mdf', 'xh', 'fj', 'srn',
        'om', 'gcr', 'ltg', 'sm', 'chr', 'nqo', 'got', 'mnw', 'pih', 'kl',
        'nia', 'st', 'cu', 'ny', 'tw', 'tn', 'ts', 'bm', 'rmy', 'mad', 'chy',
        'rn', 'tum', 'ss', 'ch', 'iu', 'ks', 'pnt', 'ady', 've', 'ee', 'ik',
        'ff', 'sg', 'din', 'dz', 'ti', 'cr', 'mni',
    ]
