...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'kk', 'et', 'min', 'be', 'simple', 'el', 'hr', 'lt', 'gl', 'az', 'uz',
        'ur', 'sl', 'ka', 'nn', 'hi', 'th', 'ta', 'la', 'mk', 'ast', 'bn',
        'zh-yue', 'lv', 'tg', 'af', 'my', 'mg', 'bs', 'oc', 'mr', 'sq', 'nds',
        'ky', 'ml', 'be-tarask', 'te', 'sw', 'br', 'new', 'jv', 'lld', 'vec',
        'ht', 'pms', 'pnb', 'su', 'lb', 'ba', 'ga', 'ku', 'lmo', 'szl', 'is',
        'cv', 'fy', 'ckb', 'tl', 'wuu', 'an', 'sco', 'diq', 'pa', 'io', 'vo',
        'ne', 'yo', 'gu', 'als', 'kn', 'bar', 'scn', 'bpy', 'avk', 'ia', 'qu',
        'mn', 'crh', 'nv', 'xmf', 'ha', 'si', 'bat-smg', 'os', 'frr', 'ban',
        'ps', 'or', 'gd', 'cdo', 'bug', 'yi', 'ilo', 'sd', 'sah', 'am', 'nap',
        'li', 'hsb', 'fo', 'map-bms', 'mai', 'gor', 'mzn', 'eml', 'ace', 'bcl',
        'shn', 'sa', 'zh-classical', 'wa', 'ie', 'ig', 'lij', 'as', 'zu',
        'mhr', 'mrj', 'hyw', 'hif', 'mni', 'km', 'hak', 'roa-tara', 'sn',
        'pam', 'so', 'nso', 'rue', 'bh', 'se', 'myv', 'tum', 'vls', 'mi',
        'nds-nl', 'sat', 'sc', 'nah', 'vep', 'gan', 'tk', 'kab', 'glk',
        'fiu-vro', 'co', 'ab', 'bo', 'ary', 'gv', 'frp', 'kw', 'kv', 'pcd',
        'csb', 'ug', 'udm', 'skr', 'zea', 'ay', 'gn', 'mt', 'nrm', 'bjn',
        'smn', 'lez', 'lfn', 'stq', 'lo', 'olo', 'mwl', 'rw', 'fur', 'ang',
        'rm', 'lad', 'gom', 'koi', 'ext', 'tyv', 'dsb', 'dty', 'ln', 'av',
        'cbk-zam', 'dv', 'ksh', 'pap', 'gag', 'bxr', 'pfl', 'pag', 'pi', 'haw',
        'awa', 'tay', 'ks', 'tw', 'dag', 'kaa', 'inh', 'mdf', 'krc', 'szy',
        'xal', 'za', 'pdc', 'atj', 'to', 'arc', 'tcy', 'kbp', 'jam', 'na',
        'wo', 'kbd', 'nia', 'nov', 'tet', 'ki', 'lg', 'mnw', 'blk', 'bi',
        'tpi', 'nqo', 'jbo', 'roa-rup', 'fj', 'lbe', 'kg', 'xh', 'ty', 'cu',
        'shi', 'srn', 'trv', 'guw', 'om', 'sm', 'gcr', 'alt', 'chr', 'ltg',
        'ny', 'pih', 'mad', 'got', 'st', 'ami', 'tn', 'bm', 'rmy', 've', 'ts',
        'chy', 'rn', 'ak', 'ss', 'iu', 'ff', 'ch', 'kcg', 'pnt', 'ady', 'ee',
        'ik', 'pcm', 'sg', 'din', 'pwn', 'kl', 'ti', 'dz', 'cr',
    ]
