...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'fi', 'hu', 'sh', 'cs', 'ro', 'eu', 'tr', 'ms', 'zh-min-nan', 'eo',
        'hy', 'he', 'bg', 'da', 'ce', 'sk', 'kk', 'min', 'hr', 'arz', 'et',
        'azb', 'lt', 'be', 'el', 'sl', 'gl', 'simple', 'az', 'ur', 'nn', 'hi',
        'th', 'ka', 'uz', 'la', 'ta', 'vo', 'cy', 'mk', 'lv', 'tg', 'ast',
        'mg', 'af', 'tt', 'oc', 'bn', 'bs', 'ky', 'sq', 'zh-yue', 'new', 'tl',
        'te', 'be-tarask', 'ml', 'br', 'pms', 'nds', 'su', 'ht', 'lb', 'jv',
        'sw', 'sco', 'mr', 'pnb', 'ga', 'szl', 'ba', 'is', 'my', 'fy', 'cv',
        'lmo', 'an', 'ne', 'pa', 'yo', 'bar', 'wuu', 'io', 'gu', 'als', 'ku',
        'scn', 'kn', 'ckb', 'bpy', 'ia', 'qu', 'vec', 'mn', 'bat-smg', 'wa',
        'or', 'si', 'cdo', 'gd', 'yi', 'am', 'nap', 'ilo', 'bug', 'xmf', 'hsb',
        'mai', 'diq', 'map-bms', 'fo', 'mzn', 'sd', 'nv', 'li', 'eml', 'sah',
        'os', 'sa', 'ps', 'frr', 'ace', 'mrj', 'zh-classical', 'mhr', 'hif',
        ...
        'ug', 'lez', 'stq', 'kw', 'haw', 'mwl', 'lfn', 'gn', 'gom', 'lij',
        'rm', 'lo', 'gor', 'lad', 'frp', 'koi', 'mt', 'fur', 'olo', 'dsb',
        'dty', 'ang', 'ext', 'ln', 'cbk-zam', 'dv', 'bjn', 'ksh', 'gag', 'pfl',
        'sat', 'pi', 'pag', 'av', 'ban', 'bxr', 'tyv', 'xal', 'krc', 'za',
