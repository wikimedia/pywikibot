...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'su', 'ht', 'sw', 'my', 'lb', 'pnb', 'ba', 'ga', 'szl', 'is', 'lmo',
        ...
        'nah', 'sc', 'ha', 'vep', 'lrc', 'sn', 'gan', 'myv', 'ab', 'glk', 'bo',
        'so', 'co', 'tk', 'zu', 'kab', 'fiu-vro', 'sat', 'kv', 'csb', 'ie',
        'ban', 'pcd', 'gv', 'udm', 'ay', 'ug', 'zea', 'nrm', 'lij', 'kw',
        'frp', 'lez', 'gn', 'lfn', 'stq', 'mwl', 'gom', 'rm', 'mt', 'lo',
        'lad', 'olo', 'koi', 'fur', 'bjn', 'ang', 'dty', 'dsb', 'ext', 'ln',
        'cbk-zam', 'ary', 'tyv', 'dv', 'ksh', 'gag', 'pfl', 'pi', 'pag', 'av',
        'awa', 'haw', 'bxr', 'xal', 'ig', 'krc', 'pap', 'za', 'rw', 'smn',
        'pdc', 'kaa', 'szy', 'arc', 'to', 'kbp', 'nov', 'jam', 'wo', 'tpi',
        'kbd', 'inh', 'na', 'tet', 'atj', 'tcy', 'ki', 'ak', 'jbo', 'roa-rup',
        'bi', 'lbe', 'lg', 'xh', 'kg', 'ty', 'mdf', 'lld', 'fj', 'srn', 'gcr',
        'om', 'ltg', 'ts', 'tn', 'sm', 'chr', 'nqo', 'got', 'kl', 'pih', 'st',
        'mnw', 'ny', 'cu', 'tw', 'bm', 'rmy', 'chy', 'rn', 'tum', 'ss', 'ch',
