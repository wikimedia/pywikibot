...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sv', 'vi', 'uk', 'ca', 'no', 'fi', 'cs', 'hu', 'fa', 'ro', 'ko',
            'ar', 'tr', 'id', 'sk', 'eo', 'da', 'sr', 'kk', 'lt', 'ms', 'he',
            'eu', 'bg', 'sl', 'vo', 'hr', 'war', 'hi', 'et', 'gl', 'az', 'nn',
            'simple', 'la', 'el', 'th', 'oc', 'new', 'sh', 'mk', 'roa-rup',
            'ka', 'tl', 'ht', 'pms', 'be', 'te', 'ta', 'be-x-old', 'lv', 'br',
            'uz', 'ceb', 'sq', 'jv', 'mg', 'cy', 'mr', 'lb', 'is', 'bs', 'hy',
            'my', 'yo', 'an', 'lmo', 'ml', 'pnb', 'fy', 'bpy', 'sw', 'bn', 'af',
            'io', 'ne', 'gu', 'zh-yue', 'nds', 'ur', 'ku', 'ba', 'ast', 'scn',
            'qu', 'su', 'diq', 'tt', 'ga', 'cv', 'ia', 'nap', 'bat-smg',
            'map-bms', 'wa', 'als', 'kn', 'am', 'ky', 'gd', 'bug', 'ckb', 'tg',
            'sco', 'mzn', 'zh-min-nan', 'yi', 'vec', 'hif', 'arz', 'roa-tara',
            'nah', 'os', 'sah', 'mn', 'sa', 'pam', 'hsb', 'li', 'mi', 'si',
            'co', 'gan', 'glk', 'fo', 'bar', 'se', 'ilo', 'bo', 'bcl', 'mrj',
            'nds-nl', 'fiu-vro', 'tk', 'ps', 'vls', 'gv', 'rue', 'dv', 'pa',
            'pag', 'xmf', 'nrm', 'kv', 'koi', 'zea', 'rm', 'km', 'csb', 'udm',
            'lad', 'mhr', 'fur', 'mt', 'lij', 'or', 'wuu', 'ug', 'pi', 'sc',
            'zh-classical', 'bh', 'frr', 'nov', 'ksh', 'ang', 'so', 'kw', 'stq',
            'nv', 'hak', 'ay', 'frp', 'ext', 'pcd', 'szl', 'gag', 'vep', 'ie',
            'ln', 'gn', 'haw', 'xal', 'eml', 'rw', 'pdc', 'pfl', 'krc', 'crh',
            'ace', 'to', 'ce', 'kl', 'arc', 'as', 'myv', 'dsb', 'bjn', 'pap',
            'sn', 'tpi', 'lbe', 'mdf', 'wo', 'jbo', 'kab', 'av', 'srn',
            'cbk-zam', 'lez', 'ty', 'kbd', 'lo', 'ab', 'tet', 'mwl', 'ltg',
            'na', 'ig', 'kg', 'za', 'kaa', 'nso', 'zu', 'rmy', 'chy', 'cu',
            'tn', 'chr', 'bxr', 'cdo', 'got', 'sm', 'bi', 'bm', 'iu', 'pih',
            'ss', 'sd', 'pnt', 'ee', 'ha', 'ti', 'ts', 'om', 'ks', 'ki', 've',
            'sg', 'rn', 'cr', 'ak', 'lg', 'dz', 'ny', 'ik', 'ch', 'ff', 'tum',
            'st', 'fj', 'tw', 'xh',
        ]
