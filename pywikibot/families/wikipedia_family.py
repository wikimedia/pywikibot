...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'bar', 'io', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'qu', 'mn', 'nv',
        'avk', 'si', 'xmf', 'bat-smg', 'or', 'gd', 'cdo', 'ilo', 'yi', 'am',
        'sd', 'bug', 'nap', 'frr', 'os', 'hsb', 'map-bms', 'mai', 'fo', 'li',
        'sah', 'mzn', 'crh', 'ha', 'eml', 'ps', 'ace', 'gor', 'sa', 'bcl',
        'wa', 'zh-classical', 'lij', 'zu', 'ban', 'mhr', 'mrj', 'hif', 'shn',
        'as', 'hak', 'roa-tara', 'hyw', 'pam', 'ie', 'nso', 'km', 'rue', 'mni',
        'se', 'bh', 'vls', 'nds-nl', 'sn', 'mi', 'nah', 'sc', 'so', 'sat',
        'vep', 'myv', 'gan', 'glk', 'kab', 'tk', 'co', 'bo', 'fiu-vro', 'ab',
        'kv', 'csb', 'pcd', 'frp', 'udm', 'ug', 'gv', 'kw', 'ay', 'zea', 'ary',
        'nrm', 'gn', 'bjn', 'mt', 'lez', 'lfn', 'stq', 'lo', 'mwl', 'skr',
        'smn', 'rm', 'olo', 'lad', 'gom', 'fur', 'koi', 'ang', 'ext', 'dsb',
        'dty', 'tyv', 'ln', 'cbk-zam', 'dv', 'ksh', 'gag', 'bxr', 'pfl', 'rw',
        'av', 'pi', 'pag', 'ig', 'awa', 'haw', 'tay', 'pap', 'xal', 'krc',
        'szy', 'za', 'pdc', 'kaa', 'inh', 'atj', 'arc', 'to', 'kbp', 'tpi',
        'jam', 'na', 'wo', 'kbd', 'tcy', 'lld', 'nov', 'mdf', 'ki', 'tet',
        'lg', 'bi', 'jbo', 'roa-rup', 'fj', 'lbe', 'kg', 'xh', 'ty', 'tw',
        'mnw', 'srn', 'nqo', 'om', 'shi', 'trv', 'gcr', 'sm', 'chr', 'ltg',
        'alt', 'nia', 'ks', 'pih', 'ny', 'got', 'cu', 'st', 'dag', 'mad',
