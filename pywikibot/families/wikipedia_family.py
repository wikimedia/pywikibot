...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'id', 'ar', 'kk', 'tr', 'sk', 'eo', 'da', 'sr', 'lt', 'ms', 'eu',
            'bg', 'he', 'sl', 'vo', 'hr', 'war', 'hi', 'et', 'gl', 'nn', 'az',
            'simple', 'la', 'el', 'th', 'sh', 'oc', 'new', 'mk', 'uz', 'ka',
            'tl', 'pms', 'be', 'ht', 'te', 'ta', 'roa-rup', 'be-x-old', 'lv',
            'br', 'sq', 'ceb', 'jv', 'mg', 'cy', 'mr', 'lb', 'is', 'hy', 'bs',
            'my', 'yo', 'an', 'lmo', 'ml', 'pnb', 'fy', 'af', 'bpy', 'bn', 'sw',
            'io', 'ba', 'scn', 'ur', 'ne', 'gu', 'zh-yue', 'ky', 'nds', 'ku',
            'ast', 'qu', 'su', 'ga', 'tt', 'cv', 'ia', 'nap', 'bat-smg', 'als',
            'map-bms', 'wa', 'kn', 'sco', 'ckb', 'am', 'gd', 'bug', 'hif', 'tg',
            'mzn', 'zh-min-nan', 'yi', 'diq', 'vec', 'arz', 'roa-tara', 'nah',
            'os', 'sa', 'mn', 'sah', 'pam', 'hsb', 'li', 'si', 'mi', 'se', 'co',
            'gan', 'bo', 'bar', 'glk', 'fo', 'ilo', 'bcl', 'mrj', 'fiu-vro',
            'nds-nl', 'tk', 'pa', 'ps', 'vls', 'gv', 'rue', 'xmf', 'pag', 'dv',
            'zea', 'kv', 'nrm', 'koi', 'km', 'rm', 'csb', 'lad', 'or', 'udm',
            'lij', 'fur', 'mhr', 'wuu', 'mt', 'ug', 'frr', 'zh-classical', 'sc',
            'pi', 'bh', 'vep', 'ksh', 'nov', 'so', 'stq', 'ang', 'kw', 'nv',
            'ay', 'hak', 'pcd', 'frp', 'ext', 'gn', 'szl', 'gag', 'ie', 'ln',
            'xal', 'eml', 'haw', 'pfl', 'pdc', 'rw', 'krc', 'crh', 'as', 'ace',
            'to', 'ce', 'kl', 'arc', 'dsb', 'myv', 'pap', 'bjn', 'sn', 'lez',
            'tpi', 'kab', 'lbe', 'jbo', 'mdf', 'wo', 'bxr', 'av', 'srn',
            'cbk-zam', 'mwl', 'ty', 'lo', 'kbd', 'ab', 'tet', 'ltg', 'na', 'kg',
            'ig', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy', 'cu', 'tn', 'chr',
            'got', 'cdo', 'sm', 'bi', 'bm', 'iu', 'pih', 'ss', 'pnt', 'sd',
            'ki', 'ee', 'ha', 'om', 'fj', 'ti', 'ts', 'ks', 've', 'sg', 'rn',
            'cr', 'ak', 'tum', 'lg', 'dz', 'ny', 'ik', 'ch', 'ff', 'st', 'tw',
            'xh',
        ]
