...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ht', 'pms', 'pnb', 'su', 'lb', 'ba', 'ku', 'ga', 'lmo', 'szl', 'is',
        'cv', 'fy', 'ckb', 'tl', 'an', 'wuu', 'diq', 'sco', 'pa', 'io', 'vo',
        'ne', 'yo', 'gu', 'als', 'kn', 'bar', 'scn', 'avk', 'bpy', 'ia', 'qu',
        'mn', 'crh', 'nv', 'xmf', 'ha', 'si', 'bat-smg', 'os', 'ps', 'ban',
        'frr', 'or', 'gd', 'cdo', 'bug', 'sah', 'yi', 'ilo', 'sd', 'am', 'nap',
        'li', 'hsb', 'fo', 'map-bms', 'mai', 'mzn', 'gor', 'ig', 'eml', 'ace',
        'bcl', 'shn', 'sa', 'zh-classical', 'wa', 'ie', 'lij', 'as', 'zu',
        'mhr', 'mrj', 'hyw', 'hif', 'mni', 'km', 'hak', 'roa-tara', 'sn',
        'pam', 'so', 'nso', 'rue', 'bh', 'tum', 'se', 'myv', 'vls', 'mi',
        'nds-nl', 'sat', 'sc', 'nah', 'vep', 'gan', 'tk', 'kab', 'glk', 'co',
        'fiu-vro', 'bjn', 'ab', 'bo', 'ary', 'gv', 'frp', 'kw', 'skr', 'kv',
        'ug', 'pcd', 'csb', 'udm', 'zea', 'ay', 'gn', 'mt', 'nrm', 'smn',
        'lez', 'lfn', 'stq', 'olo', 'mwl', 'lo', 'rw', 'ang', 'fur', 'rm',
        'lad', 'gom', 'koi', 'ext', 'tyv', 'dsb', 'dty', 'ln', 'av', 'cbk-zam',
        'dv', 'ksh', 'pap', 'gag', 'bxr', 'pfl', 'pag', 'pi', 'haw', 'awa',
        'tay', 'ks', 'dag', 'kaa', 'mdf', 'tw', 'inh', 'krc', 'szy', 'xal',
        'za', 'blk', 'pdc', 'atj', 'to', 'arc', 'tcy', 'kbp', 'jam', 'na',
        'wo', 'kbd', 'nia', 'nov', 'ki', 'mnw', 'lg', 'bi', 'tpi', 'nqo',
        'tet', 'jbo', 'roa-rup', 'fj', 'lbe', 'kg', 'xh', 'ty', 'cu', 'shi',
        'srn', 'guw', 'trv', 'om', 'sm', 'gcr', 'alt', 'chr', 'ltg', 'ny',
        'pih', 'mad', 'got', 'st', 'tn', 'ami', 'bm', 'rmy', 've', 'ts', 'chy',
        'rn', 'ak', 'ss', 'ff', 'iu', 'kcg', 'ch', 'pnt', 'ee', 'ady', 'ik',
        'pcm', 'sg', 'din', 'pwn', 'kl', 'ti', 'dz', 'cr',
    ]
