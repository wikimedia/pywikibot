...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'pms', 'ht', 'pnb', 'su', 'lb', 'ba', 'ga', 'szl', 'is', 'ku', 'lmo',
        'cv', 'fy', 'tl', 'wuu', 'ckb', 'an', 'sco', 'diq', 'pa', 'yo', 'io',
        'ne', 'bar', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'qu', 'avk', 'mn',
        'lld', 'nv', 'xmf', 'crh', 'si', 'bat-smg', 'ha', 'os', 'frr', 'gd',
        ...
        'rue', 'so', 'sn', 'bh', 'se', 'myv', 'vls', 'nds-nl', 'mi', 'nah',
        'sc', 'sat', 'vep', 'gan', 'kab', 'glk', 'tk', 'ig', 'fiu-vro', 'co',
        ...
        'gag', 'bxr', 'pfl', 'pag', 'pi', 'pap', 'haw', 'awa', 'tum', 'tay',
        'krc', 'inh', 'xal', 'szy', 'za', 'tw', 'pdc', 'kaa', 'atj', 'to',
        'dag', 'arc', 'mdf', 'tpi', 'kbp', 'jam', 'na', 'wo', 'kbd', 'tcy',
        'nov', 'nia', 'tet', 'ki', 'lg', 'bi', 'jbo', 'roa-rup', 'fj', 'lbe',
        'kg', 'nqo', 'xh', 'ty', 'mnw', 'cu', 'ks', 'shi', 'trv', 'srn', 'om',
