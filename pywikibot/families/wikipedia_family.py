...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'simple', 'th', 'la', 'el', 'new', 'roa-rup', 'oc', 'tl', 'sh',
            'ka', 'mk', 'ht', 'pms', 'te', 'ta', 'ceb', 'be-x-old', 'br', 'sq',
            'lv', 'be', 'jv', 'mg', 'cy', 'lb', 'mr', 'is', 'bs', 'yo', 'an',
            'bpy', 'hy', 'lmo', 'fy', 'sw', 'bn', 'ml', 'io', 'gu', 'af', 'pnb',
            'ne', 'nds', 'scn', 'ku', 'ur', 'zh-yue', 'su', 'qu', 'diq', 'ba',
            'ast', 'tt', 'ga', 'nap', 'ia', 'cv', 'bat-smg', 'map-bms', 'wa',
            'am', 'kn', 'als', 'bug', 'my', 'zh-min-nan', 'gd', 'tg', 'yi',
            'vec', 'roa-tara', 'hif', 'os', 'sco', 'arz', 'nah', 'sah', 'uz',
            'pam', 'sa', 'mn', 'hsb', 'mi', 'li', 'si', 'co', 'gan', 'glk',
            'ky', 'bcl', 'fo', 'ckb', 'bar', 'bo', 'mrj', 'ilo', 'fiu-vro',
            'nds-nl', 'tk', 'vls', 'se', 'gv', 'dv', 'nrm', 'rue', 'pag', 'pa',
            'rm', 'ps', 'mzn', 'km', 'udm', 'csb', 'fur', 'mt', 'wuu', 'koi',
            'kv', 'ug', 'lij', 'mhr', 'ang', 'pi', 'lad', 'sc', 'bh', 'zea',
            'zh-classical', 'nov', 'ksh', 'cbk-zam', 'or', 'so', 'nv', 'hak',
            'kw', 'frp', 'stq', 'xmf', 'szl', 'ext', 'pcd', 'ie', 'frr', 'ay',
            'xal', 'haw', 'rw', 'ln', 'pdc', 'pfl', 'krc', 'ace', 'to', 'crh',
            'eml', 'ce', 'gn', 'kl', 'myv', 'arc', 'gag', 'pap', 'bjn', 'as',
            'lbe', 'dsb', 'tpi', 'wo', 'jbo', 'kab', 'mdf', 'av', 'sn', 'ty',
            'srn', 'lo', 'ab', 'ltg', 'ig', 'mwl', 'na', 'kg', 'tet', 'kaa',
            'nso', 'rmy', 'cu', 'tn', 'kbd', 'sm', 'bi', 'sd', 'bm', 'zu', 'ik',
            'iu', 'ss', 'pih', 'za', 'chr', 'pnt', 'got', 'cdo', 'ee', 'ha',
            'ti', 'ks', 'om', 'bxr', 've', 'ts', 'sg', 'rn', 'cr', 'dz', 'lg',
            'ak', 'chy', 'fj', 'tum', 'st', 'vep', 'ch', 'xh', 'ny', 'tw', 'ff',
            'ki',
        ]
