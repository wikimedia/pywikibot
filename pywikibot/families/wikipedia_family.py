...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'hr', 'et', 'lt', 'be', 'el', 'tt', 'simple', 'az', 'sl', 'gl', 'ur',
        'nn', 'ka', 'hi', 'th', 'uz', 'la', 'cy', 'ta', 'vo', 'mk', 'ast',
        'lv', 'zh-yue', 'tg', 'bn', 'af', 'mg', 'oc', 'bs', 'sq', 'ky', 'nds',
        'new', 'be-tarask', 'ml', 'te', 'br', 'vec', 'tl', 'pms', 'mr', 'su',
        ...
        'udm', 'pcd', 'kab', 'ay', 'zea', 'sat', 'zu', 'nrm', 'ug', 'lij',
        'ban', 'kw', 'frp', 'lez', 'lfn', 'stq', 'gn', 'mwl', 'gom', 'rm',
        ...
        'kbd', 'inh', 'na', 'tet', 'wo', 'tcy', 'ki', 'ak', 'atj', 'jbo', 'bi',
        'roa-rup', 'lbe', 'kg', 'ty', 'lg', 'mdf', 'fj', 'lld', 'srn', 'xh',
        'gcr', 'ltg', 'chr', 'sm', 'om', 'kl', 'got', 'pih', 'st', 'ny', 'cu',
        'nqo', 'tn', 'tw', 'ts', 'mnw', 'rmy', 'bm', 'chy', 'rn', 'tum', 'ss',
        'ch', 'iu', 'pnt', 'ks', 'ady', 've', 'ee', 'ik', 'ff', 'sg', 'din',
        'dz', 'ti', 'cr', 'smn',
    ]
