...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'hi', 'ka', 'tt', 'th', 'uz', 'la', 'cy', 'ta', 'vo', 'mk', 'ast',
        'lv', 'zh-yue', 'tg', 'bn', 'af', 'mg', 'oc', 'bs', 'sq', 'ky', 'nds',
        'new', 'be-tarask', 'ml', 'te', 'br', 'tl', 'vec', 'pms', 'mr', 'su',
        'ht', 'sw', 'lb', 'jv', 'pnb', 'ba', 'ga', 'szl', 'is', 'my', 'sco',
        'fy', 'cv', 'lmo', 'wuu', 'an', 'pa', 'ne', 'diq', 'ku', 'yo', 'bar',
        'io', 'gu', 'ckb', 'als', 'kn', 'scn', 'bpy', 'qu', 'ia', 'mn',
        'bat-smg', 'si', 'nv', 'or', 'cdo', 'ilo', 'gd', 'xmf', 'yi', 'am',
        'nap', 'wa', 'bug', 'sd', 'hsb', 'mai', 'fo', 'map-bms', 'mzn', 'li',
        'sah', 'eml', 'os', 'ps', 'sa', 'frr', 'bcl', 'zh-classical', 'ace',
        'mrj', 'mhr', 'hif', 'avk', 'hak', 'gor', 'roa-tara', 'pam', 'hyw',
        'km', 'nso', 'rue', 'crh', 'se', 'bh', 'as', 'shn', 'vls', 'mi',
        'nds-nl', 'nah', 'sc', 'vep', 'gan', 'myv', 'sn', 'ab', 'glk', 'bo',
        'co', 'lrc', 'so', 'tk', 'fiu-vro', 'csb', 'kv', 'ha', 'ie', 'gv',
        'udm', 'pcd', 'ay', 'kab', 'zea', 'sat', 'nrm', 'ug', 'lij', 'zu',
        'kw', 'lez', 'frp', 'ban', 'stq', 'lfn', 'gn', 'mwl', 'gom', 'rm',
        ...
        'lld', 'chr', 'ak', 'om', 'sm', 'kl', 'got', 'pih', 'st', 'cu', 'ny',
