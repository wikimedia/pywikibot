...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'so', 'zea', 'udm', 'ay', 'lez', 'stq', 'ie', 'nrm', 'kw', 'lad',
            'ug', 'pcd', 'mwl', 'sn', 'rm', 'gom', 'gn', 'koi', 'ab', 'lij',
            'mt', 'fur', 'dsb', 'dv', 'ang', 'ln', 'cbk-zam', 'frp', 'kab',
            'ext', 'dty', 'ksh', 'lo', 'gag', 'olo', 'pag', 'pi', 'av', 'haw',
            'bxr', 'pfl', 'xal', 'krc', 'pap', 'kaa', 'rw', 'pdc', 'bjn', 'ha',
            'to', 'nov', 'kl', 'arc', 'jam', 'kbd', 'tyv', 'tpi', 'kbp', 'lfn',
            'tet', 'ki', 'na', 'ig', 'jbo', 'lbe', 'roa-rup', 'ty', 'gor',
            'mdf', 'za', 'kg', 'bi', 'wo', 'lg', 'srn', 'tcy', 'zu', 'chr',
            'ltg', 'sm', 'om', 'inh', 'xh', 'rmy', 'cu', 'tn', 'pih', 'bm',
            'rn', 'chy', 'tw', 'tum', 'ts', 'got', 'st', 'ak', 'atj', 'pnt',
