...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh', 'vi', 'uk', 'ca', 'no', 'fi', 'cs', 'hu', 'ko', 'id', 'tr',
            'fa', 'ro', 'ar', 'sk', 'da', 'eo', 'sr', 'lt', 'sl', 'ms', 'he',
            'bg', 'kk', 'eu', 'vo', 'war', 'hr', 'hi', 'et', 'az', 'gl', 'nn',
            'simple', 'la', 'th', 'el', 'new', 'roa-rup', 'oc', 'ka', 'sh',
            'mk', 'tl', 'ht', 'pms', 'te', 'ta', 'be-x-old', 'ceb', 'br', 'sq',
            'lv', 'be', 'jv', 'mg', 'lb', 'cy', 'mr', 'is', 'bs', 'yo', 'an',
            'hy', 'bpy', 'lmo', 'fy', 'sw', 'ml', 'io', 'bn', 'af', 'pnb', 'gu',
            'ne', 'nds', 'ku', 'zh-yue', 'scn', 'ur', 'su', 'qu', 'diq', 'ba',
            'ast', 'tt', 'ga', 'cv', 'ia', 'nap', 'bat-smg', 'map-bms', 'my',
            'wa', 'am', 'kn', 'als', 'bug', 'gd', 'zh-min-nan', 'tg', 'yi',
            'vec', 'roa-tara', 'hif', 'sco', 'os', 'arz', 'nah', 'sah', 'uz',
            'sa', 'pam', 'mn', 'hsb', 'mi', 'li', 'si', 'co', 'ky', 'gan',
            'glk', 'ckb', 'bo', 'bcl', 'fo', 'bar', 'mrj', 'ilo', 'fiu-vro',
            'nds-nl', 'tk', 'vls', 'se', 'gv', 'dv', 'rue', 'nrm', 'pag', 'mzn',
            'pa', 'ps', 'rm', 'koi', 'km', 'udm', 'kv', 'csb', 'mhr', 'fur',
            'mt', 'wuu', 'ug', 'lij', 'ang', 'lad', 'pi', 'sc', 'bh', 'zea',
            'zh-classical', 'nov', 'ksh', 'or', 'so', 'nv', 'cbk-zam', 'kw',
            'hak', 'frp', 'stq', 'ay', 'xmf', 'ext', 'szl', 'pcd', 'frr', 'ie',
            'gag', 'haw', 'xal', 'ln', 'rw', 'pdc', 'pfl', 'krc', 'crh', 'ace',
            'eml', 'to', 'gn', 'ce', 'kl', 'myv', 'arc', 'dsb', 'pap', 'as',
            'bjn', 'tpi', 'lbe', 'wo', 'mdf', 'jbo', 'kab', 'av', 'sn', 'ty',
            'srn', 'lo', 'ab', 'ltg', 'mwl', 'ig', 'na', 'kg', 'tet', 'kbd',
            'kaa', 'nso', 'rmy', 'cu', 'tn', 'lez', 'zu', 'chr', 'sm', 'bi',
            'sd', 'bm', 'ik', 'iu', 'pih', 'ss', 'za', 'pnt', 'got', 'cdo',
            'ee', 'ha', 'ti', 'om', 'ks', 'bxr', 'chy', 'vep', 'ts', 've', 'sg',
            'rn', 'dz', 'cr', 'lg', 'ak', 'fj', 'tum', 'st', 'ki', 'ch', 'ff',
            'xh', 'ny', 'tw',
        ]
        ...
        self.cross_allowed = [
            ...
            'ln', 'lo', 'ltg', 'lv', 'map-bms', 'mdf', 'mg', 'mhr', 'mi', 'mk',
            'ml', 'mn', 'mrj', 'ms', 'mwl', 'my', 'myv', 'mzn', 'na', 'nah',
            'nap', 'nds-nl', 'ne', 'new', 'nl', 'no', 'nov', 'nrm', 'nv', 'ny',
            'oc', 'om', 'or', 'os', 'pa', 'pag', 'pam', 'pap', 'pdc', 'pfl',
            'pi', 'pih', 'pms', 'pnb', 'pnt', 'ps', 'qu', 'rm', 'rmy', 'rn',
            'roa-rup', 'roa-tara', 'ru', 'rue', 'rw', 'sa', 'sah', 'sc', 'scn',
            'sco', 'sd', 'se', 'sg', 'sh', 'si', 'simple', 'sk', 'sm', 'sn',
            'so', 'srn', 'ss', 'st', 'stq', 'su', 'sv', 'sw', 'szl', 'ta', 'te',
            'tet', 'tg', 'th', 'ti', 'tk', 'tl', 'tn', 'to', 'tpi', 'tr', 'ts',
            'tt', 'tum', 'tw', 'ty', 'udm', 'ug', 'uz', 've', 'vec', 'vep',
            'vls', 'vo', 'wa', 'war', 'wo', 'xal', 'xh', 'yi', 'yo', 'za',
