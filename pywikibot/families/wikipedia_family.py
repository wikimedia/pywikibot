...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'tr', 'ro', 'ar', 'sk', 'eo', 'da', 'sr', 'lt', 'eu', 'sl', 'ms',
            ...
            'ne', 'nds', 'ku', 'zh-yue', 'scn', 'ur', 'ast', 'su', 'qu', 'diq',
            ...
            'glk', 'ckb', 'bo', 'fo', 'bar', 'bcl', 'ilo', 'mrj', 'fiu-vro',
            'nds-nl', 'tk', 'vls', 'se', 'mzn', 'gv', 'dv', 'rue', 'ps', 'nrm',
            'pag', 'koi', 'pa', 'rm', 'km', 'kv', 'udm', 'csb', 'mhr', 'fur',
            'mt', 'wuu', 'ug', 'lij', 'lad', 'pi', 'zea', 'sc', 'bh',
            'zh-classical', 'nov', 'ksh', 'ang', 'or', 'so', 'kw', 'nv', 'hak',
            'ay', 'xmf', 'frp', 'stq', 'ext', 'szl', 'frr', 'pcd', 'ie', 'gag',
            'haw', 'xal', 'ln', 'rw', 'pdc', 'pfl', 'krc', 'crh', 'ace', 'eml',
            'to', 'gn', 'ce', 'kl', 'arc', 'myv', 'dsb', 'bjn', 'pap', 'as',
            'tpi', 'lbe', 'mdf', 'wo', 'vep', 'jbo', 'kab', 'av', 'cbk-zam',
            'sn', 'ty', 'srn', 'lo', 'ab', 'kbd', 'lez', 'ltg', 'mwl', 'ig',
            'na', 'kg', 'tet', 'kaa', 'za', 'nso', 'zu', 'rmy', 'cu', 'tn',
            'chr', 'sm', 'bi', 'bm', 'iu', 'ik', 'pih', 'ss', 'sd', 'pnt',
            'got', 'chy', 'cdo', 'ee', 'ha', 'ti', 'bxr', 'om', 'ks', 'ts',
            've', 'sg', 'rn', 'dz', 'cr', 'lg', 'ak', 'ki', 'tum', 'fj', 'st',
            'ch', 'ff', 'ny', 'xh', 'tw',
        ]
