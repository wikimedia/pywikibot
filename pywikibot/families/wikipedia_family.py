...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh-yue', 'be-tarask', 'azb', 'ast', 'bn', 'ml', 'ht', 'jv', 'lb',
            'mr', 'sco', 'af', 'pnb', 'ga', 'is', 'ba', 'cv', 'fy', 'su', 'sw',
            'my', 'lmo', 'an', 'yo', 'ne', 'pa', 'gu', 'io', 'nds', 'scn',
            'bpy', 'als', 'bar', 'ku', 'kn', 'ia', 'qu', 'ckb', 'mn', 'arz',
            'bat-smg', 'gd', 'nap', 'wa', 'si', 'yi', 'bug', 'am', 'cdo', 'or',
            'map-bms', 'fo', 'mzn', 'hsb', 'xmf', 'mai', 'li', 'sah', 'sa',
            'vec', 'ilo', 'os', 'mrj', 'hif', 'mhr', 'bh', 'eml', 'roa-tara',
            'ps', 'diq', 'pam', 'sd', 'hak', 'nso', 'se', 'zh-classical',
            'bcl', 'ace', 'mi', 'nah', 'nds-nl', 'szl', 'wuu', 'gan', 'rue',
            'vls', 'frr', 'km', 'bo', 'vep', 'glk', 'sc', 'crh', 'fiu-vro',
            'co', 'lrc', 'tk', 'kv', 'csb', 'so', 'gv', 'as', 'lad', 'myv',
            'zea', 'nv', 'ay', 'udm', 'lez', 'stq', 'kw', 'ie', 'nrm', 'pcd',
            'mwl', 'rm', 'koi', 'ab', 'gom', 'ug', 'cbk-zam', 'lij', 'gn',
            'mt', 'fur', 'dsb', 'dv', 'ang', 'sn', 'ln', 'ext', 'kab', 'frp',
            'ksh', 'lo', 'gag', 'pag', 'pi', 'dty', 'olo', 'av', 'xal', 'pfl',
            'bxr', 'haw', 'krc', 'kaa', 'pap', 'rw', 'pdc', 'bjn', 'to', 'nov',
            'kl', 'ha', 'arc', 'jam', 'kbd', 'tyv', 'tpi', 'tet', 'ig', 'ki',
            'na', 'roa-rup', 'lbe', 'jbo', 'ty', 'mdf', 'kg', 'bi', 'za', 'wo',
            'lg', 'srn', 'tcy', 'chr', 'zu', 'ltg', 'sm', 'om', 'xh', 'rmy',
            'tn', 'cu', 'kbp', 'pih', 'chy', 'rn', 'tw', 'tum', 'ts', 'st',
            'got', 'pnt', 'ss', 'bm', 'ch', 'fj', 'ady', 'iu', 'ny', 'atj',
            'ee', 'ks', 'ak', 'ik', 've', 'sg', 'dz', 'ff', 'ti', 'cr', 'din',
        ]
