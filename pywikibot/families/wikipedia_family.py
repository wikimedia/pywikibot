...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'roa-tara', 'tum', 'so', 'pam', 'rue', 'nso', 'bh', 'sat', 'se', 'mi',
        'myv', 'vls', 'nds-nl', 'nah', 'sc', 'kw', 'glk', 'vep', 'tk', 'kab',
        'gan', 'co', 'ary', 'dag', 'fiu-vro', 'bo', 'ab', 'gv', 'skr', 'zea',
        'frp', 'ug', 'udm', 'pcd', 'kv', 'csb', 'mt', 'gn', 'rw', 'smn', 'ay',
        'nrm', 'lez', 'lfn', 'stq', 'olo', 'lo', 'mwl', 'ang', 'fur', 'rm',
        'lad', 'gom', 'koi', 'tyv', 'ext', 'dsb', 'av', 'dty', 'ln', 'kaa',
        'pap', 'cbk-zam', 'dv', 'ksh', 'mdf', 'gag', 'bxr', 'pfl', 'ks', 'tw',
