...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'kn', 'bar', 'ia', 'qu', 'su', 'ckb', 'bat-smg', 'mn', 'arz', 'nap',
            'wa', 'bug', 'gd', 'yi', 'map-bms', 'am', 'si', 'mzn', 'fo', 'nah',
            'li', 'sah', 'or', 'vec', 'hsb', 'os', 'mrj', 'sa', 'hif', 'azb',
            'mhr', 'roa-tara', 'pam', 'ilo', 'eml', 'sd', 'ps', 'bh', 'se',
            'xmf', 'mi', 'bcl', 'diq', 'hak', 'gan', 'glk', 'vls', 'nds-nl',
            'rue', 'bo', 'fiu-vro', 'co', 'sc', 'tk', 'csb', 'lrc', 'vep',
            'wuu', 'szl', 'km', 'crh', 'gv', 'kv', 'frr', 'zh-classical', 'zea',
            'as', 'so', 'cdo', 'stq', 'nso', 'kw', 'udm', 'ay', 'nrm', 'ie',
            'koi', 'ace', 'rm', 'lad', 'myv', 'pcd', 'mt', 'fur', 'gn', 'lij',
            'dsb', 'dv', 'mai', 'cbk-zam', 'ext', 'kab', 'ksh', 'ang', 'mwl',
            'lez', 'gag', 'ln', 'ug', 'pag', 'pi', 'sn', 'frp', 'gom', 'nv',
            'av', 'pfl', 'haw', 'xal', 'krc', 'kaa', 'rw', 'pdc', 'bxr', 'to',
            'kl', 'nov', 'arc', 'lo', 'kbd', 'pap', 'bjn', 'jam', 'ha', 'tet',
            'ki', 'tyv', 'tpi', 'na', 'ig', 'lbe', 'jbo', 'roa-rup', 'ty', 'za',
            'kg', 'mdf', 'lg', 'wo', 'srn', 'ab', 'tcy', 'ltg', 'zu', 'sm',
            'chr', 'om', 'tn', 'chy', 'rmy', 'tw', 'cu', 'tum', 'xh', 'bi',
            'rn', 'pih', 'got', 'ss', 'pnt', 'bm', 'ch', 'ady', 'ts', 'iu',
            'st', 'ee', 'ny', 'fj', 'ks', 'ak', 'ik', 'sg', 've', 'ff', 'dz',
            'ti', 'cr',
        ]
