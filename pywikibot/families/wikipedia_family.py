...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'be', 'arz', 'azb', 'el', 'sl', 'gl', 'az', 'simple', 'ur', 'nn', 'hi',
        ...
        'vls', 'crh', 'bh', 'nah', 'shn', 'nds-nl', 'sc', 'gan', 'vep', 'as',
        'ab', 'glk', 'bo', 'myv', 'co', 'so', 'tk', 'fiu-vro', 'kv', 'lrc',
        'csb', 'sn', 'gv', 'udm', 'ie', 'zea', 'pcd', 'ha', 'ay', 'kab', 'nrm',
        'ug', 'lez', 'stq', 'kw', 'haw', 'mwl', 'lfn', 'gn', 'gom', 'lij',
        'rm', 'lo', 'lad', 'frp', 'koi', 'mt', 'fur', 'dsb', 'olo', 'dty',
        'ang', 'ext', 'ln', 'cbk-zam', 'dv', 'bjn', 'ksh', 'gor', 'gag', 'pfl',
        'sat', 'pi', 'pag', 'av', 'ban', 'bxr', 'xal', 'tyv', 'krc', 'za',
        'pap', 'kaa', 'pdc', 'rw', 'szy', 'to', 'nov', 'kl', 'arc', 'jam',
        'tpi', 'kbp', 'kbd', 'tet', 'ig', 'wo', 'zu', 'ki', 'na', 'tcy', 'inh',
        'jbo', 'roa-rup', 'lbe', 'bi', 'ty', 'kg', 'mdf', 'lg', 'atj', 'srn',
