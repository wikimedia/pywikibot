...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'mrj', 'mhr', 'ps', 'hif', 'roa-tara', 'diq', 'hak', 'pam', 'bcl',
        ...
        'kw', 'lad', 'mwl', 'gn', 'gom', 'rm', 'lij', 'koi', 'ab', 'mt', 'fur',
        'frp', 'haw', 'dsb', 'shn', 'lo', 'ang', 'lfn', 'ln', 'dv', 'ext',
        'cbk-zam', 'dty', 'kab', 'ksh', 'olo', 'gag', 'ha', 'pi', 'pag', 'pfl',
        'av', 'bxr', 'xal', 'krc', 'bjn', 'pap', 'gor', 'kaa', 'za', 'pdc',
