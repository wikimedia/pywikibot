...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'vi', 'ja', 'zh', 'arz', 'ar', 'uk', 'pt', 'fa', 'ca', 'sr', 'no',
        'id', 'ko', 'fi', 'hu', 'cs', 'sh', 'ro', 'zh-min-nan', 'tr', 'eu',
        'ms', 'ce', 'eo', 'he', 'hy', 'bg', 'da', 'azb', 'sk', 'kk', 'min',
        'hr', 'et', 'lt', 'be', 'el', 'az', 'simple', 'sl', 'gl', 'ur', 'nn',
        'hi', 'ka', 'th', 'tt', 'uz', 'la', 'cy', 'ta', 'vo', 'mk', 'ast',
        'lv', 'zh-yue', 'tg', 'bn', 'af', 'mg', 'oc', 'bs', 'sq', 'ky', 'nds',
        'new', 'be-tarask', 'ml', 'te', 'br', 'tl', 'pms', 'vec', 'mr', 'su',
        'sw', 'ht', 'lb', 'jv', 'sco', 'pnb', 'ga', 'ba', 'szl', 'is', 'my',
        'fy', 'cv', 'lmo', 'wuu', 'an', 'pa', 'ne', 'yo', 'ku', 'bar', 'diq',
        'io', 'gu', 'als', 'ckb', 'kn', 'scn', 'bpy', 'qu', 'ia', 'mn',
        'bat-smg', 'or', 'nv', 'si', 'cdo', 'ilo', 'gd', 'xmf', 'yi', 'am',
        'nap', 'bug', 'wa', 'sd', 'mai', 'hsb', 'map-bms', 'fo', 'mzn', 'li',
        'sah', 'eml', 'os', 'ps', 'sa', 'frr', 'bcl', 'zh-classical', 'ace',
        'mrj', 'mhr', 'hif', 'avk', 'hak', 'roa-tara', 'gor', 'pam', 'hyw',
        'km', 'nso', 'rue', 'crh', 'se', 'bh', 'shn', 'as', 'vls', 'mi',
        'nds-nl', 'nah', 'sc', 'vep', 'gan', 'myv', 'ab', 'glk', 'sn', 'bo',
        'co', 'tk', 'so', 'lrc', 'fiu-vro', 'csb', 'kv', 'ha', 'ie', 'gv',
        'udm', 'pcd', 'ay', 'kab', 'zea', 'sat', 'nrm', 'ug', 'lij', 'kw',
        'lez', 'frp', 'zu', 'stq', 'lfn', 'ban', 'gn', 'mwl', 'gom', 'rm',
        'mt', 'lo', 'lad', 'koi', 'fur', 'olo', 'ang', 'dty', 'dsb', 'bjn',
        'ext', 'ln', 'cbk-zam', 'dv', 'ksh', 'gag', 'tyv', 'pfl', 'pag', 'ary',
        'pi', 'av', 'awa', 'haw', 'bxr', 'xal', 'krc', 'pap', 'za', 'pdc',
        'kaa', 'rw', 'szy', 'arc', 'to', 'nov', 'jam', 'tpi', 'kbp', 'kbd',
        'ig', 'na', 'tet', 'inh', 'wo', 'tcy', 'ki', 'atj', 'jbo', 'roa-rup',
        'bi', 'lbe', 'kg', 'ty', 'lg', 'mdf', 'fj', 'srn', 'xh', 'gcr', 'ltg',
        'chr', 'lld', 'ak', 'sm', 'om', 'kl', 'got', 'pih', 'st', 'cu', 'ny',
        'nqo', 'tn', 'tw', 'ts', 'rmy', 'bm', 'mnw', 'chy', 'rn', 'tum', 'ss',
