...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'no', 'ko', 'fi', 'hu', 'cs', 'sh', 'ce', 'zh-min-nan', 'tr', 'ro',
        ...
        'sd', 'nap', 'frr', 'os', 'bug', 'hsb', 'map-bms', 'mai', 'fo', 'li',
        'sah', 'mzn', 'eml', 'ha', 'ace', 'ps', 'gor', 'crh', 'sa', 'bcl',
        'wa', 'zh-classical', 'lij', 'mrj', 'mhr', 'zu', 'hif', 'ban', 'shn',
        'as', 'hak', 'roa-tara', 'hyw', 'pam', 'nso', 'ie', 'km', 'rue', 'se',
        'bh', 'vls', 'nds-nl', 'sn', 'mi', 'sc', 'nah', 'vep', 'so', 'sat',
        'myv', 'gan', 'glk', 'kab', 'tk', 'co', 'bo', 'fiu-vro', 'ab', 'kv',
        'csb', 'mni', 'pcd', 'frp', 'udm', 'ug', 'gv', 'ay', 'zea', 'kw',
        'ary', 'nrm', 'bjn', 'gn', 'mt', 'lez', 'lfn', 'stq', 'lo', 'mwl',
        'skr', 'rm', 'olo', 'smn', 'lad', 'gom', 'fur', 'koi', 'ang', 'dty',
        'dsb', 'ext', 'tyv', 'ln', 'cbk-zam', 'dv', 'ksh', 'gag', 'bxr', 'pfl',
        'pag', 'pi', 'av', 'awa', 'tay', 'haw', 'ig', 'rw', 'pap', 'xal',
        'krc', 'szy', 'za', 'pdc', 'kaa', 'inh', 'arc', 'to', 'kbp', 'jam',
        'na', 'wo', 'tpi', 'kbd', 'atj', 'tcy', 'nov', 'ki', 'mdf', 'tet',
        'lld', 'ak', 'bi', 'lg', 'jbo', 'roa-rup', 'lbe', 'kg', 'fj', 'ty',
        'xh', 'srn', 'om', 'nqo', 'trv', 'gcr', 'shi', 'sm', 'ltg', 'alt',
        'nia', 'chr', 'tw', 'mnw', 'ks', 'pih', 'got', 'ny', 'st', 'mad', 'kl',
        'cu', 'tn', 'bm', 'ts', 'rmy', 'dag', 've', 'chy', 'rn', 'tum', 'iu',
