...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'wuu', 'yi', 'am', 'or', 'bug', 'cdo', 'map-bms', 'hsb', 'mai', 'fo',
        ...
        'glk', 'co', 'tk', 'so', 'fiu-vro', 'myv', 'lrc', 'kv', 'csb', 'as',
        'gv', 'udm', 'zea', 'ay', 'ie', 'ug', 'sn', 'pcd', 'nrm', 'stq', 'lez',
        'kw', 'lad', 'mwl', 'gn', 'rm', 'gom', 'lij', 'koi', 'ab', 'mt', 'fur',
        'frp', 'dsb', 'haw', 'ang', 'lo', 'ln', 'ext', 'dv', 'cbk-zam', 'lfn',
        ...
        'pih', 'rmy', 'cu', 'bm', 'tw', 'tn', 'atj', 'rn', 'chy', 'got', 'ts',
        'tum', 'ak', 'st', 'ch', 'ny', 'pnt', 'ss', 'sat', 'fj', 'ady', 'iu',
