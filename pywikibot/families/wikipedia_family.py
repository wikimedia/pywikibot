...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ko', 'no', 'fi', 'cs', 'hu', 'tr', 'ce', 'sh', 'zh-min-nan', 'ro',
        ...
        'nds', 'ky', 'ml', 'be-tarask', 'te', 'new', 'sw', 'br', 'vec', 'jv',
        'pms', 'pnb', 'ht', 'su', 'lb', 'ba', 'ga', 'szl', 'is', 'ku', 'lmo',
        'cv', 'fy', 'tl', 'wuu', 'an', 'ckb', 'sco', 'diq', 'pa', 'yo', 'ne',
        'io', 'bar', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'qu', 'avk', 'mn',
        'nv', 'xmf', 'crh', 'si', 'lld', 'bat-smg', 'or', 'gd', 'frr', 'os',
        'cdo', 'yi', 'ilo', 'sd', 'ha', 'bug', 'am', 'nap', 'sah', 'ps', 'hsb',
        'map-bms', 'fo', 'mai', 'li', 'ban', 'mzn', 'eml', 'gor', 'ace', 'bcl',
        'sa', 'wa', 'zh-classical', 'lij', 'shn', 'zu', 'mrj', 'mhr', 'as',
        'hif', 'hyw', 'mni', 'hak', 'roa-tara', 'km', 'ie', 'pam', 'nso',
        'rue', 'so', 'sn', 'bh', 'se', 'myv', 'vls', 'nds-nl', 'nah', 'mi',
        'sc', 'sat', 'vep', 'gan', 'kab', 'glk', 'tk', 'fiu-vro', 'co', 'bo',
        'ab', 'frp', 'kv', 'csb', 'pcd', 'kw', 'gv', 'ug', 'ary', 'udm', 'ay',
        'skr', 'nrm', 'zea', 'gn', 'mt', 'bjn', 'lez', 'smn', 'ig', 'lfn',
        'stq', 'lo', 'mwl', 'olo', 'rm', 'fur', 'lad', 'ang', 'gom', 'koi',
        'ext', 'tyv', 'dsb', 'dty', 'ln', 'cbk-zam', 'rw', 'dv', 'ksh', 'gag',
        'bxr', 'av', 'pfl', 'pag', 'pi', 'haw', 'awa', 'pap', 'tay', 'krc',
        'xal', 'szy', 'inh', 'za', 'kaa', 'pdc', 'atj', 'tw', 'to', 'tum',
        'arc', 'dag', 'tpi', 'kbp', 'jam', 'mdf', 'na', 'wo', 'kbd', 'tcy',
        'nov', 'ki', 'nia', 'tet', 'lg', 'bi', 'jbo', 'roa-rup', 'fj', 'lbe',
        'kg', 'xh', 'nqo', 'ty', 'mnw', 'ks', 'cu', 'shi', 'trv', 'srn', 'om',
        'sm', 'gcr', 'alt', 'chr', 'ltg', 'pih', 'ny', 'got', 'mad', 'st',
        'ami', 'guw', 'rmy', 'tn', 'bm', 'ts', 'chy', 've', 'rn', 'iu', 'ak',
        'ss', 'ch', 'pnt', 'ady', 'ik', 'ff', 'ee', 'din', 'sg', 'pwn', 'kl',
        'ti', 'dz', 'cr',
    ]
