...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'min', 'et', 'be', 'hr', 'el', 'lt', 'simple', 'az', 'gl', 'sl', 'ur',
        ...
        'avk', 'nv', 'si', 'bat-smg', 'or', 'gd', 'cdo', 'ilo', 'yi', 'am',
        'sd', 'bug', 'frr', 'nap', 'os', 'crh', 'hsb', 'map-bms', 'mai', 'ha',
        'fo', 'sah', 'li', 'mzn', 'eml', 'ps', 'gor', 'ace', 'sa', 'bcl', 'wa',
        'ban', 'zh-classical', 'lij', 'zu', 'mhr', 'mrj', 'shn', 'hif', 'mni',
        'as', 'hak', 'roa-tara', 'hyw', 'pam', 'km', 'ie', 'nso', 'rue', 'se',
        'bh', 'vls', 'nds-nl', 'sn', 'mi', 'myv', 'so', 'nah', 'sat', 'sc',
        'vep', 'gan', 'glk', 'kab', 'tk', 'co', 'fiu-vro', 'bo', 'ab', 'kv',
        'csb', 'frp', 'pcd', 'kw', 'ug', 'udm', 'gv', 'ay', 'ary', 'zea',
        'nrm', 'gn', 'bjn', 'mt', 'lez', 'lfn', 'stq', 'lo', 'smn', 'mwl',
        'skr', 'olo', 'rm', 'lad', 'fur', 'gom', 'ang', 'koi', 'tyv', 'dsb',
        'ext', 'dty', 'ln', 'cbk-zam', 'dv', 'ksh', 'rw', 'gag', 'bxr', 'pfl',
        'ig', 'av', 'pi', 'pag', 'awa', 'haw', 'tay', 'pap', 'krc', 'xal',
        'szy', 'za', 'pdc', 'kaa', 'inh', 'atj', 'to', 'arc', 'jam', 'tpi',
        'kbp', 'na', 'lld', 'wo', 'kbd', 'tcy', 'mdf', 'nov', 'ki', 'tet',
        'lg', 'bi', 'dag', 'jbo', 'roa-rup', 'fj', 'kg', 'tw', 'lbe', 'xh',
        'ty', 'mnw', 'nqo', 'trv', 'shi', 'srn', 'om', 'gcr', 'sm', 'chr',
        'ltg', 'alt', 'ks', 'nia', 'cu', 'pih', 'ny', 'got', 'st', 'mad',
        'ami', 'kl', 'rmy', 'bm', 'tn', 'ts', 've', 'rn', 'chy', 'tum', 'iu',
