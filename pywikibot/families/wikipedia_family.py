...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'fo', 'li', 'mi', 'co', 'ilo', 'gan', 'frr', 'bo', 'glk', 'rue',
            'bcl', 'nds-nl', 'fiu-vro', 'or', 'mrj', 'ps', 'tk', 'vls', 'xmf',
            'gv', 'diq', 'zea', 'kv', 'km', 'mhr', 'pag', 'csb', 'vep', 'hak',
            'dv', 'nrm', 'rm', 'koi', 'udm', 'so', 'stq', 'lad', 'ay', 'sc',
            'wuu', 'zh-classical', 'lij', 'ug', 'fur', 'mt', 'pi', 'nov', 'bh',
            'eml', 'ksh', 'as', 'gn', 'kw', 'pcd', 'gag', 'ang', 'ace', 'nv',
            ...
            'pnt', 'ki', 'tyv', 'ee', 'rn', 'ha', 'om', 'ak', 'fj', 'ti', 'ts',
