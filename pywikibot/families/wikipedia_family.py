...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'fi', 'hu', 'cs', 'sh', 'ro', 'zh-min-nan', 'arz', 'eu', 'tr', 'ms',
        ...
        'si', 'cdo', 'ilo', 'gd', 'yi', 'am', 'nap', 'diq', 'bug', 'nv', 'xmf',
        'hsb', 'wa', 'mai', 'sd', 'map-bms', 'fo', 'mzn', 'li', 'eml', 'sah',
        'os', 'sa', 'ps', 'frr', 'bcl', 'ace', 'zh-classical', 'mrj', 'mhr',
        'hif', 'hak', 'roa-tara', 'pam', 'nso', 'km', 'hyw', 'se', 'rue',
        'crh', 'mi', 'vls', 'bh', 'shn', 'nah', 'nds-nl', 'as', 'sc', 'vep',
        'gan', 'ab', 'glk', 'myv', 'bo', 'co', 'so', 'tk', 'fiu-vro', 'kv',
        'csb', 'lrc', 'sn', 'gor', 'gv', 'ha', 'udm', 'ie', 'ay', 'pcd', 'zea',
        'kab', 'nrm', 'ug', 'lez', 'stq', 'kw', 'haw', 'lfn', 'mwl', 'lij',
        'gn', 'gom', 'rm', 'frp', 'lad', 'lo', 'mt', 'koi', 'fur', 'olo',
        'dsb', 'dty', 'ang', 'ext', 'ln', 'sat', 'cbk-zam', 'bjn', 'dv', 'ksh',
        'gag', 'ban', 'pfl', 'pag', 'pi', 'av', 'tyv', 'bxr', 'xal', 'krc',
        'pap', 'za', 'kaa', 'pdc', 'rw', 'szy', 'to', 'arc', 'zu', 'nov',
        'jam', 'tpi', 'kbp', 'kbd', 'na', 'tet', 'ig', 'wo', 'ki', 'tcy',
        'inh', 'jbo', 'roa-rup', 'bi', 'lbe', 'kg', 'ty', 'mdf', 'lg', 'atj',
        'srn', 'xh', 'gcr', 'ltg', 'fj', 'chr', 'sm', 'got', 'kl', 'ak', 'pih',
        'om', 'cu', 'tn', 'tw', 'ts', 'st', 'rmy', 'bm', 'chy', 'rn', 'nqo',
        'tum', 'ny', 'mnw', 'ch', 'ss', 'pnt', 'ady', 'iu', 'ks', 've', 'ee',
