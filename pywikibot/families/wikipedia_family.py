...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'tl', 'tt', 'ky', 'bs', 'sq', 'new', 'te', 'zh-yue', 'br', 'be-tarask',
        'pms', 'af', 'bn', 'ml', 'jv', 'lb', 'ht', 'sco', 'mr', 'ga', 'pnb',
        'is', 'sw', 'ba', 'cv', 'fy', 'my', 'su', 'lmo', 'an', 'yo', 'nds',
        'ne', 'pa', 'gu', 'io', 'bar', 'scn', 'bpy', 'als', 'kn', 'ku', 'ckb',
        'ia', 'qu', 'arz', 'mn', 'bat-smg', 'si', 'gd', 'wa', 'nap', 'yi',
        'am', 'or', 'bug', 'cdo', 'map-bms', 'hsb', 'wuu', 'mai', 'fo', 'mzn',
        'xmf', 'li', 'sah', 'ilo', 'sa', 'vec', 'eml', 'os', 'sd', 'mrj',
        'mhr', 'hif', 'roa-tara', 'ps', 'diq', 'hak', 'pam', 'bcl',
        'zh-classical', 'nso', 'frr', 'szl', 'ace', 'se', 'mi', 'nah',
        'nds-nl', 'km', 'rue', 'bh', 'vls', 'gan', 'nv', 'so', 'crh', 'sc',
        'bo', 'vep', 'glk', 'co', 'tk', 'fiu-vro', 'lrc', 'myv', 'kv', 'csb',
        'as', 'gv', 'udm', 'zea', 'ay', 'ug', 'ie', 'nrm', 'sn', 'stq', 'lez',
        'kw', 'lad', 'pcd', 'mwl', 'gn', 'rm', 'gom', 'koi', 'lij', 'ab', 'mt',
        'fur', 'dsb', 'frp', 'ang', 'ln', 'haw', 'dv', 'ext', 'cbk-zam', 'lo',
        'dty', 'lfn', 'kab', 'ksh', 'gag', 'olo', 'pag', 'pi', 'pfl', 'av',
        'bxr', 'xal', 'krc', 'pap', 'ha', 'bjn', 'kaa', 'za', 'pdc', 'rw',
        ...
        'tum', 'ts', 'ak', 'st', 'ch', 'pnt', 'ss', 'ny', 'fj', 'ady', 'iu',
