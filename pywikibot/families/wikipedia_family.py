...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'azb', 'kk', 'et', 'be', 'min', 'simple', 'uz', 'el', 'hr', 'lt', 'gl',
        ...
        'qu', 'crh', 'mn', 'nv', 'ha', 'xmf', 'si', 'bat-smg', 'ban', 'ps',
        ...
        'sat', 'mi', 'nds-nl', 'sc', 'nah', 'vep', 'kab', 'tk', 'gan', 'glk',
        'co', 'fiu-vro', 'kw', 'ary', 'ab', 'bo', 'gv', 'frp', 'dag', 'zea',
        'skr', 'ug', 'kv', 'pcd', 'udm', 'csb', 'mt', 'ay', 'gn', 'smn', 'nrm',
        'lez', 'lfn', 'stq', 'olo', 'rw', 'lo', 'mwl', 'ang', 'fur', 'rm',
        'lad', 'gom', 'koi', 'ext', 'tyv', 'dsb', 'dty', 'av', 'ln', 'cbk-zam',
        'dv', 'kaa', 'pap', 'ksh', 'gag', 'bxr', 'pfl', 'pag', 'pi', 'ks',
        'szy', 'haw', 'awa', 'tay', 'za', 'mdf', 'tw', 'inh', 'blk', 'krc',
        'xal', 'pdc', 'atj', 'to', 'arc', 'tcy', 'lg', 'kbp', 'mnw', 'jam',
        ...
        'ak', 'ss', 'kcg', 'iu', 'ch', 'pnt', 'ee', 'ady', 'ik', 'pcm', 'sg',
        'din', 'pwn', 'kl', 'ti', 'dz', 'cr',
    ]
