...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'fi', 'hu', 'sh', 'cs', 'ro', 'eu', 'tr', 'ms', 'eo', 'hy', 'bg', 'ce',
        'da', 'he', 'sk', 'zh-min-nan', 'kk', 'min', 'hr', 'et', 'lt', 'be',
        'el', 'sl', 'gl', 'azb', 'az', 'simple', 'nn', 'ur', 'th', 'hi', 'ka',
        'uz', 'la', 'ta', 'vo', 'cy', 'mk', 'ast', 'tg', 'lv', 'mg', 'tt',
        'oc', 'af', 'bs', 'ky', 'sq', 'tl', 'bn', 'zh-yue', 'new', 'te',
        'be-tarask', 'br', 'ml', 'pms', 'su', 'nds', 'lb', 'jv', 'ht', 'mr',
        'sco', 'sw', 'szl', 'ga', 'ba', 'pnb', 'is', 'my', 'fy', 'cv', 'lmo',
        'an', 'ne', 'yo', 'pa', 'bar', 'io', 'gu', 'als', 'ku', 'scn', 'kn',
        'bpy', 'ckb', 'wuu', 'ia', 'arz', 'qu', 'mn', 'bat-smg', 'si', 'wa',
        'cdo', 'or', 'yi', 'am', 'gd', 'nap', 'bug', 'ilo', 'mai', 'hsb',
        'map-bms', 'fo', 'xmf', 'mzn', 'li', 'vec', 'sd', 'eml', 'sah', 'os',
        'diq', 'sa', 'ps', 'mrj', 'mhr', 'zh-classical', 'hif', 'nv',
        'roa-tara', 'bcl', 'ace', 'hak', 'frr', 'pam', 'nso', 'km', 'se',
        'hyw', 'rue', 'mi', 'vls', 'nah', 'bh', 'nds-nl', 'crh', 'gan', 'vep',
        'sc', 'ab', 'as', 'glk', 'bo', 'myv', 'co', 'so', 'tk', 'fiu-vro',
        'lrc', 'kv', 'csb', 'shn', 'gv', 'sn', 'udm', 'zea', 'ay', 'ie', 'pcd',
        'nrm', 'kab', 'ug', 'lez', 'stq', 'ha', 'kw', 'mwl', 'gom', 'gn',
        'haw', 'rm', 'lij', 'lfn', 'lad', 'lo', 'koi', 'mt', 'frp', 'fur',
        'dsb', 'dty', 'ext', 'ang', 'ln', 'olo', 'cbk-zam', 'dv', 'bjn', 'ksh',
        'gag', 'pi', 'pfl', 'pag', 'av', 'bxr', 'gor', 'xal', 'krc', 'za',
        'pap', 'kaa', 'pdc', 'tyv', 'rw', 'to', 'kl', 'nov', 'jam', 'arc',
        'kbp', 'kbd', 'tpi', 'tet', 'ig', 'sat', 'ki', 'zu', 'wo', 'na', 'jbo',
        'roa-rup', 'lbe', 'bi', 'ty', 'mdf', 'kg', 'lg', 'tcy', 'srn', 'inh',
        'xh', 'atj', 'ltg', 'chr', 'sm', 'pih', 'om', 'ak', 'tn', 'cu', 'ts',
        'tw', 'rmy', 'bm', 'st', 'chy', 'rn', 'got', 'tum', 'ny', 'ss', 'ch',
        'pnt', 'fj', 'iu', 'ady', 've', 'ee', 'ks', 'ik', 'sg', 'nqo', 'ff',
        'dz', 'ti', 'ban', 'din', 'cr',
    ]
