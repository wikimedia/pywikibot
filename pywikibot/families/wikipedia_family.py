...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'sat', 'hak', 'ary', 'roa-tara', 'pam', 'dag', 'rue', 'bh', 'nso',
        'co', 'vls', 'so', 'mi', 'nds-nl', 'myv', 'se', 'sc', 'bo', 'vep',
        'kw', 'glk', 'tk', 'kab', 'gan', 'rw', 'fiu-vro', 'gv', 'zea', 'ab',
        'skr', 'mt', 'ug', 'nah', 'tly', 'frp', 'udm', 'pcd', 'gn', 'smn',
        'kv', 'csb', 'ay', 'nrm', 'ks', 'mdf', 'lez', 'olo', 'kaa', 'mwl',
        'lfn', 'ang', 'stq', 'lo', 'fur', 'rm', 'tw', 'ln', 'lad', 'pap',
        'ext', 'gom', 'tyv', 'koi', 'av', 'dsb', 'dty', 'cbk-zam', 'dv', 'ksh',
        'za', 'lg', 'gag', 'bxr', 'pfl', 'szy', 'blk', 'tay', 'pag', 'pi',
        'haw', 'awa', 'inh', 'krc', 'atj', 'to', 'pdc', 'tcy', 'mnw', 'arc',
        'ff', 'xh', 'shi', 'xal', 'jam', 'kbp', 'wo', 'nia', 'om', 'ki', 'anp',
        'kbd', 'nov', 'zgh', 'nqo', 'bi', 'tpi', 'tet', 'roa-rup', 'jbo', 'tn',
        'fj', 'kg', 'lbe', 'guw', 'ty', 'cu', 'rmy', 'mad', 'trv', 'ami',
        'srn', 'sm', 'alt', 'ltg', 'dga', 'gcr', 'chr', 'pcm', 'ny', 'st',
        'gpe', 'kcg', 'pih', 'got', 'ss', 'gur', 'ee', 'bm', 'ts', 've', 'bbc',
        'chy', 'rn', 'fon', 'ik', 'ady', 'ch', 'fat', 'guc', 'pnt', 'iu',
