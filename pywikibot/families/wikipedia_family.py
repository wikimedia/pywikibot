...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'tt', 'bs', 'ky', 'tl', 'sq', 'new', 'af', 'zh-yue', 'te', 'br',
        ...
        'zh-classical', 'pam', 'frr', 'nso', 'szl', 'ace', 'se', 'km', 'nv',
        'mi', 'rue', 'nah', 'nds-nl', 'vls', 'bh', 'gan', 'crh', 'sc', 'vep',
        'bo', 'glk', 'co', 'tk', 'so', 'fiu-vro', 'myv', 'lrc', 'kv', 'as',
        'csb', 'gv', 'zea', 'udm', 'ay', 'ie', 'pcd', 'sn', 'ug', 'nrm', 'stq',
        'lez', 'lad', 'kw', 'mwl', 'gn', 'gom', 'rm', 'lij', 'ab', 'koi',
        'haw', 'shn', 'mt', 'ha', 'fur', 'frp', 'dsb', 'lfn', 'lo', 'ang',
        'ln', 'ext', 'cbk-zam', 'dv', 'dty', 'kab', 'olo', 'ksh', 'gag', 'pi',
        'pag', 'pfl', 'av', 'bxr', 'bjn', 'xal', 'krc', 'gor', 'pap', 'kaa',
        'za', 'pdc', 'rw', 'tyv', 'to', 'kl', 'nov', 'jam', 'arc', 'kbd',
        'tpi', 'kbp', 'tet', 'ig', 'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'ty',
        'kg', 'mdf', 'bi', 'wo', 'lg', 'srn', 'zu', 'atj', 'tcy', 'chr', 'ltg',
        'inh', 'sm', 'om', 'xh', 'pih', 'cu', 'rmy', 'tw', 'bm', 'tn', 'chy',
        'rn', 'got', 'ts', 'sat', 'tum', 'ak', 'st', 'ny', 'ch', 'ss', 'pnt',
