...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'qu', 'crh', 'ha', 'mn', 'nv', 'xmf', 'si', 'ban', 'ps', 'bat-smg',
        ...
        'roa-tara', 'so', 'tum', 'pam', 'rue', 'nso', 'bh', 'sat', 'se', 'mi',
        'myv', 'vls', 'nds-nl', 'nah', 'sc', 'kw', 'glk', 'vep', 'kab', 'tk',
        'gan', 'co', 'ary', 'dag', 'fiu-vro', 'bo', 'ab', 'gv', 'skr', 'zea',
        'frp', 'ug', 'udm', 'pcd', 'kv', 'csb', 'mt', 'gn', 'smn', 'ay', 'rw',
        'nrm', 'lez', 'lfn', 'stq', 'olo', 'lo', 'mwl', 'ang', 'fur', 'rm',
        'lad', 'gom', 'koi', 'tyv', 'ext', 'dsb', 'av', 'ln', 'dty', 'pap',
        'cbk-zam', 'kaa', 'dv', 'ksh', 'gag', 'mdf', 'bxr', 'pfl', 'ks', 'tw',
        'pi', 'szy', 'pag', 'haw', 'lg', 'za', 'awa', 'tay', 'blk', 'inh',
        'krc', 'xal', 'pdc', 'atj', 'to', 'arc', 'tcy', 'mnw', 'jam', 'kbp',
        'na', 'wo', 'kbd', 'nia', 'nov', 'ki', 'nqo', 'bi', 'tpi', 'tet',
        'shi', 'jbo', 'roa-rup', 'fj', 'xh', 'lbe', 'kg', 'om', 'ty', 'guw',
        'cu', 'trv', 'srn', 'sm', 'gcr', 'alt', 'chr', 'ltg', 'ny', 'tn',
        'mad', 'st', 'pih', 'got', 'ami', 'ee', 'rmy', 'bm', 've', 'ts', 'ff',
        'chy', 'ss', 'rn', 'kcg', 'ak', 'iu', 'pcm', 'ch', 'ik', 'pnt', 'guc',
        'ady', 'pwn', 'sg', 'din', 'ti', 'kl', 'dz', 'gur', 'cr',
    ]
