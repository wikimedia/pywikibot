...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'vi', 'ja', 'zh', 'pt', 'ar', 'uk', 'fa', 'sr', 'ca', 'no', 'id', 'ko',
        'fi', 'hu', 'sh', 'cs', 'ro', 'eu', 'tr', 'ms', 'eo', 'hy', 'bg', 'ce',
        'da', 'he', 'sk', 'zh-min-nan', 'kk', 'min', 'hr', 'et', 'lt', 'be',
        'el', 'sl', 'gl', 'azb', 'nn', 'az', 'simple', 'ur', 'hi', 'th', 'ka',
        'uz', 'la', 'ta', 'vo', 'cy', 'mk', 'ast', 'tg', 'lv', 'mg', 'tt',
        'oc', 'af', 'bs', 'ky', 'sq', 'tl', 'bn', 'zh-yue', 'new', 'te',
        'be-tarask', 'br', 'ml', 'pms', 'su', 'lb', 'nds', 'ht', 'jv', 'mr',
        'sco', 'sw', 'szl', 'ga', 'ba', 'is', 'pnb', 'my', 'fy', 'cv', 'lmo',
        'an', 'ne', 'yo', 'pa', 'bar', 'io', 'gu', 'als', 'ku', 'scn', 'bpy',
        'kn', 'ckb', 'ia', 'wuu', 'arz', 'qu', 'mn', 'bat-smg', 'wa', 'si',
        'cdo', 'or', 'yi', 'am', 'gd', 'nap', 'bug', 'ilo', 'mai', 'hsb',
        'map-bms', 'fo', 'xmf', 'mzn', 'li', 'vec', 'sd', 'eml', 'sah', 'os',
        'sa', 'diq', 'ps', 'mrj', 'mhr', 'zh-classical', 'hif', 'nv',
        'roa-tara', 'bcl', 'ace', 'frr', 'hak', 'pam', 'nso', 'km', 'se',
        'hyw', 'rue', 'mi', 'nah', 'vls', 'bh', 'nds-nl', 'crh', 'gan', 'vep',
        'sc', 'ab', 'as', 'bo', 'glk', 'myv', 'co', 'tk', 'so', 'fiu-vro',
        'lrc', 'kv', 'csb', 'shn', 'gv', 'sn', 'udm', 'zea', 'ay', 'ie', 'pcd',
        'nrm', 'kab', 'ug', 'stq', 'lez', 'kw', 'ha', 'mwl', 'gom', 'gn',
        'haw', 'rm', 'lij', 'lfn', 'lad', 'lo', 'koi', 'mt', 'frp', 'fur',
        'dsb', 'ext', 'ang', 'ln', 'dty', 'olo', 'cbk-zam', 'dv', 'ksh', 'bjn',
        'gag', 'pi', 'pfl', 'pag', 'av', 'bxr', 'gor', 'xal', 'krc', 'za',
        'pap', 'kaa', 'pdc', 'tyv', 'rw', 'to', 'kl', 'nov', 'jam', 'arc',
        'kbp', 'kbd', 'tpi', 'tet', 'ig', 'ki', 'zu', 'wo', 'na', 'sat', 'jbo',
