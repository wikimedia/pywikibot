...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ka', 'mk', 'tl', 'ht', 'pms', 'te', 'ta', 'be-x-old', 'ceb', 'be',
            'br', 'lv', 'sq', 'jv', 'mg', 'cy', 'lb', 'mr', 'is', 'bs', 'yo',
            'an', 'hy', 'fy', 'bpy', 'lmo', 'pnb', 'ml', 'sw', 'bn', 'io', 'af',
            'gu', 'zh-yue', 'ne', 'nds', 'ku', 'ast', 'ur', 'scn', 'su', 'qu',
            'diq', 'ba', 'tt', 'my', 'ga', 'cv', 'ia', 'nap', 'bat-smg',
            'map-bms', 'wa', 'als', 'kn', 'am', 'uz', 'bug', 'tg', 'gd',
            'zh-min-nan', 'yi', 'vec', 'hif', 'sco', 'roa-tara', 'os', 'arz',
            'nah', 'sah', 'mn', 'sa', 'mzn', 'pam', 'hsb', 'mi', 'li', 'ky',
            'si', 'co', 'gan', 'ckb', 'glk', 'bo', 'fo', 'bar', 'bcl', 'ilo',
            'mrj', 'fiu-vro', 'nds-nl', 'tk', 'vls', 'se', 'gv', 'ps', 'rue',
            'dv', 'nrm', 'pag', 'koi', 'pa', 'rm', 'km', 'kv', 'udm', 'csb',
            'mhr', 'fur', 'mt', 'wuu', 'lij', 'ug', 'lad', 'zea', 'pi', 'sc',
            'bh', 'zh-classical', 'nov', 'or', 'ksh', 'ang', 'kw', 'so', 'xmf',
            'nv', 'stq', 'hak', 'ay', 'frp', 'frr', 'ext', 'szl', 'pcd', 'ie',
            'gag', 'haw', 'xal', 'ln', 'rw', 'pdc', 'pfl', 'krc', 'crh', 'eml',
            'ace', 'gn', 'to', 'ce', 'kl', 'arc', 'myv', 'dsb', 'vep', 'pap',
            'bjn', 'as', 'tpi', 'lbe', 'wo', 'mdf', 'jbo', 'kab', 'av', 'sn',
            'cbk-zam', 'ty', 'srn', 'kbd', 'lo', 'ab', 'lez', 'mwl', 'ltg',
            'na', 'ig', 'kg', 'tet', 'za', 'kaa', 'nso', 'zu', 'rmy', 'cu',
            'tn', 'chr', 'got', 'sm', 'bi', 'chy', 'bm', 'iu', 'ik', 'pih',
            'ss', 'sd', 'pnt', 'cdo', 'ee', 'ha', 'ti', 'bxr', 'ts', 'om', 'ks',
            'ki', 've', 'sg', 'rn', 'dz', 'cr', 'lg', 'ak', 'tum', 'fj', 'st',
            'tw', 'ch', 'ny', 'ff', 'xh',
        ]
