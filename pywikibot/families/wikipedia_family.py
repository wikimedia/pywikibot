...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'he', 'zh-min-nan', 'sk', 'min', 'kk', 'hr', 'lt', 'ce', 'et', 'sl',
        'be', 'gl', 'el', 'ur', 'nn', 'az', 'simple', 'uz', 'la', 'hi', 'th',
        'ka', 'vo', 'ta', 'cy', 'mk', 'tg', 'azb', 'lv', 'ast', 'mg', 'oc',
        ...
        'xmf', 'li', 'sah', 'ilo', 'sa', 'vec', 'os', 'wuu', 'eml', 'mrj',
