...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'be-x-old', 'cy', 'lv', 'sq', 'bs', 'mg', 'br', 'jv', 'lb', 'mr',
            ...
            'or', 'diq', 'kv', 'zea', 'km', 'pag', 'mhr', 'csb', 'dv', 'vep',
            'nrm', 'rm', 'hak', 'koi', 'udm', 'lad', 'mt', 'lij', 'wuu',
            'zh-classical', 'sc', 'fur', 'stq', 'ug', 'ay', 'so', 'pi', 'bh',
            'nov', 'ksh', 'gn', 'kw', 'gag', 'ang', 'pcd', 'as', 'eml', 'nv',
            'ext', 'ace', 'frp', 'szl', 'mwl', 'ie', 'ln', 'pfl', 'krc', 'lez',
            'xal', 'haw', 'pdc', 'rw', 'crh', 'dsb', 'to', 'arc', 'kl', 'myv',
            'kab', 'sn', 'bjn', 'pap', 'tpi', 'lo', 'lbe', 'wo', 'mdf', 'jbo',
            'kbd', 'cbk-zam', 'av', 'srn', 'ty', 'kg', 'ab', 'na', 'tet', 'ltg',
            'ig', 'bxr', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy', 'cu', 'chr',
            'tn', 'cdo', 'roa-rup', 'bi', 'got', 'pih', 'sm', 'bm', 'iu', 'pnt',
            'sd', 'ss', 'ki', 'ee', 'ha', 'tyv', 'om', 'fj', 'ti', 'ts', 'ks',
            'sg', 've', 'rn', 'st', 'cr', 'dz', 'ak', 'tw', 'tum', 'ik', 'lg',
            'ff', 'ny', 'ch', 'xh',
        ]
