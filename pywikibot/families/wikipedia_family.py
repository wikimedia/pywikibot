...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sv', 'vi', 'uk', 'ca', 'no', 'fi', 'cs', 'hu', 'fa', 'ko', 'ro',
            'id', 'tr', 'ar', 'sk', 'eo', 'da', 'sr', 'lt', 'kk', 'ms', 'he',
            'eu', 'bg', 'sl', 'vo', 'hr', 'war', 'hi', 'et', 'az', 'gl', 'nn',
            'simple', 'la', 'el', 'th', 'new', 'sh', 'roa-rup', 'oc', 'mk',
            'ka', 'tl', 'ht', 'pms', 'te', 'ta', 'be-x-old', 'be', 'br', 'lv',
            'ceb', 'sq', 'jv', 'mg', 'cy', 'mr', 'lb', 'is', 'bs', 'uz', 'my',
            'yo', 'an', 'lmo', 'hy', 'ml', 'fy', 'bpy', 'pnb', 'sw', 'bn', 'io',
            'af', 'gu', 'zh-yue', 'ne', 'nds', 'ur', 'ku', 'ast', 'scn', 'su',
            'qu', 'diq', 'ba', 'tt', 'ga', 'cv', 'ia', 'nap', 'bat-smg',
            'map-bms', 'wa', 'als', 'am', 'kn', 'gd', 'bug', 'tg', 'zh-min-nan',
            'sco', 'mzn', 'yi', 'vec', 'hif', 'roa-tara', 'ky', 'arz', 'os',
            'nah', 'sah', 'ckb', 'mn', 'sa', 'pam', 'hsb', 'li', 'mi', 'si',
            'co', 'gan', 'glk', 'bar', 'bo', 'fo', 'bcl', 'ilo', 'mrj', 'se',
            'nds-nl', 'fiu-vro', 'tk', 'vls', 'ps', 'gv', 'rue', 'dv', 'nrm',
            'pag', 'pa', 'koi', 'xmf', 'rm', 'km', 'kv', 'csb', 'udm', 'zea',
            'mhr', 'fur', 'mt', 'wuu', 'lad', 'lij', 'ug', 'pi', 'sc', 'or',
            'zh-classical', 'bh', 'nov', 'ksh', 'frr', 'ang', 'so', 'kw', 'stq',
            'nv', 'hak', 'ay', 'frp', 'ext', 'szl', 'pcd', 'gag', 'ie', 'ln',
            'haw', 'xal', 'vep', 'rw', 'pdc', 'pfl', 'gn', 'eml', 'krc', 'crh',
            'ace', 'to', 'ce', 'kl', 'arc', 'myv', 'dsb', 'as', 'bjn', 'pap',
            'tpi', 'lbe', 'mdf', 'wo', 'jbo', 'sn', 'kab', 'av', 'cbk-zam',
            'ty', 'srn', 'lez', 'kbd', 'lo', 'ab', 'tet', 'mwl', 'ltg', 'na',
            'ig', 'kg', 'za', 'kaa', 'nso', 'zu', 'rmy', 'cu', 'tn', 'chy',
            'chr', 'got', 'sm', 'bi', 'iu', 'bm', 'ik', 'pih', 'ss', 'sd',
            'pnt', 'cdo', 'ee', 'ha', 'ti', 'bxr', 'ts', 'om', 'ks', 'ki', 've',
            'sg', 'rn', 'cr', 'lg', 'dz', 'ak', 'ff', 'tum', 'fj', 'st', 'tw',
            'xh', 'ny', 'ch',
        ]
