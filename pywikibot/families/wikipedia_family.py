...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ace', 'nds-nl', 'bcl', 'mi', 'nah', 'zh-classical', 'gan', 'szl',
            'vls', 'rue', 'wuu', 'bo', 'glk', 'vep', 'sc', 'fiu-vro', 'co',
            'crh', 'km', 'lrc', 'frr', 'tk', 'kv', 'csb', 'gv', 'as', 'so',
            'lad', 'zea', 'ay', 'udm', 'myv', 'lez', 'kw', 'stq', 'ie', 'nrm',
            'pcd', 'nv', 'mwl', 'rm', 'koi', 'gom', 'ug', 'lij', 'ab', 'mt',
            'gn', 'fur', 'dsb', 'dv', 'cbk-zam', 'ang', 'ln', 'ext', 'kab',
            'sn', 'ksh', 'gag', 'lo', 'frp', 'pag', 'pi', 'av', 'olo', 'dty',
            'xal', 'pfl', 'krc', 'haw', 'bxr', 'kaa', 'pap', 'rw', 'pdc',
            'bjn', 'to', 'nov', 'kl', 'arc', 'jam', 'kbd', 'ha', 'tpi', 'tet',
            'tyv', 'ig', 'ki', 'na', 'lbe', 'roa-rup', 'jbo', 'ty', 'mdf',
            'kg', 'za', 'wo', 'lg', 'bi', 'srn', 'zu', 'tcy', 'ltg', 'chr',
            'sm', 'om', 'xh', 'tn', 'pih', 'chy', 'rmy', 'tw', 'cu', 'tum',
            'kbp', 'ts', 'st', 'got', 'rn', 'pnt', 'ss', 'bm', 'fj', 'ch',
            'ady', 'iu', 'ny', 'ee', 'ks', 'ak', 've', 'ik', 'sg', 'dz', 'ff',
            'ti', 'cr', 'atj', 'din',
        ]
