...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'az', 'ur', 'sl', 'ka', 'nn', 'hi', 'th', 'ta', 'bn', 'la', 'mk',
        'ast', 'zh-yue', 'lld', 'lv', 'tg', 'af', 'my', 'mg', 'mr', 'bs', 'sq',
        'oc', 'nds', 'ml', 'te', 'be-tarask', 'ky', 'br', 'sw', 'jv', 'new',
        'pnb', 'vec', 'ht', 'pms', 'ba', 'lmo', 'lb', 'su', 'ku', 'ga', 'szl',
        'is', 'fy', 'cv', 'ckb', 'pa', 'tl', 'an', 'wuu', 'diq', 'io', 'sco',
        'vo', 'yo', 'ne', 'ia', 'gu', 'kn', 'als', 'avk', 'bar', 'scn', 'ha',
        'bpy', 'crh', 'qu', 'nv', 'mn', 'xmf', 'ban', 'si', 'ps', 'frr',
        'bat-smg', 'os', 'or', 'sah', 'cdo', 'gd', 'bug', 'yi', 'sd', 'ilo',
        'am', 'mzn', 'ig', 'nap', 'li', 'fo', 'gor', 'hsb', 'map-bms', 'mai',
        'bcl', 'tum', 'eml', 'shn', 'ace', 'zh-classical', 'sa', 'wa', 'as',
        'ie', 'lij', 'zu', 'mhr', 'hyw', 'hif', 'sn', 'mrj', 'bjn', 'mni',
        'km', 'hak', 'so', 'roa-tara', 'pam', 'rue', 'nso', 'bh', 'sat', 'se',
        'myv', 'mi', 'vls', 'nds-nl', 'sc', 'nah', 'kw', 'vep', 'glk', 'dag',
        'kab', 'tk', 'ary', 'gan', 'bo', 'co', 'fiu-vro', 'ab', 'rw', 'gv',
        'zea', 'ug', 'skr', 'frp', 'udm', 'pcd', 'kv', 'csb', 'mt', 'gn',
        'smn', 'ay', 'nrm', 'lez', 'lfn', 'mwl', 'olo', 'stq', 'ks', 'lo',
        'ang', 'fur', 'rm', 'lad', 'gom', 'ext', 'koi', 'tyv', 'dsb', 'av',
        'dty', 'ln', 'kaa', 'mdf', 'pap', 'cbk-zam', 'dv', 'ksh', 'tw', 'gag',
        'bxr', 'pfl', 'lg', 'za', 'pi', 'szy', 'pag', 'haw', 'awa', 'tay',
        'blk', 'inh', 'krc', 'xal', 'pdc', 'to', 'atj', 'arc', 'tcy', 'mnw',
        'jam', 'kbp', 'wo', 'anp', 'kbd', 'nia', 'shi', 'nov', 'ki', 'nqo',
        'bi', 'tpi', 'tet', 'roa-rup', 'jbo', 'xh', 'om', 'fj', 'kg', 'lbe',
        'ty', 'guw', 'cu', 'trv', 'srn', 'sm', 'alt', 'gcr', 'chr', 'tn',
        'ltg', 'mad', 'ny', 'st', 'pih', 'ff', 'got', 'ee', 'rmy', 'ami', 've',
        'bm', 'ts', 'chy', 'pcm', 'ss', 'kcg', 'rn', 'ch', 'ik', 'pnt', 'guc',
        'ady', 'fat', 'iu', 'gur', 'pwn', 'sg', 'din', 'ti', 'kl', 'dz', 'cr',
    ]
    ...
    cross_allowed = [
        ...
        'myv', 'mzn', 'na', 'nah', 'nap', 'nds-nl', 'ne', 'new', 'nl', 'no',
        'nov', 'nrm', 'nso', 'nv', 'ny', 'oc', 'olo', 'om', 'or', 'os', 'pa',
        'pag', 'pam', 'pap', 'pdc', 'pfl', 'pi', 'pih', 'pms', 'pnb', 'pnt',
        'ps', 'qu', 'rm', 'rmy', 'rn', 'roa-rup', 'roa-tara', 'ru', 'rue',
        'rw', 'sa', 'sah', 'sc', 'scn', 'sco', 'sd', 'se', 'sg', 'sh', 'shn',
        'si', 'simple', 'sk', 'sm', 'sn', 'so', 'srn', 'ss', 'st', 'stq',
        'su', 'sv', 'sw', 'szl', 'ta', 'tcy', 'te', 'tet', 'tg', 'th', 'ti',
        'tk', 'tl', 'tn', 'to', 'tpi', 'tr', 'ts', 'tt', 'tum', 'tw', 'ty',
        'tyv', 'udm', 'ug', 'uz', 've', 'vec', 'vep', 'vls', 'vo', 'wa', 'war',
        'wo', 'xal', 'xh', 'xmf', 'yi', 'yo', 'za', 'zea', 'zh',
