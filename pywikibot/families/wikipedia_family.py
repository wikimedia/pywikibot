...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'tt', 'tl', 'ky', 'bs', 'sq', 'new', 'zh-yue', 'te', 'af', 'br',
        'be-tarask', 'pms', 'bn', 'ml', 'jv', 'lb', 'ht', 'sco', 'mr', 'ga',
        'sw', 'pnb', 'is', 'ba', 'cv', 'fy', 'my', 'su', 'nds', 'lmo', 'an',
        'yo', 'ne', 'pa', 'gu', 'io', 'bar', 'scn', 'als', 'bpy', 'kn', 'ku',
        'ckb', 'ia', 'qu', 'arz', 'mn', 'bat-smg', 'si', 'wa', 'gd', 'nap',
        'yi', 'am', 'or', 'wuu', 'bug', 'cdo', 'map-bms', 'hsb', 'mai', 'fo',
        'mzn', 'xmf', 'li', 'sah', 'ilo', 'sa', 'vec', 'eml', 'os', 'sd',
        'mrj', 'mhr', 'hif', 'ps', 'roa-tara', 'diq', 'hak', 'pam', 'bcl',
        'zh-classical', 'nso', 'frr', 'szl', 'ace', 'se', 'mi', 'km', 'nah',
        'nds-nl', 'rue', 'bh', 'vls', 'nv', 'gan', 'crh', 'sc', 'vep', 'bo',
        'glk', 'so', 'co', 'tk', 'fiu-vro', 'myv', 'lrc', 'kv', 'csb', 'as',
        'gv', 'udm', 'zea', 'ay', 'ie', 'ug', 'sn', 'nrm', 'pcd', 'stq', 'lez',
        'kw', 'lad', 'mwl', 'gn', 'rm', 'gom', 'lij', 'koi', 'ab', 'mt', 'fur',
        'frp', 'dsb', 'haw', 'ang', 'lo', 'ln', 'dv', 'ext', 'cbk-zam', 'dty',
        'lfn', 'kab', 'ksh', 'gag', 'olo', 'pi', 'pag', 'pfl', 'av', 'ha',
        'bxr', 'xal', 'krc', 'pap', 'kaa', 'gor', 'za', 'bjn', 'pdc', 'rw',
        'tyv', 'to', 'kl', 'nov', 'jam', 'arc', 'kbd', 'tpi', 'kbp', 'tet',
        'ig', 'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'mdf', 'kg', 'bi',
        'wo', 'lg', 'srn', 'zu', 'tcy', 'chr', 'ltg', 'sm', 'inh', 'om', 'xh',
        'pih', 'cu', 'rmy', 'bm', 'tw', 'tn', 'atj', 'rn', 'chy', 'got', 'tum',
        'ts', 'ak', 'st', 'ch', 'ny', 'pnt', 'ss', 'sat', 'fj', 'ady', 'iu',
