...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'lij', 'zu', 'mhr', 'hyw', 'tum', 'hif', 'sn', 'mrj', 'bjn', 'mni',
        ...
        'smn', 'ay', 'nrm', 'lez', 'lfn', 'olo', 'mwl', 'stq', 'lo', 'ang',
        ...
        'jam', 'kbp', 'wo', 'kbd', 'anp', 'nia', 'nov', 'shi', 'ki', 'nqo',
        'bi', 'tpi', 'tet', 'roa-rup', 'jbo', 'xh', 'om', 'fj', 'kg', 'lbe',
        'ty', 'guw', 'cu', 'trv', 'srn', 'sm', 'alt', 'gcr', 'chr', 'tn',
        'ltg', 'mad', 'ny', 'st', 'pih', 'got', 'ee', 'ami', 'rmy', 'bm', 'ff',
        've', 'ts', 'chy', 'ss', 'pcm', 'kcg', 'rn', 'ch', 'ik', 'pnt', 'ady',
        'guc', 'iu', 'ak', 'fat', 'pwn', 'sg', 'din', 'gur', 'ti', 'kl', 'dz',
        'cr',
    ]
