...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'co', 'glk', 'dag', 'ary', 'fiu-vro', 'bo', 'gv', 'ab', 'frp', 'zea',
        'skr', 'ug', 'pcd', 'kv', 'udm', 'csb', 'mt', 'gn', 'ay', 'smn', 'nrm',
        'lez', 'lfn', 'stq', 'olo', 'lo', 'rw', 'mwl', 'ang', 'fur', 'rm',
        'lad', 'gom', 'koi', 'tyv', 'ext', 'dsb', 'av', 'dty', 'ln', 'cbk-zam',
        'kaa', 'pap', 'dv', 'ksh', 'gag', 'bxr', 'pfl', 'ks', 'mdf', 'tw',
        'pi', 'pag', 'szy', 'haw', 'awa', 'tay', 'za', 'blk', 'inh', 'krc',
        'xal', 'pdc', 'to', 'atj', 'lg', 'arc', 'tcy', 'mnw', 'jam', 'kbp',
        'na', 'wo', 'kbd', 'nia', 'nov', 'ki', 'nqo', 'bi', 'tpi', 'tet',
        'shi', 'jbo', 'roa-rup', 'fj', 'lbe', 'kg', 'xh', 'ty', 'cu', 'om',
        'guw', 'trv', 'srn', 'sm', 'gcr', 'alt', 'chr', 'ltg', 'ny', 'tn',
        'st', 'mad', 'pih', 'got', 'ami', 'rmy', 'bm', 'ee', 've', 'ts', 'ff',
        'chy', 'ss', 'rn', 'kcg', 'ak', 'iu', 'ch', 'ik', 'pnt', 'pcm', 'ady',
        'pwn', 'sg', 'din', 'ti', 'kl', 'dz', 'cr', 'guc',
    ]
