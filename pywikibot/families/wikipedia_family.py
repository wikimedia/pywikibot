...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'nn', 'uz', 'ka', 'hi', 'th', 'ta', 'la', 'cy', 'ast', 'mk', 'zh-yue',
        'bn', 'lv', 'tg', 'af', 'my', 'mg', 'bs', 'oc', 'sq', 'mr', 'nds',
        'ky', 'ml', 'be-tarask', 'te', 'vo', 'sw', 'new', 'br', 'jv', 'vec',
        'ht', 'pms', 'pnb', 'su', 'lb', 'ba', 'lld', 'ga', 'szl', 'is', 'lmo',
        'ku', 'cv', 'fy', 'tl', 'wuu', 'ckb', 'an', 'sco', 'diq', 'pa', 'yo',
        'io', 'ne', 'bar', 'gu', 'als', 'kn', 'scn', 'bpy', 'avk', 'ia', 'qu',
        'mn', 'nv', 'xmf', 'crh', 'si', 'ha', 'bat-smg', 'os', 'frr', 'gd',
        'or', 'cdo', 'bug', 'yi', 'ilo', 'ps', 'sd', 'am', 'ban', 'nap', 'sah',
        'hsb', 'fo', 'map-bms', 'mai', 'li', 'mzn', 'gor', 'eml', 'ace', 'bcl',
        'sa', 'shn', 'wa', 'zh-classical', 'lij', 'as', 'zu', 'ie', 'mrj',
        'mhr', 'hif', 'hyw', 'mni', 'km', 'hak', 'roa-tara', 'ig', 'pam',
        'nso', 'so', 'sn', 'rue', 'bh', 'se', 'myv', 'vls', 'nds-nl', 'mi',
        'sat', 'sc', 'nah', 'vep', 'gan', 'kab', 'glk', 'tk', 'fiu-vro', 'co',
        'bo', 'ab', 'ary', 'gv', 'frp', 'kw', 'kv', 'csb', 'pcd', 'ug', 'skr',
        'udm', 'zea', 'ay', 'gn', 'nrm', 'mt', 'bjn', 'smn', 'lez', 'lfn',
        'stq', 'lo', 'tum', 'mwl', 'olo', 'fur', 'rm', 'ang', 'lad', 'gom',
        'koi', 'ext', 'tyv', 'dsb', 'rw', 'dty', 'ln', 'cbk-zam', 'av', 'dv',
        'ksh', 'gag', 'bxr', 'pfl', 'pap', 'pag', 'pi', 'haw', 'awa', 'tay',
        'tw', 'inh', 'krc', 'xal', 'szy', 'za', 'dag', 'kaa', 'pdc', 'atj',
        'to', 'mdf', 'arc', 'tcy', 'kbp', 'jam', 'na', 'wo', 'kbd', 'nov',
        'nia', 'ki', 'tet', 'lg', 'bi', 'tpi', 'jbo', 'roa-rup', 'nqo', 'fj',
        'lbe', 'kg', 'xh', 'mnw', 'ty', 'ks', 'cu', 'shi', 'srn', 'trv', 'om',
