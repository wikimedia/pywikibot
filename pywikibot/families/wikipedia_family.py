...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'et', 'ce', 'sl', 'be', 'gl', 'el', 'nn', 'az', 'simple', 'ur',
            'uz', 'la', 'hi', 'th', 'vo', 'ka', 'ta', 'cy', 'tg', 'mk', 'tl',
            'mg', 'oc', 'lv', 'ky', 'bs', 'tt', 'sq', 'new', 'te', 'ast',
            'azb', 'zh-yue', 'pms', 'br', 'be-tarask', 'bn', 'ml', 'jv', 'ht',
            'lb', 'mr', 'sco', 'af', 'ga', 'pnb', 'is', 'ba', 'cv', 'fy', 'sw',
            'su', 'my', 'lmo', 'an', 'yo', 'ne', 'nds', 'pa', 'gu', 'io',
            'scn', 'bar', 'bpy', 'als', 'ku', 'kn', 'ckb', 'ia', 'qu', 'arz',
            'mn', 'bat-smg', 'gd', 'wa', 'si', 'nap', 'yi', 'am', 'bug', 'cdo',
            'or', 'map-bms', 'fo', 'mzn', 'hsb', 'xmf', 'mai', 'li', 'sah',
            'sa', 'vec', 'ilo', 'os', 'mrj', 'mhr', 'hif', 'eml', 'bh',
            'roa-tara', 'ps', 'diq', 'sd', 'pam', 'hak', 'nso', 'zh-classical',
            'se', 'bcl', 'wuu', 'ace', 'mi', 'nah', 'szl', 'nds-nl', 'frr',
            'rue', 'gan', 'vls', 'km', 'bo', 'vep', 'crh', 'sc', 'glk', 'co',
            'fiu-vro', 'lrc', 'tk', 'kv', 'csb', 'myv', 'gv', 'as', 'lad',
            'so', 'zea', 'nv', 'udm', 'ay', 'lez', 'stq', 'ie', 'kw', 'nrm',
            'pcd', 'mwl', 'ug', 'gom', 'rm', 'koi', 'gn', 'ab', 'lij', 'mt',
            'fur', 'sn', 'dsb', 'dv', 'ang', 'ln', 'ext', 'kab', 'cbk-zam',
            'frp', 'ksh', 'lo', 'dty', 'gag', 'olo', 'pag', 'pi', 'av', 'bxr',
            'pfl', 'haw', 'xal', 'krc', 'pap', 'kaa', 'rw', 'pdc', 'bjn', 'to',
            'ha', 'nov', 'kl', 'arc', 'jam', 'kbd', 'tyv', 'tpi', 'tet', 'ki',
            'kbp', 'na', 'ig', 'bi', 'roa-rup', 'lbe', 'jbo', 'ty', 'mdf',
            'za', 'kg', 'lg', 'wo', 'srn', 'tcy', 'zu', 'chr', 'ltg', 'sm',
            'om', 'xh', 'rmy', 'tn', 'cu', 'pih', 'rn', 'chy', 'tw', 'ts',
            'tum', 'st', 'got', 'bm', 'pnt', 'ss', 'ch', 'fj', 'atj', 'ady',
            'iu', 'ny', 'ak', 'ee', 'ks', 'ik', 've', 'sg', 'ff', 'dz', 'ti',
            'cr', 'din',
        ]
