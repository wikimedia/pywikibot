...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'kk', 'et', 'min', 'be', 'simple', 'el', 'hr', 'lt', 'gl', 'az', 'ur',
        'uz', 'sl', 'ka', 'nn', 'hi', 'th', 'ta', 'la', 'mk', 'ast', 'bn',
        ...
        'mn', 'crh', 'nv', 'xmf', 'ha', 'si', 'bat-smg', 'os', 'frr', 'ps',
        'ban', 'or', 'gd', 'cdo', 'yi', 'bug', 'ilo', 'sd', 'am', 'sah', 'nap',
        'hsb', 'fo', 'li', 'map-bms', 'mai', 'gor', 'mzn', 'eml', 'ace', 'bcl',
        'shn', 'sa', 'zh-classical', 'wa', 'ie', 'lij', 'ig', 'as', 'zu',
        'mhr', 'mrj', 'hyw', 'hif', 'mni', 'km', 'hak', 'roa-tara', 'pam',
        'sn', 'so', 'nso', 'rue', 'bh', 'se', 'myv', 'vls', 'nds-nl', 'mi',
        'sat', 'sc', 'tum', 'nah', 'vep', 'gan', 'tk', 'kab', 'glk', 'fiu-vro',
        'co', 'bo', 'ab', 'ary', 'gv', 'frp', 'kw', 'kv', 'pcd', 'csb', 'ug',
        'udm', 'skr', 'zea', 'ay', 'gn', 'mt', 'nrm', 'bjn', 'smn', 'lez',
        'lfn', 'stq', 'lo', 'olo', 'mwl', 'rw', 'fur', 'rm', 'ang', 'lad',
        'gom', 'koi', 'ext', 'tyv', 'dsb', 'dty', 'ln', 'av', 'cbk-zam', 'dv',
        'ksh', 'pap', 'gag', 'bxr', 'pfl', 'pag', 'pi', 'haw', 'awa', 'tay',
        'ks', 'tw', 'dag', 'inh', 'mdf', 'szy', 'krc', 'xal', 'kaa', 'za',
        'pdc', 'atj', 'to', 'arc', 'tcy', 'kbp', 'jam', 'na', 'wo', 'kbd',
        'nia', 'nov', 'tet', 'ki', 'lg', 'mnw', 'bi', 'tpi', 'nqo', 'jbo',
        'roa-rup', 'fj', 'lbe', 'kg', 'xh', 'ty', 'cu', 'shi', 'srn', 'blk',
        'trv', 'guw', 'om', 'sm', 'gcr', 'alt', 'chr', 'ltg', 'ny', 'pih',
        'got', 'mad', 'st', 'ami', 'tn', 'bm', 've', 'rmy', 'ts', 'chy', 'rn',
        'iu', 'ak', 'ss', 'ff', 'ch', 'kcg', 'pnt', 'ady', 'ee', 'ik', 'pcm',
