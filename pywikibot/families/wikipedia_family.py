...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'bat-smg', 'os', 'or', 'sah', 'mzn', 'cdo', 'tum', 'ig', 'gd', 'bug',
        'yi', 'sd', 'ilo', 'am', 'nap', 'li', 'fo', 'bcl', 'gor', 'hsb',
        'map-bms', 'mai', 'shn', 'eml', 'ace', 'zh-classical', 'sa', 'as',
        'wa', 'ie', 'lij', 'mhr', 'zu', 'hyw', 'hif', 'sn', 'mrj', 'bjn',
        'mni', 'km', 'hak', 'so', 'roa-tara', 'pam', 'rue', 'sat', 'nso', 'bh',
        'se', 'mi', 'myv', 'vls', 'nds-nl', 'sc', 'dag', 'kw', 'bo', 'vep',
        'ary', 'glk', 'co', 'tk', 'kab', 'gan', 'rw', 'fiu-vro', 'ab', 'gv',
        ...
        'za', 'gag', 'bxr', 'pfl', 'lg', 'pag', 'szy', 'pi', 'tay', 'blk',
        'haw', 'awa', 'inh', 'krc', 'xal', 'pdc', 'to', 'atj', 'arc', 'tcy',
        'mnw', 'jam', 'kbp', 'wo', 'kbd', 'anp', 'nia', 'shi', 'nov', 'ki',
        'nqo', 'bi', 'om', 'tpi', 'xh', 'tet', 'roa-rup', 'jbo', 'fj', 'lbe',
        'kg', 'ty', 'guw', 'cu', 'trv', 'ff', 'ami', 'srn', 'sm', 'alt', 'gcr',
        'mad', 'chr', 'ltg', 'tn', 'ny', 'st', 'pih', 'got', 'rmy', 'ee', 'bm',
        'ss', 'pcm', 'gpe', 've', 'ts', 'chy', 'kcg', 'rn', 'gur', 'ch', 'ik',
        'pnt', 'fat', 'ady', 'guc', 'iu', 'pwn', 'sg', 'din', 'ti', 'kl', 'dz',
        'cr',
    ]
