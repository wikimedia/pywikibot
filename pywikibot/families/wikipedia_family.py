...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ko', 'sh', 'hu', 'cs', 'ro', 'eu', 'ms', 'tr', 'eo', 'hy', 'bg', 'da',
        'he', 'sk', 'zh-min-nan', 'kk', 'min', 'ce', 'hr', 'lt', 'et', 'be',
        'sl', 'el', 'gl', 'az', 'ur', 'simple', 'nn', 'azb', 'uz', 'th', 'hi',
        'la', 'ka', 'vo', 'ta', 'cy', 'mk', 'ast', 'tg', 'lv', 'mg', 'oc',
        'tt', 'bs', 'ky', 'af', 'sq', 'tl', 'new', 'zh-yue', 'te', 'be-tarask',
        'br', 'bn', 'pms', 'ml', 'lb', 'jv', 'ht', 'sco', 'mr', 'ga', 'sw',
        'ba', 'pnb', 'is', 'nds', 'my', 'cv', 'fy', 'su', 'lmo', 'an', 'ne',
        'yo', 'pa', 'gu', 'io', 'bar', 'scn', 'als', 'ku', 'bpy', 'kn', 'ckb',
        'ia', 'qu', 'arz', 'mn', 'wuu', 'bat-smg', 'si', 'wa', 'or', 'gd',
        'yi', 'nap', 'am', 'cdo', 'bug', 'hsb', 'map-bms', 'mai', 'xmf', 'fo',
        'mzn', 'li', 'ilo', 'sah', 'eml', 'os', 'vec', 'sa', 'sd', 'mrj',
        'mhr', 'hif', 'ps', 'roa-tara', 'diq', 'bcl', 'zh-classical', 'hak',
        'frr', 'pam', 'ace', 'szl', 'nso', 'se', 'km', 'nv', 'mi', 'rue',
        'nah', 'nds-nl', 'vls', 'bh', 'gan', 'crh', 'sc', 'vep', 'bo', 'glk',
        'co', 'tk', 'fiu-vro', 'myv', 'so', 'as', 'lrc', 'kv', 'csb', 'gv',
        'shn', 'zea', 'udm', 'pcd', 'ay', 'ie', 'sn', 'ug', 'nrm', 'stq',
        'lez', 'kw', 'lad', 'mwl', 'gom', 'gn', 'rm', 'haw', 'lij', 'ha',
        'koi', 'ab', 'mt', 'fur', 'lfn', 'lo', 'frp', 'dsb', 'ln', 'ang',
        'kab', 'ext', 'cbk-zam', 'dty', 'dv', 'olo', 'ksh', 'gag', 'pi', 'pag',
        'pfl', 'av', 'bjn', 'bxr', 'xal', 'krc', 'gor', 'pap', 'za', 'kaa',
        'pdc', 'rw', 'tyv', 'to', 'kl', 'nov', 'jam', 'arc', 'kbd', 'kbp',
        'tpi', 'tet', 'ig', 'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'kg',
        'bi', 'mdf', 'wo', 'lg', 'zu', 'srn', 'tcy', 'atj', 'inh', 'chr',
        'ltg', 'sm', 'xh', 'om', 'pih', 'sat', 'cu', 'rmy', 'bm', 'tw', 'tn',
