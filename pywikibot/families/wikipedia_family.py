...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'kbd', 'tpi', 'tet', 'ig', 'ki', 'wo', 'zu', 'na', 'jbo', 'tcy',
        'roa-rup', 'lbe', 'bi', 'ty', 'mdf', 'kg', 'lg', 'inh', 'srn', 'atj',
        'xh', 'ltg', 'ban', 'chr', 'sm', 'pih', 'om', 'got', 'ak', 'tn', 'cu',
        'tw', 'ts', 'rmy', 'bm', 'st', 'chy', 'rn', 'tum', 'ny', 'ch', 'ss',
        'nqo', 'pnt', 'fj', 'ady', 'iu', 've', 'ee', 'mnw', 'ks', 'ik', 'sg',
        'ff', 'dz', 'ti', 'cr', 'din', 'gcr', 'szy',
    ]
