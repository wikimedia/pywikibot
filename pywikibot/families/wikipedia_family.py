...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ce', 'ms', 'eo', 'he', 'tt', 'hy', 'bg', 'da', 'azb', 'sk', 'kk',
        'min', 'et', 'hr', 'be', 'lt', 'el', 'simple', 'az', 'gl', 'sl', 'ur',
        'nn', 'ka', 'hi', 'uz', 'th', 'ta', 'la', 'cy', 'ast', 'vo', 'mk',
        'zh-yue', 'bn', 'lv', 'tg', 'my', 'af', 'mg', 'oc', 'bs', 'sq', 'nds',
        'ky', 'mr', 'be-tarask', 'ml', 'new', 'te', 'br', 'vec', 'pms', 'jv',
        'sw', 'pnb', 'ht', 'su', 'lb', 'ba', 'ga', 'szl', 'is', 'tl', 'lmo',
        'cv', 'fy', 'wuu', 'sco', 'an', 'diq', 'ku', 'pa', 'yo', 'ne', 'ckb',
        'bar', 'io', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'qu', 'mn', 'si',
        'bat-smg', 'nv', 'xmf', 'or', 'cdo', 'ilo', 'gd', 'yi', 'am', 'nap',
        'avk', 'sd', 'bug', 'hsb', 'mai', 'fo', 'os', 'frr', 'map-bms', 'li',
        'mzn', 'sah', 'eml', 'ps', 'ace', 'sa', 'gor', 'bcl', 'wa',
        'zh-classical', 'crh', 'lij', 'mrj', 'mhr', 'ha', 'hif', 'hak',
        'roa-tara', 'shn', 'pam', 'hyw', 'as', 'nso', 'zu', 'km', 'rue', 'ie',
        'ban', 'se', 'bh', 'vls', 'nds-nl', 'mi', 'sc', 'nah', 'sn', 'vep',
        'gan', 'myv', 'glk', 'kab', 'sat', 'so', 'ab', 'bo', 'co', 'tk',
        'fiu-vro', 'kv', 'csb', 'pcd', 'frp', 'udm', 'ug', 'gv', 'ay', 'zea',
        'kw', 'nrm', 'lez', 'gn', 'lfn', 'stq', 'mt', 'mni', 'ary', 'mwl',
        'lo', 'rm', 'skr', 'bjn', 'olo', 'lad', 'gom', 'koi', 'fur', 'ang',
        'dsb', 'dty', 'ext', 'ln', 'tyv', 'cbk-zam', 'smn', 'dv', 'ksh', 'gag',
        'pfl', 'pi', 'pag', 'av', 'bxr', 'awa', 'tay', 'haw', 'pap', 'ig',
        'xal', 'rw', 'krc', 'za', 'szy', 'pdc', 'kaa', 'inh', 'arc', 'to',
        'nov', 'kbp', 'jam', 'wo', 'tpi', 'na', 'kbd', 'atj', 'ki', 'tet',
        'tcy', 'ak', 'lld', 'lg', 'jbo', 'bi', 'roa-rup', 'lbe', 'kg', 'ty',
        'mdf', 'xh', 'fj', 'srn', 'om', 'gcr', 'trv', 'ltg', 'sm', 'chr',
        'nia', 'nqo', 'mnw', 'pih', 'got', 'st', 'kl', 'mad', 'tw', 'cu', 'ny',
        'tn', 'ts', 'bm', 'rmy', 've', 'chy', 'rn', 'tum', 'iu', 'ss', 'ch',
        'ks', 'alt', 'pnt', 'ady', 'ee', 'ff', 'ik', 'sg', 'din', 'dz', 'ti',
        'cr',
    ]
