...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'az', 'ur', 'sl', 'ka', 'nn', 'hi', 'th', 'ta', 'lld', 'bn', 'la',
        'mk', 'ast', 'zh-yue', 'lv', 'tg', 'af', 'my', 'mg', 'mr', 'bs', 'sq',
        ...
        'bat-smg', 'os', 'or', 'sah', 'cdo', 'gd', 'bug', 'mzn', 'yi', 'sd',
        'ilo', 'am', 'ig', 'nap', 'li', 'fo', 'gor', 'hsb', 'map-bms', 'mai',
        'bcl', 'tum', 'eml', 'shn', 'ace', 'zh-classical', 'sa', 'as', 'wa',
        'ie', 'lij', 'zu', 'mhr', 'hyw', 'hif', 'sn', 'mrj', 'bjn', 'mni',
        'km', 'hak', 'so', 'roa-tara', 'pam', 'rue', 'nso', 'bh', 'sat', 'se',
        'mi', 'myv', 'vls', 'nds-nl', 'sc', 'kw', 'vep', 'dag', 'glk', 'tk',
        'kab', 'ary', 'gan', 'nah', 'bo', 'co', 'fiu-vro', 'ab', 'rw', 'gv',
        'ug', 'zea', 'skr', 'frp', 'udm', 'pcd', 'kv', 'csb', 'mt', 'gn',
        'smn', 'ay', 'nrm', 'lez', 'lfn', 'mwl', 'olo', 'stq', 'ks', 'lo',
        'ang', 'fur', 'rm', 'lad', 'gom', 'ext', 'koi', 'tyv', 'dsb', 'av',
        'mdf', 'dty', 'ln', 'kaa', 'pap', 'cbk-zam', 'tw', 'dv', 'ksh', 'gag',
        ...
        'ltg', 'mad', 'ny', 'ff', 'st', 'pih', 'got', 'rmy', 'ee', 'ami', 'bm',
        've', 'ts', 'chy', 'pcm', 'ss', 'kcg', 'rn', 'ch', 'ik', 'pnt', 'ady',
        'guc', 'fat', 'iu', 'gur', 'pwn', 'sg', 'din', 'ti', 'kl', 'dz', 'cr',
    ]
