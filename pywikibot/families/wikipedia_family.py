...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'el', 'sl', 'gl', 'azb', 'nn', 'az', 'simple', 'ur', 'th', 'hi', 'uz',
        'ka', 'la', 'ta', 'vo', 'cy', 'mk', 'ast', 'tg', 'lv', 'mg', 'tt',
        'oc', 'af', 'bs', 'ky', 'sq', 'tl', 'zh-yue', 'new', 'bn', 'te',
        'be-tarask', 'br', 'ml', 'pms', 'lb', 'jv', 'ht', 'sco', 'mr', 'nds',
        'sw', 'su', 'ga', 'ba', 'is', 'pnb', 'my', 'fy', 'cv', 'lmo', 'an',
        'ne', 'yo', 'pa', 'io', 'gu', 'bar', 'ku', 'als', 'scn', 'bpy', 'kn',
        'ckb', 'ia', 'qu', 'wuu', 'arz', 'mn', 'bat-smg', 'wa', 'si', 'or',
        'gd', 'yi', 'am', 'cdo', 'nap', 'bug', 'hsb', 'mai', 'map-bms', 'fo',
        'mzn', 'xmf', 'ilo', 'li', 'vec', 'eml', 'sah', 'sd', 'os', 'sa',
        'diq', 'ps', 'mrj', 'mhr', 'zh-classical', 'hif', 'roa-tara', 'bcl',
        'frr', 'nv', 'ace', 'hak', 'pam', 'szl', 'nso', 'se', 'km', 'hyw',
        'rue', 'mi', 'nah', 'vls', 'bh', 'nds-nl', 'crh', 'gan', 'vep', 'sc',
        'ab', 'bo', 'as', 'myv', 'glk', 'co', 'tk', 'so', 'fiu-vro', 'lrc',
        'kv', 'csb', 'shn', 'gv', 'sn', 'udm', 'zea', 'ay', 'ie', 'pcd', 'nrm',
        'ug', 'kab', 'stq', 'lez', 'kw', 'lad', 'mwl', 'ha', 'gom', 'gn',
        'haw', 'rm', 'lij', 'lfn', 'koi', 'lo', 'mt', 'frp', 'fur', 'dsb',
        'ext', 'ln', 'ang', 'dty', 'olo', 'cbk-zam', 'dv', 'ksh', 'gag', 'bjn',
        'pi', 'pag', 'pfl', 'av', 'bxr', 'gor', 'xal', 'krc', 'za', 'pap',
        'kaa', 'pdc', 'tyv', 'rw', 'to', 'kl', 'nov', 'arc', 'jam', 'kbp',
        'kbd', 'tpi', 'tet', 'ig', 'ki', 'zu', 'na', 'wo', 'jbo', 'roa-rup',
        'lbe', 'bi', 'ty', 'kg', 'mdf', 'lg', 'tcy', 'srn', 'sat', 'inh', 'xh',
        'atj', 'ltg', 'chr', 'sm', 'pih', 'om', 'tn', 'cu', 'ak', 'tw', 'rmy',
        'bm', 'ts', 'chy', 'rn', 'st', 'got', 'tum', 'ny', 'ch', 'ss', 'pnt',
