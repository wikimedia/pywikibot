...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'be', 'el', 'gl', 'az', 'ur', 'simple', 'nn', 'uz', 'la', 'th', 'hi',
        ...
        'lad', 'kw', 'mwl', 'gn', 'gom', 'rm', 'lij', 'ab', 'koi', 'shn',
        'haw', 'mt', 'fur', 'ha', 'frp', 'dsb', 'lo', 'lfn', 'ang', 'ln',
        'ext', 'cbk-zam', 'dv', 'dty', 'kab', 'ksh', 'olo', 'gag', 'pi', 'pag',
        'pfl', 'av', 'bxr', 'xal', 'bjn', 'krc', 'gor', 'pap', 'kaa', 'za',
        'pdc', 'rw', 'tyv', 'to', 'kl', 'nov', 'jam', 'arc', 'kbd', 'tpi',
        'kbp', 'tet', 'ig', 'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'mdf',
        'kg', 'bi', 'wo', 'lg', 'srn', 'zu', 'atj', 'tcy', 'chr', 'ltg', 'inh',
        'sm', 'om', 'xh', 'pih', 'cu', 'rmy', 'tw', 'bm', 'tn', 'chy', 'rn',
