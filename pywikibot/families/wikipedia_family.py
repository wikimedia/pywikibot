...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'el', 'azb', 'sl', 'gl', 'az', 'simple', 'ur', 'nn', 'hi', 'th', 'ka',
        'uz', 'la', 'ta', 'vo', 'arz', 'cy', 'mk', 'tg', 'lv', 'ast', 'mg',
        'tt', 'af', 'oc', 'bs', 'bn', 'ky', 'sq', 'zh-yue', 'tl', 'new', 'te',
        'be-tarask', 'br', 'ml', 'pms', 'nds', 'su', 'ht', 'lb', 'jv', 'sco',
        'mr', 'sw', 'pnb', 'ga', 'szl', 'ba', 'is', 'my', 'fy', 'cv', 'lmo',
        'an', 'ne', 'pa', 'yo', 'bar', 'io', 'gu', 'wuu', 'als', 'ku', 'scn',
        'kn', 'ckb', 'bpy', 'ia', 'qu', 'mn', 'bat-smg', 'vec', 'wa', 'si',
        'or', 'cdo', 'gd', 'yi', 'am', 'nap', 'ilo', 'bug', 'xmf', 'mai',
        'hsb', 'map-bms', 'fo', 'diq', 'mzn', 'sd', 'li', 'eml', 'sah', 'nv',
        'os', 'sa', 'ps', 'ace', 'mrj', 'frr', 'zh-classical', 'mhr', 'hif',
        'bcl', 'hak', 'roa-tara', 'pam', 'nso', 'km', 'hyw', 'se', 'rue', 'mi',
        'vls', 'bh', 'crh', 'nah', 'nds-nl', 'shn', 'gan', 'vep', 'sc', 'as',
        'ab', 'glk', 'myv', 'bo', 'co', 'so', 'tk', 'fiu-vro', 'lrc', 'kv',
        'csb', 'gv', 'sn', 'udm', 'zea', 'ie', 'pcd', 'ay', 'ha', 'kab', 'nrm',
        ...
        'ban', 'kaa', 'pdc', 'rw', 'to', 'szy', 'nov', 'kl', 'jam', 'arc',
        'tpi', 'kbp', 'kbd', 'tet', 'ig', 'wo', 'zu', 'ki', 'na', 'tcy', 'jbo',
        'roa-rup', 'lbe', 'bi', 'ty', 'inh', 'kg', 'mdf', 'lg', 'atj', 'srn',
        'xh', 'gcr', 'ltg', 'chr', 'got', 'sm', 'pih', 'ak', 'om', 'fj', 'tn',
        'tw', 'cu', 'ts', 'rmy', 'bm', 'st', 'chy', 'rn', 'tum', 'ny', 'nqo',
        'ch', 'ss', 'pnt', 'mnw', 'ady', 'iu', 've', 'ks', 'ee', 'ik', 'sg',
        'ff', 'dz', 'ti', 'din', 'cr',
    ]
