...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'simple', 'nn', 'la', 'el', 'th', 'new', 'roa-rup', 'oc', 'sh',
            'ka', 'mk', 'tl', 'ht', 'pms', 'te', 'ta', 'be-x-old', 'be', 'ceb',
            'br', 'lv', 'sq', 'jv', 'mg', 'cy', 'lb', 'mr', 'is', 'bs', 'yo',
            'an', 'hy', 'fy', 'lmo', 'bpy', 'pnb', 'ml', 'sw', 'bn', 'io', 'af',
            'gu', 'zh-yue', 'ne', 'nds', 'ku', 'ur', 'ast', 'scn', 'su', 'qu',
            'diq', 'ba', 'tt', 'my', 'ga', 'uz', 'cv', 'ia', 'nap', 'bat-smg',
            'map-bms', 'wa', 'als', 'kn', 'am', 'bug', 'tg', 'gd', 'zh-min-nan',
            'yi', 'vec', 'sco', 'hif', 'roa-tara', 'arz', 'os', 'nah', 'sah',
            'mn', 'mzn', 'sa', 'pam', 'hsb', 'ky', 'mi', 'li', 'si', 'co',
            'gan', 'ckb', 'glk', 'bo', 'fo', 'bar', 'bcl', 'ilo', 'mrj',
            'fiu-vro', 'nds-nl', 'tk', 'vls', 'se', 'ps', 'gv', 'rue', 'dv',
            'nrm', 'pag', 'koi', 'pa', 'rm', 'km', 'kv', 'udm', 'csb', 'mhr',
            'fur', 'mt', 'wuu', 'lij', 'ug', 'zea', 'lad', 'pi', 'sc', 'bh',
            'zh-classical', 'or', 'nov', 'ksh', 'ang', 'kw', 'xmf', 'so', 'nv',
            'stq', 'hak', 'ay', 'frr', 'frp', 'ext', 'szl', 'pcd', 'ie', 'gag',
            'haw', 'xal', 'ln', 'rw', 'pdc', 'pfl', 'krc', 'crh', 'eml', 'ace',
            'gn', 'vep', 'to', 'ce', 'kl', 'arc', 'myv', 'dsb', 'as', 'pap',
            'bjn', 'tpi', 'lbe', 'mdf', 'wo', 'jbo', 'kab', 'av', 'sn',
            ...
            'ki', 've', 'sg', 'rn', 'cr', 'dz', 'lg', 'ak', 'tum', 'fj', 'st',
            'tw', 'ch', 'ny', 'ff', 'xh',
        ]
