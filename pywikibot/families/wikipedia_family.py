...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'nv', 'xmf', 'crh', 'si', 'lld', 'bat-smg', 'or', 'gd', 'frr', 'cdo',
        'os', 'ilo', 'yi', 'sd', 'am', 'ha', 'bug', 'nap', 'sah', 'ps', 'hsb',
        'map-bms', 'fo', 'mai', 'li', 'mzn', 'ban', 'eml', 'gor', 'ace', 'bcl',
        'sa', 'wa', 'zh-classical', 'lij', 'shn', 'zu', 'mrj', 'mhr', 'as',
        'hif', 'mni', 'hyw', 'hak', 'roa-tara', 'km', 'pam', 'ie', 'nso',
        'rue', 'so', 'sn', 'bh', 'se', 'vls', 'nds-nl', 'myv', 'sat', 'nah',
        'mi', 'sc', 'vep', 'gan', 'kab', 'glk', 'tk', 'fiu-vro', 'co', 'bo',
        'ab', 'frp', 'kv', 'csb', 'pcd', 'kw', 'gv', 'ug', 'udm', 'ary', 'ay',
        'nrm', 'zea', 'gn', 'skr', 'mt', 'bjn', 'lez', 'lfn', 'smn', 'stq',
        'lo', 'mwl', 'olo', 'ig', 'rm', 'fur', 'lad', 'gom', 'ang', 'koi',
        'ext', 'tyv', 'dsb', 'dty', 'ln', 'cbk-zam', 'dv', 'rw', 'ksh', 'gag',
        'bxr', 'pfl', 'av', 'pag', 'pi', 'haw', 'awa', 'tay', 'pap', 'krc',
        'xal', 'szy', 'inh', 'za', 'kaa', 'pdc', 'atj', 'to', 'tum', 'arc',
        'dag', 'tw', 'tpi', 'kbp', 'jam', 'na', 'wo', 'mdf', 'kbd', 'tcy',
        'nov', 'nia', 'ki', 'tet', 'lg', 'bi', 'jbo', 'roa-rup', 'fj', 'kg',
        'lbe', 'xh', 'ty', 'nqo', 'mnw', 'ks', 'cu', 'shi', 'trv', 'srn', 'om',
        'sm', 'gcr', 'alt', 'ltg', 'chr', 'pih', 'ny', 'got', 'mad', 'st',
        'ami', 'rmy', 'tn', 'bm', 'ts', 'chy', 've', 'rn', 'guw', 'iu', 'ak',
