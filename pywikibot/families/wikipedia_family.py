...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'se', 'vls', 'dag', 'nds-nl', 'co', 'sc', 'ary', 'kw', 'bo', 'vep',
        'glk', 'tk', 'kab', 'gan', 'rw', 'fiu-vro', 'gv', 'ab', 'zea', 'ug',
        'nah', 'skr', 'frp', 'mt', 'tly', 'udm', 'pcd', 'kv', 'gn', 'csb',
        'smn', 'ay', 'nrm', 'ks', 'lez', 'olo', 'lfn', 'mwl', 'mdf', 'lo',
        'stq', 'ang', 'fur', 'rm', 'kaa', 'lad', 'ext', 'gom', 'tw', 'tyv',
        'koi', 'pap', 'av', 'dsb', 'ln', 'dty', 'cbk-zam', 'dv', 'ksh', 'za',
        'gag', 'bxr', 'pfl', 'lg', 'szy', 'blk', 'pag', 'tay', 'pi', 'haw',
        'awa', 'inh', 'krc', 'xal', 'pdc', 'to', 'atj', 'tcy', 'arc', 'mnw',
        'shi', 'jam', 'kbp', 'wo', 'anp', 'kbd', 'nia', 'om', 'nov', 'ki',
        'ff', 'xh', 'nqo', 'bi', 'tpi', 'tet', 'roa-rup', 'jbo', 'fj', 'lbe',
        'kg', 'ty', 'guw', 'cu', 'trv', 'ami', 'srn', 'mad', 'sm', 'tn', 'alt',
        'ltg', 'gcr', 'chr', 'ny', 'st', 'pih', 'gpe', 'got', 'rmy', 'ss',
        'ee', 'pcm', 'bm', 'kcg', 'ts', 've', 'chy', 'rn', 'gur', 'ch', 'ady',
        'ik', 'guc', 'fat', 'pnt', 'iu', 'pwn', 'sg', 'din', 'ti', 'kl', 'dz',
        'cr', 'fon',
    ]
