...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'vo', 'yo', 'ne', 'ia', 'kn', 'gu', 'ha', 'als', 'avk', 'bar', 'crh',
        'scn', 'bpy', 'qu', 'mn', 'nv', 'xmf', 'ban', 'si', 'tum', 'ps', 'frr',
        'ig', 'os', 'mzn', 'bat-smg', 'or', 'sah', 'cdo', 'gd', 'bug', 'yi',
        ...
        'zea', 'skr', 'frp', 'udm', 'mt', 'pcd', 'kv', 'gn', 'csb', 'smn',
        'ay', 'nrm', 'ks', 'lez', 'olo', 'lfn', 'mwl', 'lo', 'stq', 'ang',
        'mdf', 'fur', 'rm', 'lad', 'kaa', 'ext', 'gom', 'koi', 'tyv', 'pap',
        'av', 'dsb', 'ln', 'dty', 'tw', 'cbk-zam', 'dv', 'ksh', 'za', 'gag',
        'bxr', 'pfl', 'lg', 'szy', 'blk', 'pag', 'pi', 'tay', 'haw', 'tly',
        'awa', 'inh', 'krc', 'xal', 'pdc', 'to', 'atj', 'tcy', 'arc', 'mnw',
        'shi', 'jam', 'kbp', 'wo', 'anp', 'kbd', 'nia', 'om', 'nov', 'ki',
        'nqo', 'bi', 'xh', 'ff', 'tpi', 'tet', 'roa-rup', 'jbo', 'fj', 'kg',
        'lbe', 'ty', 'cu', 'guw', 'trv', 'ami', 'srn', 'sm', 'mad', 'alt',
        'ltg', 'gcr', 'chr', 'tn', 'ny', 'st', 'pih', 'got', 'rmy', 'ee', 'ss',
        'pcm', 'bm', 'gpe', 'ts', 've', 'kcg', 'chy', 'rn', 'gur', 'ch', 'ik',
        'ady', 'fat', 'guc', 'pnt', 'iu', 'pwn', 'sg', 'din', 'ti', 'kl', 'dz',
        'cr',
    ]
