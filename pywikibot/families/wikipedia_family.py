...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'scn', 'bpy', 'qu', 'mn', 'nv', 'ban', 'xmf', 'si', 'ig', 'frr', 'tum',
        'ps', 'mzn', 'os', 'or', 'bat-smg', 'sah', 'cdo', 'gd', 'bug', 'sd',
        'yi', 'ilo', 'bcl', 'am', 'li', 'nap', 'gor', 'fo', 'hsb', 'map-bms',
        'mai', 'shn', 'eml', 'ace', 'zh-classical', 'as', 'sa', 'wa', 'ie',
        'hyw', 'mhr', 'lij', 'sn', 'zu', 'hif', 'mrj', 'bjn', 'km', 'mni',
        'hak', 'sat', 'roa-tara', 'pam', 'rue', 'nso', 'bh', 'ary', 'dag',
        'so', 'mi', 'myv', 'se', 'nds-nl', 'vls', 'co', 'sc', 'bo', 'kw',
        'vep', 'glk', 'tk', 'kab', 'gan', 'rw', 'fiu-vro', 'gv', 'ab', 'zea',
        'ug', 'nah', 'skr', 'frp', 'mt', 'tly', 'udm', 'pcd', 'kv', 'gn',
        'csb', 'smn', 'ay', 'nrm', 'ks', 'lez', 'olo', 'mwl', 'lfn', 'mdf',
        'lo', 'stq', 'ang', 'fur', 'kaa', 'rm', 'lad', 'ext', 'gom', 'tw',
        'pap', 'tyv', 'koi', 'av', 'dsb', 'ln', 'dty', 'cbk-zam', 'dv', 'ksh',
        'za', 'lg', 'gag', 'bxr', 'pfl', 'szy', 'blk', 'tay', 'pag', 'pi',
        'haw', 'awa', 'inh', 'krc', 'xal', 'pdc', 'to', 'atj', 'tcy', 'arc',
        'mnw', 'shi', 'jam', 'kbp', 'wo', 'anp', 'nia', 'kbd', 'om', 'nov',
        'ff', 'ki', 'xh', 'nqo', 'bi', 'tpi', 'tet', 'roa-rup', 'jbo', 'fj',
        'kg', 'lbe', 'guw', 'ty', 'cu', 'tn', 'trv', 'ami', 'srn', 'mad', 'sm',
        'alt', 'ltg', 'gcr', 'chr', 'rmy', 'ny', 'st', 'pcm', 'pih', 'gpe',
        'got', 'ss', 'ee', 'bm', 'kcg', 'ts', 've', 'gur', 'chy', 'rn', 'ch',
