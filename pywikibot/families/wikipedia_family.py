...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'th', 'ka', 'uz', 'la', 'cy', 'ta', 'vo', 'mk', 'ast', 'lv', 'tg',
        'mg', 'af', 'tt', 'oc', 'bn', 'bs', 'zh-yue', 'ky', 'sq', 'tl', 'new',
        'te', 'be-tarask', 'ml', 'br', 'pms', 'nds', 'su', 'sw', 'lb', 'ht',
        'jv', 'sco', 'mr', 'pnb', 'ga', 'szl', 'ba', 'is', 'my', 'fy', 'cv',
        'lmo', 'an', 'pa', 'ne', 'yo', 'wuu', 'bar', 'io', 'gu', 'ku', 'als',
        'scn', 'kn', 'ckb', 'bpy', 'vec', 'ia', 'qu', 'mn', 'bat-smg', 'or',
        'si', 'cdo', 'gd', 'yi', 'am', 'ilo', 'nap', 'diq', 'bug', 'xmf', 'nv',
        'hsb', 'mai', 'wa', 'map-bms', 'sd', 'fo', 'mzn', 'li', 'eml', 'sah',
        'os', 'sa', 'ps', 'frr', 'bcl', 'ace', 'mrj', 'zh-classical', 'mhr',
        'hif', 'hak', 'roa-tara', 'pam', 'nso', 'km', 'hyw', 'se', 'rue',
        'crh', 'mi', 'vls', 'bh', 'shn', 'nah', 'nds-nl', 'sc', 'as', 'vep',
        'gan', 'ab', 'glk', 'myv', 'bo', 'co', 'so', 'tk', 'fiu-vro', 'lrc',
        'kv', 'csb', 'sn', 'gor', 'gv', 'udm', 'ha', 'ie', 'zea', 'pcd', 'ay',
        'kab', 'nrm', 'ug', 'lez', 'stq', 'kw', 'haw', 'lfn', 'mwl', 'gn',
        'lij', 'gom', 'rm', 'lo', 'frp', 'lad', 'mt', 'koi', 'fur', 'olo',
        'dsb', 'dty', 'ang', 'ext', 'ln', 'cbk-zam', 'bjn', 'dv', 'sat', 'ksh',
        'gag', 'pfl', 'ban', 'pag', 'pi', 'av', 'tyv', 'bxr', 'xal', 'krc',
        'pap', 'za', 'kaa', 'pdc', 'rw', 'szy', 'to', 'arc', 'nov', 'jam',
        'tpi', 'kbp', 'kbd', 'na', 'tet', 'ig', 'zu', 'wo', 'ki', 'tcy', 'inh',
        'jbo', 'roa-rup', 'bi', 'lbe', 'kg', 'ty', 'mdf', 'lg', 'atj', 'srn',
        'xh', 'gcr', 'ltg', 'fj', 'chr', 'sm', 'got', 'kl', 'ak', 'pih', 'om',
        'tn', 'cu', 'tw', 'ts', 'st', 'rmy', 'bm', 'chy', 'rn', 'tum', 'nqo',
        'ny', 'ch', 'mnw', 'ss', 'pnt', 'ady', 'iu', 'ks', 've', 'ee', 'ik',
        'sg', 'ff', 'ti', 'dz', 'din', 'cr',
    ]
