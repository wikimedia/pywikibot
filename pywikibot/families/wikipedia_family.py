...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'he', 'zh-min-nan', 'sk', 'min', 'kk', 'hr', 'ce', 'lt', 'et', 'sl',
        'be', 'el', 'gl', 'ur', 'nn', 'az', 'simple', 'uz', 'la', 'hi', 'th',
        'ka', 'vo', 'ta', 'cy', 'azb', 'mk', 'tg', 'lv', 'ast', 'mg', 'oc',
        ...
        'xmf', 'li', 'sah', 'ilo', 'sa', 'vec', 'wuu', 'os', 'eml', 'mrj',
        'sd', 'mhr', 'hif', 'roa-tara', 'ps', 'diq', 'hak', 'pam', 'nso',
        'zh-classical', 'bcl', 'bh', 'ace', 'szl', 'se', 'mi', 'frr', 'nah',
        'nds-nl', 'rue', 'km', 'vls', 'gan', 'crh', 'sc', 'bo', 'nv', 'vep',
        'glk', 'co', 'tk', 'fiu-vro', 'lrc', 'so', 'myv', 'kv', 'csb', 'as',
        'gv', 'udm', 'zea', 'ay', 'ug', 'ie', 'nrm', 'stq', 'lez', 'kw', 'lad',
        'sn', 'pcd', 'mwl', 'gn', 'rm', 'gom', 'koi', 'ab', 'lij', 'mt', 'fur',
        'dsb', 'frp', 'ln', 'dv', 'ang', 'cbk-zam', 'ext', 'dty', 'lo', 'kab',
        'ksh', 'gag', 'lfn', 'haw', 'olo', 'pag', 'pi', 'av', 'pfl', 'bxr',
        'xal', 'krc', 'pap', 'kaa', 'ha', 'bjn', 'rw', 'pdc', 'gor', 'tyv',
        'to', 'nov', 'kl', 'jam', 'arc', 'kbd', 'tpi', 'kbp', 'tet', 'ki',
        'ig', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'mdf', 'za', 'kg', 'bi',
        'wo', 'lg', 'srn', 'zu', 'tcy', 'chr', 'ltg', 'sm', 'om', 'inh', 'xh',
        'rmy', 'cu', 'pih', 'bm', 'tn', 'rn', 'chy', 'tw', 'atj', 'got', 'ts',
        'tum', 'ak', 'st', 'ch', 'pnt', 'ss', 'fj', 'ady', 'iu', 'ny', 'ee',
        'ks', 've', 'ik', 'sg', 'ff', 'dz', 'ti', 'cr', 'din', 'sat',
    ]
