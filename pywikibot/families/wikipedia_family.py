...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'avk', 'sah', 'frr', 'eml', 'ace', 'ps', 'sa', 'gor', 'bcl',
        'zh-classical', 'mrj', 'lij', 'mhr', 'hif', 'hak', 'roa-tara', 'crh',
        'pam', 'hyw', 'ha', 'shn', 'nso', 'as', 'km', 'rue', 'zu', 'se', 'bh',
        'vls', 'nds-nl', 'mi', 'nah', 'sc', 'ban', 'sn', 'vep', 'gan', 'myv',
        'glk', 'kab', 'ab', 'ie', 'so', 'bo', 'sat', 'co', 'tk', 'fiu-vro',
        'kv', 'csb', 'pcd', 'gv', 'udm', 'ug', 'ay', 'frp', 'zea', 'nrm', 'kw',
        'lez', 'gn', 'lfn', 'stq', 'mwl', 'mt', 'rm', 'lo', 'ary', 'lad',
        'olo', 'gom', 'skr', 'bjn', 'koi', 'fur', 'ang', 'dty', 'dsb', 'ext',
        'ln', 'tyv', 'cbk-zam', 'dv', 'ksh', 'smn', 'gag', 'mni', 'pfl', 'pag',
        ...
        'bm', 'rmy', 'chy', 'rn', 'tum', 'ss', 'ch', 'iu', 'ks', 'pnt', 've',
