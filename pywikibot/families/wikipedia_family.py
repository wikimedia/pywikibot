...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ky', 'mr', 'be-tarask', 'ml', 'new', 'te', 'br', 'vec', 'sw', 'pms',
        'jv', 'pnb', 'ht', 'su', 'lb', 'ba', 'ga', 'szl', 'is', 'lmo', 'tl',
        'ku', 'cv', 'fy', 'wuu', 'sco', 'an', 'diq', 'pa', 'ckb', 'yo', 'ne',
        'bar', 'io', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'qu', 'mn', 'si',
        'bat-smg', 'nv', 'xmf', 'or', 'cdo', 'avk', 'gd', 'ilo', 'yi', 'am',
        'nap', 'sd', 'bug', 'frr', 'hsb', 'os', 'mai', 'fo', 'map-bms', 'li',
        'mzn', 'sah', 'eml', 'ace', 'ps', 'gor', 'sa', 'bcl', 'wa', 'crh',
        'ha', 'zh-classical', 'lij', 'mrj', 'mhr', 'hif', 'zu', 'shn', 'hak',
        'roa-tara', 'as', 'hyw', 'ban', 'pam', 'nso', 'ie', 'km', 'rue', 'se',
        'bh', 'vls', 'nds-nl', 'sn', 'mi', 'sc', 'nah', 'vep', 'myv', 'gan',
        'sat', 'glk', 'so', 'kab', 'co', 'tk', 'bo', 'ab', 'fiu-vro', 'kv',
        ...
        'pag', 'pi', 'av', 'awa', 'tay', 'haw', 'ig', 'pap', 'rw', 'xal',
        'krc', 'szy', 'za', 'pdc', 'kaa', 'inh', 'arc', 'to', 'kbp', 'jam',
        'wo', 'tpi', 'na', 'kbd', 'atj', 'nov', 'ki', 'tet', 'tcy', 'ak',
        'lld', 'lg', 'jbo', 'bi', 'roa-rup', 'mdf', 'lbe', 'kg', 'ty', 'xh',
        'fj', 'srn', 'om', 'trv', 'gcr', 'sm', 'ltg', 'shi', 'nqo', 'chr',
        'nia', 'mnw', 'pih', 'tw', 'got', 'st', 'kl', 'mad', 'cu', 'ny', 'tn',
        'bm', 'ks', 'ts', 'rmy', 've', 'chy', 'rn', 'tum', 'iu', 'ss', 'ch',
        'alt', 'dag', 'pnt', 'ady', 'ee', 'ff', 'ik', 'din', 'sg', 'dz', 'ti',
        'cr',
    ]
