...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'fa', 'ro', 'ar', 'sk', 'eo', 'da', 'sr', 'lt', 'sl', 'ms', 'he',
            ...
            'ps', 'pa', 'rm', 'koi', 'km', 'udm', 'kv', 'csb', 'mhr', 'fur',
            ...
            'bjn', 'lbe', 'tpi', 'wo', 'mdf', 'jbo', 'kab', 'av', 'sn', 'ty',
            'srn', 'lo', 'ab', 'ltg', 'mwl', 'ig', 'na', 'kg', 'tet', 'kbd',
            'kaa', 'nso', 'lez', 'rmy', 'cu', 'zu', 'tn', 'chr', 'sm', 'bi',
            'sd', 'bm', 'ik', 'iu', 'pih', 'ss', 'za', 'pnt', 'got', 'cdo',
            'ee', 'ha', 'ti', 'chy', 'om', 'ks', 'bxr', 'vep', 'ts', 've', 'sg',
