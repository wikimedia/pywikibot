...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'hi', 'uz', 'ka', 'th', 'tt', 'la', 'cy', 'ta', 'vo', 'mk', 'ast',
        'lv', 'zh-yue', 'tg', 'bn', 'af', 'mg', 'oc', 'bs', 'sq', 'ky', 'nds',
        'new', 'be-tarask', 'ml', 'te', 'br', 'tl', 'vec', 'pms', 'mr', 'su',
        'ht', 'sw', 'lb', 'jv', 'sco', 'pnb', 'ba', 'ga', 'szl', 'is', 'my',
        'fy', 'cv', 'lmo', 'wuu', 'an', 'pa', 'ne', 'yo', 'ku', 'diq', 'bar',
        'io', 'gu', 'als', 'ckb', 'kn', 'scn', 'bpy', 'qu', 'ia', 'mn',
        'bat-smg', 'nv', 'si', 'or', 'cdo', 'ilo', 'gd', 'xmf', 'yi', 'am',
        'nap', 'wa', 'bug', 'sd', 'hsb', 'mai', 'map-bms', 'fo', 'mzn', 'li',
        ...
        'zu', 'lez', 'frp', 'stq', 'lfn', 'ban', 'gn', 'mwl', 'gom', 'rm',
        'mt', 'lo', 'lad', 'koi', 'fur', 'olo', 'ang', 'dty', 'dsb', 'bjn',
        'ext', 'ln', 'cbk-zam', 'dv', 'ksh', 'tyv', 'gag', 'pfl', 'pag', 'ary',
        'pi', 'av', 'awa', 'haw', 'bxr', 'xal', 'krc', 'pap', 'za', 'pdc',
        'kaa', 'rw', 'szy', 'arc', 'to', 'nov', 'jam', 'tpi', 'kbp', 'kbd',
        'ig', 'na', 'inh', 'tet', 'wo', 'tcy', 'ki', 'atj', 'jbo', 'roa-rup',
