...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ka', 'tl', 'ht', 'pms', 'te', 'ta', 'be', 'be-x-old', 'br', 'lv',
            'ceb', 'sq', 'jv', 'mg', 'cy', 'mr', 'lb', 'uz', 'is', 'bs', 'my',
            'yo', 'an', 'lmo', 'hy', 'ml', 'fy', 'pnb', 'bpy', 'sw', 'bn', 'io',
            'af', 'gu', 'zh-yue', 'ne', 'nds', 'ur', 'ku', 'ast', 'scn', 'su',
            'qu', 'diq', 'ba', 'tt', 'ga', 'cv', 'ia', 'nap', 'bat-smg',
            'map-bms', 'wa', 'als', 'kn', 'am', 'gd', 'bug', 'tg', 'ckb',
            'zh-min-nan', 'sco', 'yi', 'mzn', 'vec', 'hif', 'ky', 'roa-tara',
            'arz', 'nah', 'os', 'sah', 'mn', 'sa', 'pam', 'hsb', 'li', 'mi',
            'si', 'co', 'gan', 'glk', 'fo', 'bar', 'bo', 'ilo', 'bcl', 'se',
            'mrj', 'nds-nl', 'fiu-vro', 'tk', 'ps', 'vls', 'gv', 'rue', 'dv',
            'xmf', 'pag', 'nrm', 'pa', 'koi', 'rm', 'kv', 'km', 'zea', 'csb',
            'udm', 'mhr', 'fur', 'mt', 'lad', 'wuu', 'lij', 'ug', 'or', 'pi',
            'sc', 'zh-classical', 'bh', 'frr', 'nov', 'ksh', 'ang', 'so', 'kw',
            'stq', 'nv', 'hak', 'ay', 'frp', 'ext', 'pcd', 'szl', 'gag', 'ie',
            'ln', 'vep', 'haw', 'xal', 'gn', 'rw', 'pdc', 'pfl', 'eml', 'krc',
            'crh', 'ace', 'to', 'ce', 'kl', 'arc', 'myv', 'dsb', 'as', 'bjn',
            'pap', 'sn', 'tpi', 'lbe', 'mdf', 'wo', 'jbo', 'kab', 'av',
            'cbk-zam', 'srn', 'ty', 'lez', 'kbd', 'lo', 'ab', 'tet', 'mwl',
            'ltg', 'na', 'ig', 'kg', 'za', 'kaa', 'nso', 'zu', 'rmy', 'cu',
            'tn', 'chy', 'chr', 'cdo', 'got', 'sm', 'bi', 'iu', 'bm', 'pih',
            'ss', 'sd', 'pnt', 'ee', 'ha', 'bxr', 'ti', 'ts', 'om', 'ks', 'ki',
            've', 'sg', 'rn', 'cr', 'lg', 'dz', 'ak', 'ik', 'ff', 'ch', 'tum',
            'fj', 'st', 'tw', 'xh', 'ny',
        ]
