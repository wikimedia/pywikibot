...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'roa-rup', 'tl', 'pms', 'be', 'ht', 'te', 'uz', 'ta', 'be-x-old',
            'lv', 'br', 'sq', 'ceb', 'jv', 'mg', 'cy', 'mr', 'lb', 'is', 'bs',
            'hy', 'my', 'yo', 'an', 'lmo', 'ml', 'fy', 'pnb', 'af', 'bpy', 'bn',
            'sw', 'io', 'scn', 'ne', 'gu', 'zh-yue', 'ur', 'ba', 'nds', 'ku',
            'ky', 'ast', 'qu', 'su', 'diq', 'tt', 'ga', 'cv', 'ia', 'nap',
            'bat-smg', 'map-bms', 'als', 'wa', 'kn', 'am', 'sco', 'ckb', 'gd',
            'bug', 'tg', 'hif', 'mzn', 'zh-min-nan', 'yi', 'vec', 'arz',
            'roa-tara', 'nah', 'os', 'sah', 'mn', 'sa', 'pam', 'hsb', 'li',
            'mi', 'si', 'se', 'co', 'gan', 'glk', 'bar', 'bo', 'fo', 'ilo',
            'bcl', 'mrj', 'fiu-vro', 'nds-nl', 'ps', 'tk', 'vls', 'gv', 'rue',
            'pa', 'xmf', 'pag', 'dv', 'nrm', 'zea', 'kv', 'koi', 'km', 'rm',
            'csb', 'lad', 'udm', 'or', 'mt', 'mhr', 'fur', 'lij', 'wuu', 'ug',
            'frr', 'pi', 'sc', 'zh-classical', 'bh', 'nov', 'ksh', 'ang', 'so',
            'stq', 'kw', 'nv', 'vep', 'hak', 'ay', 'frp', 'pcd', 'ext', 'szl',
            'gag', 'gn', 'ln', 'ie', 'eml', 'haw', 'xal', 'pfl', 'pdc', 'rw',
            'krc', 'crh', 'ace', 'to', 'as', 'ce', 'kl', 'arc', 'dsb', 'myv',
            'pap', 'bjn', 'sn', 'tpi', 'lbe', 'lez', 'kab', 'mdf', 'wo', 'jbo',
            'av', 'srn', 'cbk-zam', 'bxr', 'ty', 'lo', 'kbd', 'ab', 'tet',
            'mwl', 'ltg', 'na', 'kg', 'ig', 'nso', 'za', 'kaa', 'zu', 'chy',
            'rmy', 'cu', 'tn', 'chr', 'got', 'cdo', 'sm', 'bi', 'bm', 'iu',
            'pih', 'ss', 'sd', 'pnt', 'ee', 'ki', 'om', 'ha', 'ti', 'ts', 'ks',
            'fj', 'sg', 've', 'rn', 'cr', 'ak', 'tum', 'lg', 'dz', 'ny', 'ik',
            'ch', 'ff', 'st', 'tw', 'xh',
        ]
