...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'zh-min-nan', 'he', 'sk', 'min', 'kk', 'hr', 'lt', 'et', 'ce', 'sl',
        ...
        'mai', 'li', 'sah', 'sa', 'ilo', 'vec', 'os', 'eml', 'mrj', 'mhr',
        'sd', 'wuu', 'hif', 'roa-tara', 'ps', 'diq', 'hak', 'pam', 'nso',
        'zh-classical', 'bcl', 'bh', 'ace', 'se', 'szl', 'mi', 'nah', 'frr',
        'nds-nl', 'rue', 'km', 'vls', 'gan', 'crh', 'sc', 'bo', 'vep', 'glk',
        'co', 'nv', 'fiu-vro', 'tk', 'lrc', 'myv', 'kv', 'csb', 'gv', 'as',
        'so', 'udm', 'zea', 'ay', 'ug', 'ie', 'nrm', 'stq', 'lez', 'kw', 'lad',
        'pcd', 'sn', 'mwl', 'gn', 'rm', 'gom', 'koi', 'lij', 'ab', 'mt', 'fur',
        'dsb', 'frp', 'dv', 'ln', 'ang', 'cbk-zam', 'ext', 'dty', 'lo', 'kab',
        'ksh', 'gag', 'olo', 'lfn', 'pag', 'pi', 'haw', 'av', 'pfl', 'bxr',
        'xal', 'krc', 'pap', 'kaa', 'ha', 'bjn', 'rw', 'pdc', 'to', 'tyv',
        'nov', 'kl', 'arc', 'jam', 'kbd', 'gor', 'tpi', 'kbp', 'tet', 'ki',
        'ig', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'mdf', 'za', 'kg', 'bi',
        'wo', 'lg', 'srn', 'zu', 'tcy', 'chr', 'ltg', 'sm', 'om', 'inh', 'xh',
        'cu', 'rmy', 'bm', 'tn', 'pih', 'rn', 'chy', 'tw', 'ts', 'tum', 'got',
