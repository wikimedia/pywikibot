...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'hy', 'da', 'zh-min-nan', 'sk', 'min', 'he', 'kk', 'lt', 'hr',
            'et', 'ce', 'sl', 'be', 'gl', 'el', 'ur', 'nn', 'az', 'simple',
            'uz', 'la', 'hi', 'th', 'ka', 'vo', 'ta', 'cy', 'tg', 'mk', 'tl',
            'mg', 'oc', 'lv', 'ky', 'bs', 'tt', 'sq', 'new', 'azb', 'ast',
            ...
            'mn', 'bat-smg', 'gd', 'si', 'wa', 'nap', 'yi', 'am', 'bug', 'cdo',
            'or', 'map-bms', 'fo', 'mzn', 'hsb', 'mai', 'xmf', 'li', 'sah',
            'sa', 'vec', 'ilo', 'os', 'mrj', 'mhr', 'hif', 'eml', 'bh',
            'roa-tara', 'ps', 'sd', 'diq', 'pam', 'hak', 'nso', 'wuu',
            ...
            'mt', 'sn', 'fur', 'dsb', 'dv', 'ang', 'ln', 'ext', 'kab',
            'cbk-zam', 'frp', 'dty', 'ksh', 'lo', 'gag', 'olo', 'pag', 'pi',
            'av', 'bxr', 'pfl', 'haw', 'xal', 'krc', 'pap', 'kaa', 'rw', 'pdc',
            'bjn', 'ha', 'to', 'nov', 'kl', 'arc', 'jam', 'kbd', 'tyv', 'tpi',
            'tet', 'kbp', 'ki', 'na', 'ig', 'bi', 'roa-rup', 'lbe', 'jbo',
            'ty', 'mdf', 'za', 'kg', 'wo', 'lg', 'srn', 'tcy', 'zu', 'chr',
            'ltg', 'sm', 'om', 'xh', 'rmy', 'cu', 'tn', 'pih', 'rn', 'chy',
            'tw', 'tum', 'ts', 'st', 'got', 'bm', 'pnt', 'ss', 'ch', 'fj',
            'atj', 'ady', 'ak', 'iu', 'ny', 'ee', 'ks', 'ik', 've', 'sg', 'ff',
            'dz', 'ti', 'cr', 'din',
        ]
