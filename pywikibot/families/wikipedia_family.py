...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'sd', 'nap', 'bug', 'frr', 'os', 'hsb', 'map-bms', 'mai', 'fo', 'li',
        'sah', 'mzn', 'eml', 'ha', 'ace', 'ps', 'crh', 'gor', 'sa', 'bcl',
        ...
        'mni', 'csb', 'pcd', 'frp', 'udm', 'ug', 'gv', 'ay', 'kw', 'zea',
        ...
        'krc', 'szy', 'za', 'pdc', 'kaa', 'inh', 'arc', 'to', 'ak', 'kbp',
        'jam', 'na', 'wo', 'tpi', 'kbd', 'atj', 'tcy', 'nov', 'ki', 'mdf',
        'tet', 'lld', 'bi', 'lg', 'jbo', 'roa-rup', 'lbe', 'kg', 'fj', 'ty',
        'xh', 'srn', 'om', 'shi', 'nqo', 'trv', 'gcr', 'sm', 'ltg', 'alt',
