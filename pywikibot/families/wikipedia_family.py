...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'he', 'sk', 'zh-min-nan', 'ce', 'kk', 'min', 'hr', 'et', 'lt', 'be',
        ...
        'ne', 'yo', 'pa', 'bar', 'io', 'gu', 'als', 'ku', 'scn', 'bpy', 'kn',
        'ckb', 'ia', 'qu', 'wuu', 'arz', 'mn', 'bat-smg', 'wa', 'si', 'or',
        'yi', 'am', 'gd', 'cdo', 'nap', 'bug', 'hsb', 'mai', 'map-bms', 'ilo',
        'fo', 'xmf', 'mzn', 'li', 'vec', 'eml', 'sd', 'sah', 'os', 'sa', 'diq',
        'ps', 'mrj', 'mhr', 'zh-classical', 'hif', 'nv', 'roa-tara', 'ace',
        'bcl', 'frr', 'hak', 'szl', 'pam', 'nso', 'km', 'se', 'hyw', 'rue',
        'mi', 'nah', 'vls', 'bh', 'nds-nl', 'crh', 'gan', 'vep', 'sc', 'ab',
        'bo', 'as', 'myv', 'glk', 'co', 'tk', 'fiu-vro', 'so', 'lrc', 'kv',
        'csb', 'shn', 'gv', 'sn', 'udm', 'zea', 'ay', 'ie', 'pcd', 'nrm',
        'kab', 'ug', 'stq', 'lez', 'kw', 'lad', 'ha', 'mwl', 'gom', 'gn',
        ...
        'kbd', 'tpi', 'tet', 'ig', 'ki', 'zu', 'wo', 'na', 'jbo', 'lg',
