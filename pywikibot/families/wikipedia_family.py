...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ky', 'be-tarask', 'ml', 'mr', 'new', 'te', 'br', 'vec', 'pms', 'jv',
        'ht', 'pnb', 'sw', 'su', 'lb', 'ba', 'ga', 'tl', 'szl', 'is', 'lmo',
        'cv', 'fy', 'wuu', 'sco', 'diq', 'an', 'ku', 'pa', 'yo', 'ne', 'bar',
        'ckb', 'io', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'qu', 'mn', 'si',
        'bat-smg', 'nv', 'xmf', 'or', 'cdo', 'ilo', 'gd', 'yi', 'am', 'nap',
        'sd', 'bug', 'hsb', 'mai', 'avk', 'fo', 'map-bms', 'os', 'mzn', 'li',
        'sah', 'frr', 'eml', 'ace', 'ps', 'sa', 'gor', 'bcl', 'wa',
        'zh-classical', 'mrj', 'lij', 'mhr', 'hif', 'hak', 'roa-tara', 'crh',
        'pam', 'hyw', 'shn', 'ha', 'as', 'nso', 'km', 'rue', 'zu', 'se', 'bh',
        'vls', 'nds-nl', 'mi', 'ie', 'ban', 'nah', 'sc', 'sn', 'vep', 'gan',
        'myv', 'glk', 'kab', 'ab', 'sat', 'so', 'bo', 'co', 'tk', 'fiu-vro',
        'kv', 'csb', 'pcd', 'ug', 'udm', 'gv', 'frp', 'ay', 'zea', 'nrm', 'kw',
        'lez', 'gn', 'lfn', 'stq', 'mni', 'mt', 'mwl', 'ary', 'rm', 'lo',
        'bjn', 'lad', 'skr', 'olo', 'gom', 'koi', 'fur', 'ang', 'dty', 'dsb',
        ...
        'bm', 'rmy', 've', 'chy', 'rn', 'tum', 'ss', 'ch', 'iu', 'ks', 'pnt',
