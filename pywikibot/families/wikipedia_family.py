...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'zh-yue', 'lv', 'tg', 'bn', 'af', 'mg', 'oc', 'bs', 'my', 'nds', 'sq',
        'ky', 'be-tarask', 'new', 'ml', 'te', 'br', 'vec', 'mr', 'pms', 'tl',
        'jv', 'su', 'ht', 'sw', 'lb', 'pnb', 'ba', 'ga', 'szl', 'is', 'lmo',
        'fy', 'cv', 'sco', 'wuu', 'an', 'diq', 'pa', 'ku', 'yo', 'ne', 'bar',
        ...
        'nah', 'sc', 'lrc', 'ha', 'vep', 'sn', 'gan', 'myv', 'ab', 'zu', 'glk',
        'kab', 'bo', 'so', 'co', 'tk', 'fiu-vro', 'sat', 'ban', 'kv', 'ie',
        'csb', 'pcd', 'gv', 'udm', 'ay', 'ug', 'zea', 'nrm', 'lij', 'kw',
        'frp', 'lez', 'gn', 'lfn', 'stq', 'gom', 'mwl', 'rm', 'mt', 'lo',
        'lad', 'olo', 'koi', 'fur', 'bjn', 'ang', 'dsb', 'dty', 'ext', 'ary',
        'ln', 'tyv', 'cbk-zam', 'dv', 'ksh', 'gag', 'pfl', 'pi', 'pag', 'av',
        'awa', 'haw', 'bxr', 'xal', 'ig', 'krc', 'pap', 'za', 'rw', 'smn',
        'pdc', 'kaa', 'szy', 'arc', 'to', 'nov', 'kbp', 'jam', 'wo', 'tpi',
        'inh', 'kbd', 'na', 'tet', 'atj', 'tcy', 'ki', 'ak', 'jbo', 'bi',
        'roa-rup', 'lbe', 'lg', 'kg', 'xh', 'ty', 'mdf', 'lld', 'fj', 'srn',
        'gcr', 'om', 'ltg', 'sm', 'chr', 'nqo', 'got', 'kl', 'pih', 'st',
        'mnw', 'ny', 'cu', 'tw', 'tn', 'ts', 'bm', 'rmy', 'chy', 'rn', 'tum',
        'ss', 'ch', 'ks', 'iu', 'pnt', 'ady', 've', 'ee', 'ik', 'ff', 'sg',
        'din', 'dz', 'ti', 'cr', 'mad', 'skr',
    ]
