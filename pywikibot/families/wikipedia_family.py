...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ht', 'su', 'sw', 'tl', 'lb', 'pnb', 'ba', 'ga', 'szl', 'is', 'lmo',
        ...
        'hyw', 'crh', 'km', 'nso', 'rue', 'shn', 'se', 'as', 'bh', 'vls', 'mi',
        'nds-nl', 'nah', 'lrc', 'sc', 'ha', 'vep', 'sn', 'zu', 'gan', 'myv',
        'ab', 'glk', 'kab', 'bo', 'so', 'co', 'tk', 'ban', 'fiu-vro', 'sat',
        'ie', 'kv', 'csb', 'pcd', 'gv', 'udm', 'ay', 'ug', 'zea', 'nrm', 'lij',
        'kw', 'frp', 'lez', 'gn', 'lfn', 'stq', 'mwl', 'rm', 'mt', 'gom', 'lo',
        'lad', 'olo', 'koi', 'fur', 'bjn', 'ang', 'dty', 'dsb', 'ext', 'ary',
        'ln', 'tyv', 'cbk-zam', 'dv', 'ksh', 'gag', 'pfl', 'pi', 'pag', 'av',
        'awa', 'haw', 'bxr', 'smn', 'xal', 'ig', 'krc', 'pap', 'rw', 'za',
        'pdc', 'kaa', 'szy', 'arc', 'to', 'nov', 'kbp', 'jam', 'wo', 'tpi',
        'inh', 'kbd', 'na', 'tet', 'atj', 'tcy', 'ki', 'ak', 'lld', 'jbo',
        'roa-rup', 'bi', 'lbe', 'lg', 'kg', 'ty', 'skr', 'mdf', 'xh', 'fj',
        'srn', 'om', 'gcr', 'ltg', 'sm', 'chr', 'nqo', 'got', 'pih', 'kl',
        'st', 'mnw', 'ny', 'cu', 'tw', 'tn', 'ts', 'bm', 'rmy', 'chy', 'rn',
        'tum', 'ss', 'ch', 'iu', 'ks', 'pnt', 'mad', 'ady', 've', 'ee', 'ik',
        'ff', 'sg', 'din', 'dz', 'ti', 'cr', 'nia',
    ]
