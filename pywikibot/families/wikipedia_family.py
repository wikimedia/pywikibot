...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'nv', 'xmf', 'crh', 'si', 'bat-smg', 'lld', 'or', 'gd', 'frr', 'cdo',
        'os', 'ilo', 'yi', 'sd', 'am', 'ha', 'bug', 'nap', 'sah', 'hsb', 'ps',
        'map-bms', 'fo', 'mai', 'li', 'mzn', 'eml', 'ban', 'gor', 'ace', 'bcl',
        'sa', 'wa', 'zh-classical', 'lij', 'shn', 'zu', 'mrj', 'mhr', 'as',
        'hif', 'mni', 'hyw', 'hak', 'roa-tara', 'km', 'pam', 'ie', 'nso',
        'rue', 'so', 'sn', 'bh', 'se', 'sat', 'vls', 'nds-nl', 'myv', 'mi',
        'nah', 'sc', 'vep', 'gan', 'glk', 'kab', 'tk', 'fiu-vro', 'co', 'bo',
        'ab', 'kv', 'frp', 'csb', 'pcd', 'kw', 'ug', 'gv', 'udm', 'ary', 'ay',
        'nrm', 'zea', 'gn', 'skr', 'mt', 'bjn', 'lez', 'lfn', 'smn', 'stq',
        'lo', 'mwl', 'olo', 'rm', 'fur', 'ig', 'lad', 'gom', 'ang', 'koi',
        'ext', 'tyv', 'dsb', 'dty', 'ln', 'cbk-zam', 'dv', 'rw', 'ksh', 'gag',
        'bxr', 'pfl', 'av', 'pag', 'pi', 'haw', 'awa', 'tay', 'pap', 'krc',
        'xal', 'szy', 'za', 'inh', 'kaa', 'pdc', 'atj', 'to', 'arc', 'dag',
        'tpi', 'kbp', 'tw', 'jam', 'na', 'wo', 'mdf', 'kbd', 'tcy', 'nov',
        'nia', 'ki', 'tet', 'lg', 'bi', 'tum', 'jbo', 'roa-rup', 'fj', 'kg',
        'xh', 'lbe', 'ty', 'nqo', 'mnw', 'ks', 'cu', 'shi', 'trv', 'srn', 'om',
        'sm', 'gcr', 'alt', 'ltg', 'chr', 'pih', 'ny', 'got', 'mad', 'st',
        'ami', 'kl', 'rmy', 'tn', 'bm', 'ts', 'chy', 've', 'rn', 'iu', 'ak',
        'ss', 'ch', 'pnt', 'guw', 'ady', 'ik', 'ee', 'ff', 'din', 'sg', 'ti',
        'dz', 'pwn', 'cr',
    ]
