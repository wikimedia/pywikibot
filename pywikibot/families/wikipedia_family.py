...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ky', 'tt', 'bs', 'ast', 'sq', 'new', 'te', 'zh-yue', 'br', 'pms',
        ...
        'mai', 'li', 'sah', 'sa', 'vec', 'ilo', 'os', 'mrj', 'eml', 'mhr',
        'sd', 'hif', 'wuu', 'roa-tara', 'ps', 'diq', 'hak', 'pam', 'nso',
        'bcl', 'zh-classical', 'bh', 'se', 'szl', 'ace', 'mi', 'nah', 'frr',
        'nds-nl', 'rue', 'vls', 'gan', 'km', 'crh', 'bo', 'sc', 'vep', 'glk',
        'co', 'fiu-vro', 'tk', 'lrc', 'kv', 'myv', 'nv', 'csb', 'gv', 'as',
        'so', 'udm', 'zea', 'ay', 'ug', 'ie', 'stq', 'lez', 'nrm', 'kw', 'lad',
        'pcd', 'sn', 'mwl', 'gn', 'rm', 'gom', 'koi', 'lij', 'ab', 'mt', 'fur',
        'dsb', 'frp', 'dv', 'ln', 'ang', 'cbk-zam', 'ext', 'dty', 'kab', 'lo',
        'ksh', 'gag', 'olo', 'pag', 'pi', 'lfn', 'haw', 'av', 'pfl', 'bxr',
        'xal', 'krc', 'pap', 'kaa', 'ha', 'rw', 'pdc', 'bjn', 'to', 'tyv',
        'kl', 'nov', 'arc', 'jam', 'kbd', 'tpi', 'kbp', 'tet', 'ki', 'gor',
        'ig', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'mdf', 'za', 'kg', 'bi',
        'wo', 'lg', 'srn', 'tcy', 'zu', 'chr', 'ltg', 'sm', 'om', 'inh', 'xh',
        'rmy', 'cu', 'bm', 'tn', 'pih', 'rn', 'chy', 'tw', 'ts', 'tum', 'got',
        'ak', 'st', 'atj', 'ch', 'pnt', 'ss', 'fj', 'iu', 'ady', 'ny', 'ee',
