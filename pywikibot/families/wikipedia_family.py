...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'vi', 'sv', 'uk', 'ca', 'no', 'fi', 'cs', 'fa', 'hu', 'ro', 'ko',
            'ar', 'tr', 'id', 'sk', 'eo', 'da', 'kk', 'sr', 'lt', 'ms', 'he',
            'eu', 'bg', 'sl', 'vo', 'hr', 'war', 'hi', 'et', 'gl', 'az', 'nn',
            'simple', 'la', 'el', 'th', 'oc', 'sh', 'new', 'mk', 'roa-rup',
            'ka', 'tl', 'pms', 'ht', 'be', 'te', 'ta', 'be-x-old', 'uz', 'lv',
            'br', 'ceb', 'sq', 'jv', 'mg', 'mr', 'cy', 'lb', 'is', 'bs', 'hy',
            'my', 'yo', 'an', 'lmo', 'ml', 'pnb', 'fy', 'bpy', 'af', 'sw', 'bn',
            'io', 'ne', 'gu', 'zh-yue', 'nds', 'ur', 'ku', 'ba', 'ast', 'scn',
            'qu', 'su', 'diq', 'tt', 'ga', 'cv', 'ky', 'ia', 'nap', 'bat-smg',
            'map-bms', 'wa', 'als', 'kn', 'am', 'gd', 'ckb', 'bug', 'sco', 'tg',
            'mzn', 'zh-min-nan', 'yi', 'vec', 'arz', 'hif', 'roa-tara', 'nah',
            'os', 'sah', 'mn', 'sa', 'pam', 'hsb', 'li', 'mi', 'si', 'se', 'co',
            'gan', 'glk', 'fo', 'bar', 'ilo', 'bo', 'bcl', 'mrj', 'nds-nl',
            'fiu-vro', 'tk', 'ps', 'vls', 'gv', 'rue', 'pa', 'dv', 'pag', 'xmf',
            'nrm', 'kv', 'zea', 'koi', 'rm', 'km', 'csb', 'lad', 'udm', 'mhr',
            'mt', 'or', 'fur', 'lij', 'wuu', 'ug', 'pi', 'sc', 'frr',
            'zh-classical', 'bh', 'nov', 'ksh', 'ang', 'so', 'kw', 'stq', 'nv',
            'hak', 'ay', 'frp', 'ext', 'vep', 'pcd', 'szl', 'gag', 'ie', 'gn',
            'ln', 'haw', 'xal', 'eml', 'rw', 'pdc', 'pfl', 'krc', 'crh', 'ace',
            'to', 'ce', 'as', 'kl', 'arc', 'myv', 'dsb', 'bjn', 'pap', 'sn',
            'tpi', 'lbe', 'mdf', 'wo', 'jbo', 'kab', 'av', 'srn', 'cbk-zam',
            'lez', 'ty', 'kbd', 'lo', 'ab', 'tet', 'mwl', 'ltg', 'na', 'ig',
            'kg', 'nso', 'za', 'kaa', 'zu', 'rmy', 'chy', 'cu', 'bxr', 'tn',
            'chr', 'got', 'cdo', 'sm', 'bi', 'bm', 'iu', 'pih', 'ss', 'sd',
            'pnt', 'ee', 'ha', 'om', 'ti', 'ki', 'ts', 'ks', 'sg', 've', 'rn',
            'cr', 'ak', 'lg', 'tum', 'dz', 'ny', 'ik', 'ff', 'ch', 'st', 'fj',
            'tw', 'xh',
        ]
