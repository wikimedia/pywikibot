...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'mrj', 'hif', 'hyw', 'mni', 'ig', 'km', 'hak', 'roa-tara', 'pam', 'sn',
        'nso', 'so', 'rue', 'bh', 'se', 'myv', 'vls', 'nds-nl', 'sat', 'mi',
        'sc', 'nah', 'vep', 'gan', 'kab', 'glk', 'tk', 'fiu-vro', 'co', 'bo',
        'ab', 'tum', 'gv', 'ary', 'frp', 'kw', 'kv', 'csb', 'pcd', 'ug', 'skr',
        'udm', 'zea', 'ay', 'gn', 'mt', 'nrm', 'bjn', 'smn', 'lez', 'lfn',
        'stq', 'lo', 'olo', 'mwl', 'fur', 'rm', 'ang', 'lad', 'gom', 'koi',
        'ext', 'tyv', 'rw', 'dsb', 'dty', 'ln', 'av', 'cbk-zam', 'dv', 'ksh',
        'gag', 'bxr', 'pfl', 'pap', 'pag', 'pi', 'haw', 'awa', 'tay', 'ks',
        'tw', 'inh', 'dag', 'krc', 'xal', 'szy', 'za', 'mdf', 'kaa', 'pdc',
        ...
        'blk', 'ami', 'bm', 'tn', 've', 'rmy', 'ts', 'chy', 'rn', 'iu', 'ak',
        'ss', 'ff', 'ch', 'pnt', 'kcg', 'ady', 'ik', 'ee', 'sg', 'din', 'pwn',
        'pcm', 'kl', 'ti', 'dz', 'cr',
    ]
