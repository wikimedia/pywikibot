...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'roa-tara', 'ps', 'diq', 'pam', 'hak', 'wuu', 'nso',
            'zh-classical', 'bcl', 'se', 'ace', 'mi', 'szl', 'nah', 'nds-nl',
            'frr', 'rue', 'gan', 'vls', 'km', 'bo', 'crh', 'sc', 'vep', 'glk',
            'co', 'fiu-vro', 'tk', 'lrc', 'kv', 'csb', 'myv', 'gv', 'as', 'nv',
            'so', 'zea', 'udm', 'ay', 'lez', 'stq', 'ie', 'lad', 'nrm', 'kw',
            'ug', 'pcd', 'mwl', 'gom', 'rm', 'gn', 'sn', 'koi', 'ab', 'lij',
            'mt', 'fur', 'dsb', 'dv', 'ang', 'ln', 'cbk-zam', 'frp', 'kab',
            'ext', 'dty', 'ksh', 'lo', 'gag', 'olo', 'pag', 'pi', 'av', 'haw',
            'bxr', 'pfl', 'xal', 'krc', 'pap', 'kaa', 'rw', 'pdc', 'bjn', 'ha',
            'to', 'nov', 'kl', 'arc', 'jam', 'kbd', 'tyv', 'tpi', 'kbp', 'tet',
            'ki', 'lfn', 'ig', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'mdf',
            'za', 'kg', 'gor', 'bi', 'wo', 'lg', 'srn', 'tcy', 'zu', 'chr',
            'ltg', 'sm', 'om', 'inh', 'xh', 'rmy', 'cu', 'tn', 'pih', 'rn',
            'chy', 'tw', 'bm', 'tum', 'ts', 'got', 'st', 'ak', 'atj', 'pnt',
