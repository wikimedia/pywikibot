...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ce', 'ms', 'eo', 'he', 'hy', 'tt', 'bg', 'da', 'azb', 'sk', 'kk',
        ...
        'sd', 'avk', 'bug', 'hsb', 'mai', 'fo', 'os', 'map-bms', 'li', 'mzn',
        'frr', 'sah', 'eml', 'ps', 'ace', 'sa', 'gor', 'bcl', 'wa',
        'zh-classical', 'lij', 'mrj', 'mhr', 'crh', 'hif', 'hak', 'roa-tara',
        'shn', 'pam', 'hyw', 'ha', 'as', 'nso', 'km', 'ie', 'rue', 'zu', 'ban',
        'se', 'bh', 'vls', 'nds-nl', 'mi', 'sc', 'nah', 'sn', 'vep', 'gan',
        'myv', 'glk', 'kab', 'sat', 'ab', 'so', 'bo', 'co', 'tk', 'fiu-vro',
        'kv', 'csb', 'pcd', 'frp', 'udm', 'ug', 'gv', 'ay', 'zea', 'kw', 'nrm',
        'lez', 'gn', 'lfn', 'stq', 'mt', 'mni', 'ary', 'mwl', 'rm', 'lo',
        'skr', 'bjn', 'olo', 'lad', 'gom', 'koi', 'fur', 'ang', 'dty', 'dsb',
        'ext', 'ln', 'tyv', 'cbk-zam', 'dv', 'smn', 'ksh', 'gag', 'pfl', 'pag',
        'pi', 'av', 'awa', 'tay', 'haw', 'bxr', 'pap', 'ig', 'xal', 'rw',
        'krc', 'za', 'pdc', 'kaa', 'szy', 'inh', 'arc', 'to', 'nov', 'kbp',
        'jam', 'wo', 'tpi', 'na', 'kbd', 'atj', 'ki', 'tet', 'tcy', 'ak',
        'lld', 'lg', 'jbo', 'roa-rup', 'bi', 'lbe', 'kg', 'ty', 'mdf', 'xh',
        'fj', 'srn', 'om', 'gcr', 'trv', 'ltg', 'sm', 'chr', 'nia', 'nqo',
        'pih', 'mnw', 'got', 'kl', 'st', 'mad', 'tw', 'cu', 'ny', 'tn', 'ts',
        'bm', 'rmy', 've', 'chy', 'rn', 'tum', 'iu', 'ss', 'ch', 'ks', 'alt',
        'pnt', 'ady', 'ee', 'ff', 'ik', 'sg', 'din', 'dz', 'ti', 'cr',
    ]
