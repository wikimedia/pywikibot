...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'sd', 'bug', 'nap', 'frr', 'os', 'crh', 'hsb', 'map-bms', 'mai', 'fo',
        'ha', 'li', 'sah', 'mzn', 'eml', 'ps', 'gor', 'ace', 'sa', 'bcl', 'wa',
        'zh-classical', 'ban', 'lij', 'zu', 'mhr', 'mrj', 'hif', 'shn', 'mni',
        'as', 'hak', 'roa-tara', 'hyw', 'pam', 'ie', 'nso', 'km', 'rue', 'se',
        'bh', 'vls', 'nds-nl', 'sn', 'mi', 'so', 'nah', 'sat', 'sc', 'myv',
        'vep', 'gan', 'glk', 'kab', 'tk', 'co', 'fiu-vro', 'bo', 'ab', 'kv',
        'csb', 'pcd', 'frp', 'kw', 'ug', 'udm', 'gv', 'ay', 'ary', 'zea',
        'nrm', 'gn', 'bjn', 'mt', 'lez', 'lfn', 'stq', 'lo', 'mwl', 'smn',
        'skr', 'olo', 'rm', 'lad', 'fur', 'gom', 'ang', 'koi', 'dsb', 'tyv',
        'ext', 'dty', 'ln', 'cbk-zam', 'dv', 'ksh', 'rw', 'gag', 'bxr', 'pfl',
        'ig', 'av', 'pi', 'pag', 'awa', 'haw', 'tay', 'pap', 'krc', 'xal',
        'szy', 'za', 'pdc', 'kaa', 'inh', 'atj', 'to', 'arc', 'kbp', 'tpi',
        'jam', 'na', 'wo', 'lld', 'kbd', 'tcy', 'mdf', 'nov', 'ki', 'tet',
        'lg', 'bi', 'jbo', 'roa-rup', 'fj', 'kg', 'tw', 'lbe', 'xh', 'ty',
        'mnw', 'nqo', 'srn', 'shi', 'om', 'trv', 'gcr', 'sm', 'ltg', 'chr',
        'alt', 'ks', 'nia', 'dag', 'pih', 'cu', 'ny', 'got', 'st', 'mad',
        'ami', 'kl', 'rmy', 'tn', 'bm', 'ts', 've', 'chy', 'rn', 'tum', 'iu',
