...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'yi', 'am', 'or', 'bug', 'cdo', 'map-bms', 'hsb', 'fo', 'mai', 'mzn',
        ...
        'vep', 'glk', 'co', 'so', 'tk', 'fiu-vro', 'lrc', 'myv', 'kv', 'csb',
        'as', 'gv', 'udm', 'zea', 'ay', 'ug', 'ie', 'nrm', 'stq', 'lez', 'sn',
        'kw', 'lad', 'pcd', 'mwl', 'gn', 'rm', 'gom', 'koi', 'ab', 'lij', 'mt',
        'fur', 'dsb', 'frp', 'ln', 'ang', 'dv', 'cbk-zam', 'ext', 'dty', 'lo',
        'kab', 'ksh', 'haw', 'lfn', 'gag', 'olo', 'pag', 'pi', 'av', 'pfl',
        'bxr', 'xal', 'krc', 'pap', 'kaa', 'ha', 'bjn', 'pdc', 'rw', 'gor',
        'tyv', 'to', 'nov', 'kl', 'jam', 'arc', 'kbd', 'tpi', 'kbp', 'tet',
        'ig', 'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'za', 'ty', 'mdf', 'kg',
        'bi', 'wo', 'lg', 'srn', 'zu', 'tcy', 'chr', 'ltg', 'sm', 'inh', 'om',
        'xh', 'pih', 'cu', 'rmy', 'tw', 'bm', 'tn', 'rn', 'chy', 'atj', 'tum',
        'got', 'ts', 'ak', 'st', 'ch', 'pnt', 'ss', 'fj', 'ny', 'ady', 'iu',
