...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'gv', 'shn', 'udm', 'zea', 'ie', 'ay', 'pcd', 'sn', 'ug', 'nrm', 'stq',
        'lez', 'kw', 'lad', 'mwl', 'gom', 'gn', 'haw', 'rm', 'lij', 'ha',
        'kab', 'ab', 'koi', 'lo', 'mt', 'lfn', 'fur', 'frp', 'dsb', 'ln',
        'ang', 'ext', 'olo', 'dty', 'cbk-zam', 'dv', 'ksh', 'gag', 'pi', 'pag',
        'pfl', 'bjn', 'av', 'bxr', 'xal', 'gor', 'krc', 'za', 'pap', 'kaa',
        'pdc', 'rw', 'tyv', 'to', 'kl', 'nov', 'jam', 'arc', 'kbp', 'kbd',
        'tpi', 'tet', 'ig', 'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'bi', 'ty',
        'kg', 'wo', 'mdf', 'lg', 'zu', 'srn', 'inh', 'tcy', 'atj', 'chr',
        'ltg', 'sm', 'xh', 'om', 'sat', 'pih', 'cu', 'rmy', 'tw', 'bm', 'tn',
