...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'et', 'min', 'be', 'hr', 'simple', 'el', 'lt', 'gl', 'az', 'sl', 'ur',
        'nn', 'ka', 'hi', 'th', 'ta', 'uz', 'la', 'cy', 'ast', 'mk', 'zh-yue',
        ...
        'nv', 'xmf', 'crh', 'lld', 'si', 'bat-smg', 'gd', 'frr', 'os', 'or',
        'ha', 'cdo', 'yi', 'ilo', 'sd', 'bug', 'am', 'nap', 'ps', 'sah', 'ban',
        'hsb', 'fo', 'map-bms', 'mai', 'li', 'mzn', 'eml', 'gor', 'ace', 'bcl',
        'sa', 'wa', 'zh-classical', 'shn', 'lij', 'zu', 'mrj', 'mhr', 'as',
        'hif', 'hyw', 'mni', 'ie', 'hak', 'roa-tara', 'km', 'pam', 'nso',
        'rue', 'so', 'sn', 'bh', 'se', 'myv', 'vls', 'nds-nl', 'mi', 'sc',
        'nah', 'sat', 'vep', 'gan', 'kab', 'glk', 'tk', 'fiu-vro', 'co', 'bo',
        'ab', 'frp', 'kv', 'csb', 'kw', 'gv', 'pcd', 'ug', 'ary', 'udm', 'skr',
        'ay', 'zea', 'nrm', 'gn', 'mt', 'bjn', 'ig', 'smn', 'lez', 'lfn',
        'stq', 'lo', 'mwl', 'olo', 'fur', 'rm', 'lad', 'ang', 'gom', 'koi',
        'ext', 'tyv', 'dsb', 'dty', 'rw', 'ln', 'cbk-zam', 'dv', 'ksh', 'av',
        'gag', 'bxr', 'pfl', 'pag', 'pi', 'pap', 'haw', 'awa', 'tay', 'krc',
        'xal', 'inh', 'szy', 'za', 'tw', 'pdc', 'kaa', 'atj', 'to', 'dag',
        'tum', 'arc', 'mdf', 'tpi', 'kbp', 'jam', 'na', 'wo', 'kbd', 'tcy',
        'nov', 'nia', 'ki', 'tet', 'lg', 'bi', 'jbo', 'roa-rup', 'fj', 'lbe',
        'ks', 'kg', 'nqo', 'xh', 'ty', 'mnw', 'cu', 'shi', 'trv', 'srn', 'om',
        'sm', 'gcr', 'alt', 'chr', 'ltg', 'ny', 'pih', 'got', 'mad', 'st',
        'ami', 'guw', 'tn', 'rmy', 'bm', 'ts', 'chy', 've', 'rn', 'iu', 'ak',
        'ss', 'ch', 'pnt', 'ady', 'kcg', 'ik', 'ff', 'ee', 'din', 'sg', 'pwn',
        'kl', 'ti', 'dz', 'cr',
    ]
