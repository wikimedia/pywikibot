...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'vo', 'yo', 'ne', 'ia', 'gu', 'kn', 'als', 'ha', 'avk', 'bar', 'crh',
        ...
        'hak', 'roa-tara', 'pam', 'sat', 'rue', 'nso', 'bh', 'so', 'se', 'mi',
        'myv', 'vls', 'nds-nl', 'sc', 'dag', 'ary', 'kw', 'co', 'bo', 'vep',
        'glk', 'tk', 'kab', 'gan', 'rw', 'fiu-vro', 'ab', 'gv', 'ug', 'nah',
        'zea', 'skr', 'frp', 'udm', 'pcd', 'kv', 'mt', 'csb', 'gn', 'smn',
        'ay', 'nrm', 'ks', 'lez', 'lfn', 'olo', 'mwl', 'stq', 'lo', 'ang',
        'fur', 'mdf', 'rm', 'lad', 'kaa', 'gom', 'ext', 'koi', 'tyv', 'pap',
        'av', 'dsb', 'ln', 'dty', 'tw', 'cbk-zam', 'dv', 'ksh', 'za', 'gag',
        'bxr', 'pfl', 'lg', 'szy', 'pag', 'blk', 'pi', 'tay', 'haw', 'awa',
        'inh', 'krc', 'xal', 'pdc', 'to', 'atj', 'tcy', 'arc', 'mnw', 'jam',
        'kbp', 'wo', 'anp', 'kbd', 'nia', 'nov', 'shi', 'ki', 'nqo', 'om',
        'bi', 'xh', 'tpi', 'tet', 'roa-rup', 'jbo', 'fj', 'ff', 'kg', 'lbe',
        'ty', 'cu', 'guw', 'trv', 'ami', 'srn', 'sm', 'mad', 'alt', 'gcr',
        'ltg', 'chr', 'tn', 'ny', 'st', 'pih', 'rmy', 'got', 'ee', 'bm', 'pcm',
