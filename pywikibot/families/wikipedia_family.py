...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'os', 'yi', 'ilo', 'bug', 'sd', 'ha', 'am', 'nap', 'sah', 'ps', 'hsb',
        ...
        'nah', 'sc', 'vep', 'gan', 'kab', 'glk', 'tk', 'fiu-vro', 'co', 'bo',
        'ab', 'frp', 'kv', 'csb', 'pcd', 'kw', 'gv', 'ug', 'ary', 'udm', 'ay',
        'skr', 'nrm', 'zea', 'gn', 'mt', 'bjn', 'lez', 'smn', 'lfn', 'stq',
        'lo', 'mwl', 'ig', 'olo', 'rm', 'fur', 'lad', 'ang', 'gom', 'koi',
        ...
        'sm', 'gcr', 'chr', 'alt', 'ltg', 'pih', 'ny', 'got', 'mad', 'st',
        'ami', 'rmy', 'tn', 'bm', 'ts', 'guw', 'chy', 've', 'rn', 'iu', 'ak',
