...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'vi', 'ja', 'zh', 'pt', 'uk', 'fa', 'sr', 'ca', 'ar', 'no', 'sh', 'fi',
        'hu', 'id', 'ko', 'cs', 'ro', 'ms', 'tr', 'eu', 'eo', 'bg', 'hy', 'da',
        'zh-min-nan', 'sk', 'he', 'min', 'kk', 'hr', 'lt', 'et', 'ce', 'sl',
        'be', 'gl', 'el', 'ur', 'nn', 'az', 'simple', 'uz', 'la', 'hi', 'th',
        'ka', 'vo', 'ta', 'cy', 'mk', 'tg', 'lv', 'mg', 'oc', 'tl', 'ky', 'tt',
        'bs', 'azb', 'ast', 'sq', 'new', 'te', 'zh-yue', 'br', 'pms',
        'be-tarask', 'bn', 'ml', 'jv', 'lb', 'ht', 'sco', 'mr', 'af', 'ga',
        'pnb', 'is', 'ba', 'sw', 'cv', 'fy', 'su', 'my', 'lmo', 'an', 'yo',
        'ne', 'nds', 'pa', 'gu', 'io', 'bar', 'scn', 'bpy', 'als', 'ku', 'kn',
        'ckb', 'ia', 'qu', 'arz', 'mn', 'bat-smg', 'si', 'gd', 'wa', 'nap',
        'yi', 'am', 'bug', 'or', 'cdo', 'map-bms', 'hsb', 'fo', 'mzn', 'mai',
        'xmf', 'li', 'sah', 'sa', 'vec', 'ilo', 'os', 'mrj', 'eml', 'hif',
        'mhr', 'sd', 'wuu', 'roa-tara', 'ps', 'diq', 'hak', 'pam', 'nso',
        'bcl', 'zh-classical', 'bh', 'se', 'ace', 'szl', 'mi', 'nah', 'frr',
        'nds-nl', 'rue', 'vls', 'gan', 'km', 'crh', 'bo', 'sc', 'vep', 'glk',
        'co', 'fiu-vro', 'tk', 'lrc', 'kv', 'myv', 'csb', 'nv', 'gv', 'as',
        'so', 'udm', 'zea', 'ay', 'ug', 'ie', 'stq', 'lez', 'nrm', 'kw', 'lad',
        'pcd', 'sn', 'mwl', 'gn', 'rm', 'gom', 'koi', 'ab', 'lij', 'mt', 'fur',
        'dsb', 'frp', 'dv', 'ln', 'ang', 'cbk-zam', 'ext', 'kab', 'dty', 'lo',
        'ksh', 'gag', 'olo', 'pag', 'pi', 'haw', 'lfn', 'av', 'bxr', 'pfl',
        'xal', 'krc', 'pap', 'kaa', 'rw', 'pdc', 'bjn', 'ha', 'to', 'tyv',
        'nov', 'kl', 'arc', 'jam', 'kbd', 'tpi', 'kbp', 'tet', 'ki', 'ig',
        'na', 'gor', 'jbo', 'lbe', 'roa-rup', 'ty', 'mdf', 'za', 'kg', 'bi',
        'wo', 'lg', 'srn', 'tcy', 'zu', 'chr', 'ltg', 'sm', 'om', 'inh', 'xh',
        'rmy', 'cu', 'bm', 'tn', 'pih', 'rn', 'chy', 'tw', 'ts', 'tum', 'ak',
        'got', 'st', 'atj', 'pnt', 'ch', 'ss', 'fj', 'iu', 'ady', 'ny', 'ee',
