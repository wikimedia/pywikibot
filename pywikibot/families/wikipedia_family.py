...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'no', 'ko', 'fi', 'hu', 'cs', 'sh', 'ce', 'tr', 'zh-min-nan', 'ro',
        ...
        'mr', 'ky', 'be-tarask', 'ml', 'te', 'new', 'br', 'vec', 'sw', 'pms',
        'jv', 'pnb', 'ht', 'su', 'lb', 'ba', 'ga', 'szl', 'is', 'ku', 'lmo',
        'cv', 'fy', 'tl', 'wuu', 'an', 'sco', 'diq', 'pa', 'ckb', 'yo', 'ne',
        'bar', 'io', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'qu', 'mn', 'si',
        'nv', 'bat-smg', 'avk', 'xmf', 'or', 'gd', 'cdo', 'ilo', 'yi', 'am',
        'bug', 'sd', 'nap', 'frr', 'os', 'hsb', 'map-bms', 'mai', 'fo', 'li',
        'sah', 'mzn', 'eml', 'ha', 'crh', 'ace', 'ps', 'gor', 'sa', 'bcl',
        'wa', 'zh-classical', 'lij', 'zu', 'mrj', 'mhr', 'hif', 'ban', 'shn',
        'as', 'hak', 'roa-tara', 'hyw', 'pam', 'ie', 'nso', 'km', 'rue', 'se',
        'bh', 'vls', 'nds-nl', 'sn', 'mi', 'sc', 'nah', 'so', 'sat', 'vep',
        'myv', 'gan', 'glk', 'kab', 'tk', 'mni', 'co', 'bo', 'fiu-vro', 'ab',
        'kv', 'csb', 'pcd', 'frp', 'udm', 'ug', 'gv', 'ay', 'kw', 'zea', 'ary',
        'nrm', 'bjn', 'gn', 'mt', 'lez', 'lfn', 'stq', 'lo', 'mwl', 'skr',
        'rm', 'olo', 'smn', 'lad', 'gom', 'fur', 'koi', 'ang', 'dty', 'dsb',
        'ext', 'tyv', 'ln', 'cbk-zam', 'dv', 'ksh', 'gag', 'bxr', 'pfl', 'pi',
        'pag', 'av', 'awa', 'ig', 'haw', 'tay', 'rw', 'pap', 'xal', 'krc',
        'szy', 'za', 'pdc', 'kaa', 'ak', 'inh', 'arc', 'to', 'kbp', 'jam',
        'na', 'tpi', 'wo', 'atj', 'kbd', 'tcy', 'nov', 'ki', 'mdf', 'tet',
        'lld', 'bi', 'lg', 'jbo', 'roa-rup', 'lbe', 'kg', 'xh', 'fj', 'ty',
        'srn', 'om', 'shi', 'nqo', 'trv', 'gcr', 'sm', 'chr', 'ltg', 'alt',
        'nia', 'tw', 'ks', 'mnw', 'pih', 'ny', 'got', 'cu', 'st', 'mad', 'kl',
        'dag', 'tn', 'bm', 'ts', 'rmy', 've', 'chy', 'rn', 'tum', 'iu', 'ss',
        'ch', 'pnt', 'ady', 'ik', 'ee', 'ff', 'din', 'sg', 'dz', 'ti', 'cr',
        'ami', 'pwn',
    ]
