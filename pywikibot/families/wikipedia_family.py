...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'bat-smg', 'os', 'or', 'sah', 'cdo', 'ig', 'mzn', 'gd', 'bug', 'yi',
        'sd', 'ilo', 'am', 'tum', 'nap', 'li', 'fo', 'gor', 'hsb', 'map-bms',
        'bcl', 'mai', 'shn', 'eml', 'ace', 'zh-classical', 'sa', 'as', 'wa',
        'ie', 'lij', 'zu', 'mhr', 'hyw', 'hif', 'sn', 'mrj', 'bjn', 'mni',
        'km', 'hak', 'so', 'roa-tara', 'pam', 'rue', 'nso', 'sat', 'bh', 'se',
        'mi', 'myv', 'vls', 'nds-nl', 'sc', 'dag', 'kw', 'vep', 'glk', 'bo',
        'ary', 'tk', 'co', 'kab', 'gan', 'rw', 'fiu-vro', 'ab', 'gv', 'ug',
        'nah', 'zea', 'skr', 'frp', 'udm', 'pcd', 'kv', 'mt', 'csb', 'gn',
        'smn', 'ay', 'nrm', 'ks', 'lez', 'lfn', 'olo', 'mwl', 'stq', 'lo',
        'ang', 'fur', 'rm', 'mdf', 'lad', 'gom', 'ext', 'tyv', 'koi', 'kaa',
        'dsb', 'av', 'ln', 'pap', 'dty', 'tw', 'cbk-zam', 'dv', 'ksh', 'gag',
        'bxr', 'pfl', 'lg', 'za', 'szy', 'pi', 'tay', 'pag', 'haw', 'blk',
        'awa', 'inh', 'krc', 'xal', 'pdc', 'to', 'atj', 'tcy', 'arc', 'mnw',
        'jam', 'kbp', 'wo', 'anp', 'kbd', 'nia', 'shi', 'nov', 'ki', 'nqo',
        'bi', 'tpi', 'xh', 'tet', 'roa-rup', 'om', 'jbo', 'fj', 'lbe', 'kg',
        'ty', 'guw', 'cu', 'trv', 'srn', 'ff', 'sm', 'alt', 'gcr', 'chr', 'tn',
