...
featured_name = {
    ...
    #'fa': (CAT, u"مقاله‌های برگزیده"),
    'fi': (CAT, u"Suositellut artikkelit"),
    ...
    'ml': (BACK, u"Featured"),
    #'ml': (CAT, u"തിരഞ്ഞെടുത്ത ലേഖനങ്ങൾ"),
    ...
    #'nn': (CAT, u"Wikipedia/Gode artiklar"),
